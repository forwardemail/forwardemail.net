...
module.exports = appendContactsAndCalendarsToArchive;
module.exports.ensureExtension = ensureExtension;
module.exports.sanitizeArchiveSegment = sanitizeArchiveSegment;
module.exports.getUniquePath = getUniquePath;
