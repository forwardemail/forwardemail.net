...
module.exports = {
  ...
  'No enterprise accounts exist for that search.':
    'No enterprise accounts exist for that search.',
  ...
  'Select a specific workflow action to execute for this enterprise account.':
    'Select a specific workflow action to execute for this enterprise account.',
  Action: 'Action',
  ...
  'Add any notes about this workflow action...':
    'Add any notes about this workflow action...',
  ...
  'No recent enterprise payments found.':
    'No recent enterprise payments found.',
  Dashboard: 'Dashboard',
  ...
  'Select accounts to update from the pipeline above':
    'Select accounts to update from the pipeline above',
  ...
  USER_MUST_HAVE_TEAM_OR_ENHANCED_PLAN:
    'User must have a Team or Enhanced Protection plan to be converted to enterprise.',
  CONVERT_ENTERPRISE_REQUIRED_FIELDS:
    'Email, company name, and primary contact name are required for conversion.',
  USER_DOES_NOT_EXIST: 'User with this email address does not exist.',
  USER_ALREADY_HAS_ENTERPRISE: 'User already has an enterprise account.',
  ENTERPRISE_ACCOUNT_CONVERTED:
    'User account has been successfully converted to enterprise.',
  CONVERT_ENTERPRISE_ERROR:
    'An error occurred while converting the account to enterprise.',
  ENTERPRISE_ACCOUNT_UPDATED:
    'Enterprise account has been updated successfully.',
  ENTERPRISE_ACCOUNT_REMOVED:
    'Enterprise account has been removed successfully.',
  ENTERPRISE_REQUIRED_FIELDS:
    'Company name, contact name, and email are required.',
  DASHBOARD_ERROR: 'An error occurred while loading dashboard data.',
  DOCUMENT_UPLOADED: 'Document has been uploaded successfully.',
  SETUP_DOCUMENT_GENERATED: 'Setup document has been generated successfully.',
  ACTION_REQUIRED: 'Action is required.',
  NO_CONTRACT_PREVIEW_TO_APPROVE: 'No contract preview available to approve.',
  INVALID_ACTION: 'Invalid action specified.',
  WORKFLOW_ACTION_COMPLETED: 'Workflow action has been completed successfully.',
