...
module.exports = {
  ...
  // Email Deliverability Tool phrases
  EMAIL_DELIVERABILITY_TOOL: 'Email Deliverability Tool',
  EMAIL_DELIVERABILITY_DESCRIPTION:
    'Analyze raw email messages and debug deliverability issues with comprehensive insights and actionable recommendations',
  UPLOAD_EMAIL_FOR_ANALYSIS: 'Upload Email for Analysis',
  UPLOAD_EML_FILE: 'Upload .eml File',
  SELECT_EML_FILE: 'Select an email file (.eml format) to analyze',
  OR: 'OR',
  PASTE_RAW_EMAIL_CONTENT: 'Paste Raw Email Content',
  PASTE_COMPLETE_RAW_EMAIL:
    'Paste the complete raw email headers and body here...',
  INCLUDE_ALL_HEADERS_BODY:
    'Include all headers and body content from the raw email source',
  DOMAIN_OPTIONAL: 'Domain (Optional)',
  OVERRIDE_DOMAIN_DNS: 'Override domain for DNS analysis',
  ANALYZE_EMAIL: 'Analyze Email',
  ANALYZING_EMAIL: 'Analyzing Email...',
  ANALYSIS_TAKE_MOMENTS: 'This may take a few moments',
  DELIVERABILITY_ANALYSIS_RESULTS: 'Deliverability Analysis Results',
  ...
  LOADING_EMAIL_DETAILS: 'Loading email details...',
  MAIL_FLOW: 'Mail Flow',
  LOADING_MAIL_FLOW: 'Loading mail flow analysis...',
  SPF: 'SPF',
  CHECKING: 'Checking...',
  DKIM: 'DKIM',
  DMARC: 'DMARC',
  ARC: 'ARC',
  LOADING_DNS_ANALYSIS: 'Loading DNS analysis...',
  LOADING_HEADER_ANALYSIS: 'Loading header analysis...',
  ANALYZING_IP_REPUTATION: 'Analyzing IP reputation...',
  GENERATING_RECOMMENDATIONS: 'Generating recommendations...',
  INBOX_PLACEMENT_PROBABILITY: 'Inbox Placement Probability',
  CALCULATING_PLACEMENT_PROBABILITY: 'Calculating placement probability...',
  RISK_ASSESSMENT: 'Risk Assessment',
  ANALYZING_IMPLEMENTATION_RISKS: 'Analyzing implementation risks...',
  SMART_INSIGHTS: 'Smart Insights',
  GENERATING_INTELLIGENT_INSIGHTS: 'Generating intelligent insights...',
  IMPLEMENTATION_PLAN: 'Implementation Plan',
  CREATING_IMPLEMENTATION_TIMELINE: 'Creating implementation timeline...',
  TIME_ESTIMATES: 'Time Estimates',
  CALCULATING_TIME_REQUIREMENTS: 'Calculating time requirements...',
  DNS_RECORDS_CHECK: 'DNS Records Check',
  DNS_CHECK_DESCRIPTION:
    'Check SPF, DKIM, DMARC, and other DNS records for any domain',
  DOMAIN_NAME: 'Domain Name',
  CHECK_DNS_RECORDS: 'Check DNS Records',
  CHECKING_DNS_RECORDS: 'Checking DNS Records...',
  ANALYZING_DNS_CONFIGURATION: 'Analyzing DNS configuration',
  DNS_ANALYSIS_RESULTS: 'DNS Analysis Results',
  ANALYZED_DOMAIN: 'Analyzed Domain:',
  MTA_STS: 'MTA-STS',
