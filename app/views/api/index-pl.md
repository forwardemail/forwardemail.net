...
| Parametr w ciele | Wymagany | Typ    | Opis                                                                                                                                                                                                                      |
| ---------------- | -------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `new_password`   | Nie      | String | Twoje własne nowe hasło do użycia jako hasło catch-all dla całej domeny.  Możesz pozostawić to pole puste lub całkowicie pominąć w ciele zapytania API, jeśli chcesz otrzymać losowo wygenerowane i silne hasło.              Niestandardowe hasła do skrzynek pocztowych muszą mieć maksymalnie 128 znaków, nie mogą zaczynać się ani kończyć na spację oraz nie mogą zawierać cudzysłowów ani apostrofów. Hasła catch-all służą wyłącznie do wysyłania przez SMTP. Do dostępu przez IMAP, POP3, CalDAV, CardDAV oraz do skrzynki pocztowej generuj hasło dla konkretnego aliasu. |
...
| Parametr w ciele      | Wymagany | Typ     | Opis                                                                                                                                                                                                                                                                                              |
| --------------------- | -------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `new_password`        | Nie      | String  | Twoje niestandardowe nowe hasło do użycia dla aliasu. Możesz pozostawić to pole puste lub całkowicie pominąć w ciele żądania API, jeśli chcesz otrzymać losowo wygenerowane i silne hasło.                                                                                                        Niestandardowe hasła do skrzynek pocztowych muszą mieć maksymalnie 128 znaków, nie mogą zaczynać się ani kończyć na spację oraz nie mogą zawierać cudzysłowów ani apostrofów. |
