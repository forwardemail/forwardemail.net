...
| -------------- | ---------- | ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `new_password` | Ei         | Merkkijono | Oma uusi salasanasi, jota käytetään domainin catch-all-salasanana. Huomaa, että voit jättää tämän tyhjäksi tai kokonaan pois API-pyynnön rungosta, jos haluat saada satunnaisesti luodun ja vahvan salasanan.                Mukautettujen postilaatikon salasanojen on oltava enintään 128 merkkiä pitkiä, ne eivät saa alkaa tai päättyä välilyöntiin, eikä niiden saa sisältää lainaus- tai heittomerkkejä. Catch-all-salasanat ovat tarkoitettu vain SMTP-lähetykseen. IMAP-, POP3-, CalDAV-, CardDAV- ja postilaatikon käyttöä varten luo salasana tietylle aliasille. |
...
| Body Parameter         | Pakollinen | Tyyppi   | Kuvaus                                                                                                                                                                                                                                                                                           |
| ---------------------- | ---------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `new_password`         | Ei         | Merkkijono | Oma uusi salasana aliasille. Voit jättää tämän tyhjäksi tai kokonaan pois API-pyynnön rungosta, jos haluat saada satunnaisesti luodun vahvan salasanan.                                                                                                                                         Mukautettujen postilaatikon salasanojen on oltava enintään 128 merkkiä pitkiä, ne eivät saa alkaa tai päättyä välilyöntiin, eikä niiden saa sisältää lainaus- tai heittomerkkejä. |
