...
| معامل الجسم | مطلوب | النوع   | الوصف                                                                                                                                                                                                                     |
| ------------ | ------ | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `new_password` | لا     | نص     | كلمة المرور الجديدة المخصصة التي تريد استخدامها لكلمة المرور الشاملة للنطاق. لاحظ أنه يمكنك ترك هذا الحقل فارغًا أو عدم تضمينه في جسم طلب API إذا كنت ترغب في الحصول على كلمة مرور قوية وعشوائية يتم إنشاؤها تلقائيًا.  يجب أن تكون كلمات مرور صناديق البريد المخصصة 128 حرفًا أو أقل، ولا يمكن أن تبدأ أو تنتهي بمسافات بيضاء، ولا يمكن أن تحتوي على علامات اقتباس أو فواصل مفردة. كلمات مرور catch-all مخصصة للإرسال عبر SMTP فقط. للوصول إلى IMAP وPOP3 وCalDAV وCardDAV وصندوق البريد، أنشئ كلمة مرور للملف التعريفي المحدد بدلاً من ذلك. |
...
| معامل الجسم           | مطلوب | النوع    | الوصف                                                                                                                                                                                                                                                                                             |
| --------------------- | ------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `new_password`        | لا      | نص       | كلمة المرور الجديدة المخصصة التي تريد استخدامها للاسم المستعار. لاحظ أنه يمكنك ترك هذا الحقل فارغًا أو عدم تضمينه تمامًا في جسم طلب API إذا كنت ترغب في الحصول على كلمة مرور قوية وعشوائية التوليد.                                                                                           يجب أن تكون كلمات مرور صناديق البريد المخصصة 128 حرفًا أو أقل، ولا يمكن أن تبدأ أو تنتهي بمسافات بيضاء، ولا يمكن أن تحتوي على علامات اقتباس أو فواصل مفردة. |
