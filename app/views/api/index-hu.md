...
| -------------- | -------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `new_password` | Nem      | String | Egyéni új jelszó a domain szintű catch-all jelszóhoz. Megjegyzés: ezt üresen hagyhatja vagy teljesen el is hagyhatja az API kérés törzséből, ha véletlenszerűen generált és erős jelszót szeretne kapni.                         |
...
| Body Parameter         | Kötelező | Típus    | Leírás                                                                                                                                                                                                                                                                                         |
| ---------------------- | -------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `new_password`         | Nem      | String  | Egyéni új jelszó az alias számára. Megjegyzés: ezt üresen hagyhatod vagy teljesen el is hagyhatod az API kérésed törzséből, ha véletlenszerűen generált és erős jelszót szeretnél kapni.                                                                                                    |
