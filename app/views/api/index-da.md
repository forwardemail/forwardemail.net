...
| Body Parameter | Påkrævet | Type   | Beskrivelse                                                                                                                                                                                                               |
| -------------- | -------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `new_password` | Nej      | String | Din brugerdefinerede nye adgangskode til brug for den domænedækkende catch-all adgangskode. Bemærk, at du kan lade denne være tom eller helt udelade den i din API-forespørgsels body, hvis du ønsker at få en tilfældigt genereret og stærk adgangskode.  Brugertilpassede mailbokskoder må være højst 128 tegn, må ikke starte eller slutte med mellemrum og må ikke indeholde anførselstegn eller apostroffer. Catch-all adgangskoder er kun til SMTP-afsendelse. For IMAP, POP3, CalDAV, CardDAV og postkasseadgang, generer en adgangskode til den specifikke alias i stedet. |
...
| Body Parameter         | Påkrævet | Type    | Beskrivelse                                                                                                                                                                                                                                                                                         |
| ---------------------- | -------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `new_password`         | Nej      | String  | Dit brugerdefinerede nye kodeord til aliaset. Bemærk, at du kan lade dette være tomt eller helt udelade det fra din API-forespørgsels krop, hvis du ønsker at få et tilfældigt genereret og stærkt kodeord.                                                                                           Brugertilpassede mailbokskoder må være højst 128 tegn, må ikke starte eller slutte med mellemrum og må ikke indeholde anførselstegn eller apostroffer. |
