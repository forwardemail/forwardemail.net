...
| Paramètre du corps | Obligatoire | Type   | Description                                                                                                                                                                                                               |
| ------------------ | ----------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `new_password`     | Non         | String | Votre nouveau mot de passe personnalisé à utiliser pour le mot de passe catch-all du domaine. Notez que vous pouvez laisser ce champ vide ou l’omettre complètement dans le corps de votre requête API si vous souhaitez obtenir un mot de passe fort généré aléatoirement.  Les mots de passe personnalisés des boîtes mail doivent comporter au maximum 128 caractères, ne doivent pas commencer ou se terminer par un espace, et ne doivent contenir ni guillemets ni apostrophes. Les mots de passe catch-all sont uniquement pour l’envoi SMTP. Pour IMAP, POP3, CalDAV, CardDAV et l’accès à la boîte mail, générez plutôt un mot de passe pour l'alias spécifique. |
...
| Paramètre du corps     | Obligatoire | Type    | Description                                                                                                                                                                                                                                                                                         |
| --------------------- | ----------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `new_password`        | Non         | Chaîne  | Votre nouveau mot de passe personnalisé à utiliser pour l'alias. Notez que vous pouvez laisser ce champ vide ou l'omettre complètement dans le corps de votre requête API si vous souhaitez obtenir un mot de passe fort généré aléatoirement.                                                                                                     Les mots de passe personnalisés des boîtes mail doivent comporter au maximum 128 caractères, ne doivent pas commencer ou se terminer par un espace, et ne doivent contenir ni guillemets ni apostrophes. |
