...
| Port (SSL/TLS) | `2455` |
| Port (STARTTLS) | `2555` |
| Nom d'utilisateur | Your alias email (e.g., `camera@yourdomain.com`) |
| Mot de passe | The password from "Generate Password" |
| Authentication | Indispensable |
...
| Fournisseur | SMTP Server | Port | App Password Required? |
| -------- | --------------------- | ---- | ---------------------- |
