...
| Port (SSL/TLS) | `2455` |
| Port (STARTTLS) | `2555` |
| ชื่อผู้ใช้ | Your alias email (e.g., `camera@yourdomain.com`) |
...
| ผู้ให้บริการ | SMTP Server | Port | App Password Required? |
| -------- | --------------------- | ---- | ---------------------- |
| Gmail | smtp.gmail.com | 587 | ใช่ |
| มองการณ์ไกล | smtp-mail.outlook.com | 587 | ใช่ |
