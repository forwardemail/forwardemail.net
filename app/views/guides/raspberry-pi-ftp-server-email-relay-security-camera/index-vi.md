...
| Mật khẩu | The password from "Generate Password" |
| Authentication | Hãy cung cấp văn bản cần dịch |
...
| Dịch vụ | SMTP Server | Port | App Password Required? |
| -------- | --------------------- | ---- | ---------------------- |
