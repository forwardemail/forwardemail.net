...
ufw allow 587/tcp   # SMTP gönderimi (STARTTLS)
...
# nginx (sni-router hizmeti) TLS'yi 443'te sonlandırır ve 3000'deki web
# uygulamasına proxy yapar (bkz. docker-compose-self-hosted.yml ve nginx.conf).
# WEB_PORT değerini 3000'de bırakın; 443 olarak ayarlamak ana makine ağında
# nginx ile çakışır ve web arayüzünü erişilemez hale getirir.
...
# Redis yedekleme cron görevi ekle (her gün 00:30'da çalışır, iki yüklemenin aynı
# bant genişliği için yarışmaması amacıyla MongoDB yedeğinden 30 dakika sonraya kaydırılmıştır)
