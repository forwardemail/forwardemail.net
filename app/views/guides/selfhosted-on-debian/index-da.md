...
ufw allow 587/tcp   # SMTP-indsendelse (STARTTLS)
...
# nginx (sni-router-tjenesten) afslutter TLS på 443 og fungerer som proxy til
# web-appen på 3000 (se docker-compose-self-hosted.yml og nginx.conf). Lad
# WEB_PORT stå på 3000; at sætte den til 443 kolliderer med nginx på værtsnetværket
# og gør webgrænsefladen utilgængelig.
...
# Tilføj cron-job til Redis-backup (kører dagligt kl. 00:30, forskudt 30 minutter
# efter MongoDB-backuppen, så de to uploads ikke konkurrerer om den samme båndbredde)
