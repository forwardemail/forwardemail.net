...
ufw allow 587/tcp   # SMTP-inlämning (STARTTLS)
...
# nginx (sni-router-tjänsten) avslutar TLS på 443 och fungerar som proxy till
# webbappen på 3000 (se docker-compose-self-hosted.yml och nginx.conf). Låt
# WEB_PORT vara 3000; att sätta den till 443 krockar med nginx på värdnätverket
# och gör webbgränssnittet oåtkomligt.
...
# Lägg till cron-jobb för Redis-säkerhetskopiering (körs dagligen kl. 00:30,
# förskjutet 30 minuter efter MongoDB-säkerhetskopian så att de två uppladdningarna inte konkurrerar om samma bandbredd)
