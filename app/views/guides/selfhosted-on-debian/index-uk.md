...
ufw allow 587/tcp   # Надсилання SMTP (STARTTLS)
...
# nginx (служба sni-router) завершує TLS на 443 і проксіює до веб-застосунку
# на 3000 (див. docker-compose-self-hosted.yml і nginx.conf). Залиште WEB_PORT
# рівним 3000; встановлення 443 конфліктує з nginx у мережі хоста й робить
# веб-інтерфейс недоступним.
...
# Додати cron-завдання резервного копіювання Redis (виконується щодня о 00:30,
# зі зсувом на 30 хвилин після копіювання MongoDB, щоб обидва вивантаження не конкурували за одну смугу пропускання)
