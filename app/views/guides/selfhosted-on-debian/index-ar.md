...
ufw allow 587/tcp   # إرسال SMTP (STARTTLS)
...
# يُنهي nginx (خدمة sni-router) اتصال TLS على المنفذ 443 ويعمل كوكيل لتطبيق
# الويب على المنفذ 3000 (راجع docker-compose-self-hosted.yml و nginx.conf).
# اترك WEB_PORT على 3000؛ ضبطه على 443 يتعارض مع nginx على شبكة المضيف
# ويجعل واجهة الويب غير قابلة للوصول.
...
# أضف مهمة cron لنسخ Redis الاحتياطي (تعمل يوميًا في الساعة 00:30، بفارق 30 دقيقة
# بعد نسخة MongoDB الاحتياطية حتى لا يتنافس التحميلان على نفس عرض النطاق الترددي)
