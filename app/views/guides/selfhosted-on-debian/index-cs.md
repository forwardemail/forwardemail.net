...
ufw allow 587/tcp   # Odesílání SMTP (STARTTLS)
...
# nginx (služba sni-router) ukončuje TLS na portu 443 a funguje jako proxy k
# webové aplikaci na portu 3000 (viz docker-compose-self-hosted.yml a nginx.conf).
# Ponechte WEB_PORT na 3000; nastavení na 443 koliduje s nginx v síti hostitele
# a způsobí, že webové rozhraní bude nedostupné.
...
# Přidat úlohu cron pro zálohu Redis (spouští se denně v 00:30, posunutá o 30 minut
# po záloze MongoDB, aby si obě nahrávání nekonkurovala o stejnou šířku pásma)
