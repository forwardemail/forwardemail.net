...
ufw allow 587/tcp   # Gửi SMTP (STARTTLS)
...
# nginx (dịch vụ sni-router) kết thúc TLS trên cổng 443 và làm proxy đến ứng dụng
# web trên cổng 3000 (xem docker-compose-self-hosted.yml và nginx.conf). Hãy để
# WEB_PORT ở 3000; đặt thành 443 sẽ xung đột với nginx trên mạng của máy chủ
# và khiến giao diện web không thể truy cập được.
...
# Thêm tác vụ cron sao lưu Redis (chạy hằng ngày lúc 00:30, lệch 30 phút sau bản
# sao lưu MongoDB để hai lần tải lên không tranh cùng một băng thông)
