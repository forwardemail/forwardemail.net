...
ufw allow 587/tcp   # SMTP-innsending (STARTTLS)
...
# nginx (sni-router-tjenesten) terminerer TLS på 443 og fungerer som proxy til
# web-appen på 3000 (se docker-compose-self-hosted.yml og nginx.conf). La
# WEB_PORT stå på 3000; å sette den til 443 kolliderer med nginx på vertsnettet
# og gjør nettgrensesnittet utilgjengelig.
...
# Legg til cron-jobb for Redis-sikkerhetskopiering (kjører daglig kl. 00:30,
# forskjøvet 30 minutter etter MongoDB-sikkerhetskopien slik at de to opplastingene ikke konkurrerer om samme båndbredde)
