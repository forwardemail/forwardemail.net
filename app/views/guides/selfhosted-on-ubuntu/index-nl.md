...
# nginx (de sni-router-service) termineert TLS op 443 en fungeert als proxy naar
# de web-app op 3000 (zie docker-compose-self-hosted.yml en nginx.conf). Laat
# WEB_PORT op 3000 staan; instellen op 443 botst met nginx op het host-netwerk
# en maakt de webinterface onbereikbaar.
...
# Redis-back-up-cronjob toevoegen (draait dagelijks om 00:30 uur, met 30 minuten
# verschoven na de MongoDB-back-up zodat de twee uploads niet om dezelfde bandbreedte strijden)
