...
ufw allow 587/tcp   # SMTP-beküldés (STARTTLS)
...
# az nginx (a sni-router szolgáltatás) a 443-on zárja le a TLS-t, és proxyként
# továbbít a webalkalmazáshoz a 3000-en (lásd docker-compose-self-hosted.yml és
# nginx.conf). Hagyd a WEB_PORT értékét 3000-en; 443-ra állítva ütközik az
# nginx-szel a gazdagép hálózatán, és elérhetetlenné teszi a webes felületet.
...
# Redis biztonsági mentés cron feladat hozzáadása (naponta 00:30-kor fut, a MongoDB
# mentése után 30 perccel eltolva, hogy a két feltöltés ne versengjen ugyanazért a sávszélességért)
