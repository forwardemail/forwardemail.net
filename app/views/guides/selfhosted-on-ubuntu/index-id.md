...
ufw allow 587/tcp   # Pengiriman SMTP (STARTTLS)
...
# nginx (layanan sni-router) mengakhiri TLS di 443 dan menjadi proxy ke aplikasi
# web di 3000 (lihat docker-compose-self-hosted.yml dan nginx.conf). Biarkan
# WEB_PORT tetap 3000; menyetelnya ke 443 berbenturan dengan nginx di jaringan
# host dan membuat antarmuka web tidak dapat dijangkau.
...
# Tambahkan tugas cron pencadangan Redis (berjalan setiap hari pukul 00:30,
# digeser 30 menit setelah pencadangan MongoDB agar kedua unggahan tidak berebut bandwidth yang sama)
