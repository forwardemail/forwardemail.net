...
ufw allow 587/tcp   # Envio SMTP (STARTTLS)
...
# o nginx (o serviço sni-router) termina o TLS na 443 e faz proxy para a
# aplicação web na 3000 (consulte docker-compose-self-hosted.yml e nginx.conf).
# Deixe WEB_PORT em 3000; defini-la como 443 entra em conflito com o nginx na
# rede do host e torna a interface web inacessível.
...
# Adicionar tarefa cron de backup do Redis (executa diariamente às 00:30,
# escalonada 30 minutos após o backup do MongoDB para que os dois envios não disputem a mesma largura de banda)
