...
# nginx (der sni-router-Dienst) terminiert TLS auf 443 und leitet als Proxy an
# die Web-App auf 3000 weiter (siehe docker-compose-self-hosted.yml und
# nginx.conf). Belasse WEB_PORT bei 3000; auf 443 gesetzt kollidiert es mit
# nginx im Host-Netzwerk und macht die Weboberfläche unerreichbar.
...
# Redis-Backup-Cronjob hinzufügen (läuft täglich um 00:30 Uhr, um 30 Minuten
# nach dem MongoDB-Backup versetzt, damit die beiden Uploads nicht um dieselbe Bandbreite konkurrieren)
