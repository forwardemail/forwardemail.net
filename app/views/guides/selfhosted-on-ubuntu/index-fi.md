...
ufw allow 587/tcp   # SMTP-lähetys (STARTTLS)
...
# nginx (sni-router-palvelu) päättää TLS:n portissa 443 ja välittää liikenteen
# web-sovellukselle porttiin 3000 (katso docker-compose-self-hosted.yml ja
# nginx.conf). Jätä WEB_PORT arvoon 3000; arvon 443 asettaminen aiheuttaa
# ristiriidan nginxin kanssa isäntäverkossa ja tekee web-käyttöliittymästä tavoittamattoman.
...
# Lisää Redis-varmuuskopioinnin cron-tehtävä (suoritetaan päivittäin klo 00:30,
# porrastettuna 30 minuuttia MongoDB-varmuuskopion jälkeen, jotta lataukset eivät kilpaile samasta kaistanleveydestä)
