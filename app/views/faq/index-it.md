...
* [Configurazione e-mail](#email-configuration)
  ...
  * [Come faccio a impostare un risponditore automatico per assenza dall'ufficio?](#how-do-i-set-up-a-vacation-responder-out-of-office-auto-responder)
...
### Che cos'è Inoltra email {#what-is-forward-email}
...
| Nell'umanità | [:page_facing_up: Case Study](/blog/docs/canonical-ubuntu-email-enterprise-case-study) |
...
| Collegio di Swarthmore | [:page_facing_up: Case Study](/blog/docs/alumni-email-forwarding-university-case-study) |
...
Non scriviamo su disco né memorizziamo registri, con [eccezione di errori](#do-you-store-error-logs) e [SMTP in uscita](#do-you-support-sending-email-with-smtp) (vedere il nostro [politica sulla riservatezza](/privacy)).

Tutto viene fatto in memoria e [il nostro codice sorgente è su GitHub](https://github.com/forwardemail).

## Client di posta elettronica {#email-clients}

__URL_PROTETTO_463__ Thunderbird {__URL_PROTETTO_464__
...
__URL_PROTETTO_465__ Microsoft Outlook {__URL_PROTETTO_466__
...
4. Vai su [Gmail](https://gmail.com) e sotto [Impostazioni <i class="fa fa-angle-right"></i> Account e importazione <i class="fa fa-angle-right"></i> Invia e-mail come](https://mail.google.com/mail/u/0/#settings/accounts), clicca su "Aggiungi un altro indirizzo email"
...
### Qual è la guida gratuita legacy per Invia email come tramite Gmail {#what-is-the-legacy-free-guide-for-send-mail-as-using-gmail}
...
1. Per funzionare, devi abilitare [l'autenticazione a due fattori di Gmail][gmail-2fa]. Visita <https://www.google.com/landing/2step/> se non l'hai abilitata.
...
<span>
Se utilizzi G Suite, visita il pannello di amministrazione <a class="alert-link" href="https://admin.google.com/AdminHome#ServiceSettings/service=email&subtab=filters" rel="noopener noreferrer" target="_blank">App <i class="fa fa-angle-right"></i> Impostazioni di G Suite <i class="fa fa-angle-right"></i> Impostazioni di Gmail <i class="fa fa-angle-right"></i> Impostazioni</a> e assicurati di selezionare "Consenti agli utenti di inviare email tramite un server SMTP esterno...". L'attivazione di questa modifica potrebbe richiedere del tempo, quindi attendi qualche minuto.
</span>
</div>

5. Vai su [Gmail](https://gmail.com) e sotto [Impostazioni <i class="fa fa-angle-right"></i> Account e importazione <i class="fa fa-angle-right"></i> Invia e-mail come](https://mail.google.com/mail/u/0/#settings/accounts), clicca su "Aggiungi un altro indirizzo email"
...
* Seleziona "Instrada verso host" e inserisci `mx1.forwardemail.net` come server primario
...
6. In **Esegui quanto segue**, seleziona:
...
8. Imposta la priorità della regola per assicurarti che venga eseguita dopo le altre regole del flusso di posta
9. Fai clic su **Salva** per attivare la regola
...
**Hai ancora problemi?** <a href="/help">Contattaci</a> così possiamo aiutarti a indagare sul problema e trovare una rapida soluzione.
...
Questa sezione ti guida nel caso in cui la tua posta in uscita utilizzi i nostri server SMTP (ad esempio `smtp.forwardemail.net`) (o venga inoltrata tramite `mx1.forwardemail.net` o `mx2.forwardemail.net`) e venga recapitata nella cartella Spam o Posta indesiderata dei destinatari.

Monitoriamo regolarmente il nostro [indirizzi IP](#what-are-your-servers-ip-addresses) rispetto a [tutte le denylist DNS affidabili](#how-do-you-handle-your-ip-addresses-becoming-blocked), **pertanto è molto probabile che si tratti di un problema specifico della reputazione del dominio**.
...
| Rimozione IP di Microsoft Outlook e Office 365 | <https://sendersupport.olc.protection.outlook.com/pm/Postmaster> | Rimozione |
...
Questo argomento è correlato a un [problema ampiamente noto in Gmail in cui vengono visualizzate informazioni aggiuntive accanto al nome del mittente](https://support.google.com/mail/answer/1311182).
...
In qualsiasi momento puoi esportare le tue caselle di posta nei formati [EML](https://en.wikipedia.org/wiki/Email#Filename_extensions), [M-box](https://en.wikipedia.org/wiki/Mbox) o crittografato [SQLite](https://en.wikipedia.org/wiki/SQLite).
...
| --------------- | :----: | ------------- | --------------------------------------------------- |
| Visualizzatore MBox | M-box | Finestre | <https://github.com/eneam/mboxviewer> |
| visualizzatore web mbox | M-box | Tutte le piattaforme | <https://github.com/PHMRanger/mbox-web-viewer> |
...
4. Scarica e installa il plugin [Strumenti di importazione ed esportazione OF](https://addons.thunderbird.net/en-GB/thunderbird/addon/importexporttools-ng/) Thunderbird.
...
<span>
Devi aprire una nuova scheda e accedere al tuo registrar di domini. Puoi facilmente cliccare sul tuo "Registrar" qui sotto per farlo automaticamente. In questa nuova scheda, devi accedere alla pagina di gestione DNS del tuo registrar – e abbiamo fornito la procedura dettagliata di navigazione nella colonna "Passaggi di configurazione" qui sotto. Una volta raggiunta questa pagina nella nuova scheda, puoi tornare a questa scheda e procedere al passaggio tre qui sotto.
...
<td>Accedi <i class="fa fa-angle-right"></i> I miei server <i class="fa fa-angle-right"></i> Gestione dominio <i class="fa fa-angle-right"></i> Gestore DNS</td>
</tr>
<tr>
...
<br />
PER LA VERSIONE LEGACY: Accedi <i class="fa fa-angle-right"></i> Domini <i class="fa fa-angle-right"></i> Editor di zona <i class="fa fa-angle-right"></i> (Seleziona il tuo dominio)</td>
</tr>
<tr>
...
<td>Accedi <i class="fa fa-angle-right"></i> Nella visualizzazione a schede, fai clic su Gestisci sul tuo dominio <i class="fa fa-angle-right"></i> Nella visualizzazione elenco, fai clic sull'icona a forma di ingranaggio <i class="fa fa-angle-right"></i> DNS e nameserver <i class="fa fa-angle-right"></i> Record DNS</td>
</tr>
<tr>
<td>
...
<tr>
<td>
<a rel="noopener noreferrer" target="_blank" href="https://domains.google.com/registrar">Google Domini</a>
<br />
...
<td>Accedi <i class="fa fa-angle-right"></i> Elenco domini <i class="fa fa-angle-right"></i> (Seleziona il tuo dominio) <i class="fa fa-angle-right"></i> Gestisci <i class="fa fa-angle-right"></i> Avanzate DNS</td>
</tr>
<tr>
...
<tr>
<td><a rel="noopener noreferrer" target="_blank" href="https://www.networksolutions.com/manage-it/index.jsp">Network Soluzioni</a></td>
...
<tr>
<td><a rel="noopener noreferrer" target="_blank" href="https://vercel.com/docs/now-cli?utm_source=zeit-dashboard&utm_medium=web&utm_campaign=configure-dns#commands/dns">Vercel's Ora</a></td>
<td>Utilizzo dell'interfaccia a riga di comando "now" <i class="fa fa-angle-right"></i> <code>now dns add [domain] '@' MX [record-value] [priority]</code></td>
</tr>
<tr>
<td><a rel="noopener noreferrer" target="_blank" href="https://www.weebly.com/app/help/us/en/topics/manage-dns-records">Weebly</a></td>
<td>Accedi alla pagina <i class="fa fa-angle-right"></i> Domini <i class="fa fa-angle-right"></i> (Seleziona il tuo dominio) <i class="fa fa-angle-right"></i> DNS</td>
</tr>
<tr>
...
<td>Altro</td>
<td>
<div class="alert mb-0 alert-warning"><i class="fa fa-exclamation-circle font-weight-bold"></i> <strong class="font-weight-bold">Importante:</strong> Non vedi il nome del tuo registrar elencato qui? Basta cercare su Internet "come modificare i record DNS su $REGISTRAR" (sostituendo $REGISTRAR con il nome del tuo registrar, ad esempio "come modificare i record DNS su GoDaddy" se utilizzi GoDaddy).</div>
</td>
</tr>
</tbody>
</table>
...
Ciò significa che le email in arrivo che corrispondono ad almeno una regola di inoltro specifica verranno utilizzate al posto della regola catch-all.
...
### Come faccio a impostare un risponditore automatico per assenza in ufficio? {#how-do-i-set-up-a-vacation-responder-out-of-office-auto-responder}
...
* Attualmente sono supportati oggetto e messaggio in testo normale (internamente utilizziamo il pacchetto `striptags` per rimuovere qualsiasi HTML).
...
* Vai a <a href="/my-account/domains" class="alert-link" target="_blank" rel="noopener noreferrer">Il mio account <i class="fa fa-angle-right"></i> Domini</a> <i class="fa fa-angle-right"></i> Impostazioni <i class="fa fa-angle-right"></i> Configurazione SMTP in uscita e segui le istruzioni di configurazione. * Il risponditore automatico non può essere abilitato sui nomi di dominio vanity globali (ad esempio, [indirizzi usa e getta](/disposable-addresses) non è supportato).
* Il risponditore automatico non può essere abilitato per alias con caratteri jolly/catch-all (`*`) né espressioni regolari.
...
2. Inviamo solo quando il campo MAIL FROM e/o From non è vuoto e non contiene (senza distinzione tra maiuscole e minuscole) un [nome utente postmaster](#what-are-postmaster-addresses) (la parte prima della @ in un'e-mail).
...
* Intestazione di `auto-submitted` con valore diverso da `no`. * Intestazione di `x-auto-response-suppress` con valore `dr`, `autoreply`, `auto-reply`, `auto_reply` o `all`
* Intestazione di `list-id`, `list-subscribe`, `list-unsubscribe`, `list-help`, `list-post`, `list-owner`, `list-archive`, `x-autoreply`, `x-autorespond` o `x-auto-respond` (indipendentemente dal valore).
* Intestazione di `precedence` con valore `bulk`, `autoreply`, `auto-reply`, `auto_reply` o `list`.
...
6. Non effettuiamo l'invio se è presente un'intestazione `content-type` senza distinzione tra maiuscole e minuscole di `multipart/report`.
...
### Come faccio a connettere e configurare i miei contatti {#how-do-i-connect-and-configure-my-contacts}
...
Se desideri aggiungere altri calendari, aggiungi semplicemente un nuovo URL calendario di: `https://caldav.forwardemail.net/dav/principals/calendar-name` (**assicurati di sostituire `calendar-name` con il nome del calendario desiderato**)
...
### Come posso impostare SRS per l'inoltro email {#how-do-i-set-up-srs-for-forward-email}

Noi configuriamo automaticamente [Schema di riscrittura del mittente](https://en.wikipedia.org/wiki/Sender_Rewriting_Scheme) ("SRS"): non è necessario che tu lo faccia.
...
1. Vai a <https://google.com> ed esci da tutti gli account email
...
6. Inserisci il tuo indirizzo email del nome di dominio personalizzato
...
11. Vai a <https://google.com> e, nell'angolo in alto a destra, fai clic sull'icona del tuo profilo e poi sul pulsante "Modifica"
...
Per inviare e-mail in uscita con la nostra API, devi utilizzare il tuo token API disponibile in [La mia sicurezza](/my-account/security).
...
<span>Se utilizzi Thunderbird, assicurati che "Sicurezza connessione" sia impostato su "SSL/TLS" e che il metodo di autenticazione sia impostato su "Password normale".</span>
</div>
...
5. Quando viene richiesta la porta del server POP3, inserire `995` (SSL/TLS) – vedere [porte POP3 alternative](/faq#what-are-your-pop3-server-configuration-settings) se necessario
...
Sì, supportiamo [Apri PGP](https://en.wikipedia.org/wiki/Pretty_Good_Privacy#OpenPGP), [crittografia end-to-end ("E2EE")](https://en.wikipedia.org/wiki/End-to-end_encryption) e la scoperta delle chiavi pubbliche tramite [Elenco delle chiavi Web ("WKD")](https://wiki.gnupg.org/WKD). È possibile configurare OpenPGP utilizzando [keys.openpgp.org](https://keys.openpgp.org/about/usage#wkd-as-a-service) o [ospita autonomamente le tue chiavi](https://wiki.gnupg.org/WKDHosting) (fare riferimento a [questo gist per la configurazione del server WKD](https://gist.github.com/kafene/0a6e259996862d35845784e6e5dbfc79)).

* Le ricerche WKD vengono memorizzate nella cache per 1 ora per garantire la consegna tempestiva delle email → pertanto, se aggiungi, modifichi o rimuovi la tua chiave WKD, inviaci un'email all'indirizzo `support@forwardemail.net` con il tuo indirizzo email in modo che possiamo svuotare manualmente la cache.
...
* Se hai più alias che corrispondono a un determinato indirizzo di inoltro (ad esempio, regex/carattere jolly/combinazione esatta) e se più di uno di questi contiene una chiave PGP caricata e ha PGP selezionato → ti invieremo un'email di avviso di errore e non crittograferemo il messaggio con la tua chiave PGP caricata. Questo è molto raro e di solito si applica solo agli utenti esperti con regole di alias complesse.
* **La crittografia PGP non verrà applicata all'inoltro email tramite i nostri server MX se il mittente ha impostato una politica DMARC di rifiuto. Se richiedi la crittografia PGP su *tutte* le email, ti consigliamo di utilizzare il nostro servizio IMAP e di configurare la tua chiave PGP per il tuo alias per la posta in arrivo.**

**È possibile convalidare la configurazione della directory Web Key su <https://wkd.chimbosonic.com/> (open-source) o <https://www.webkeydirectory.com/> (proprietario).**
...
| Gmail | Navigatore | [Mailvelope](https://mailvelope.com/) o [FlowCrypt](https://flowcrypt.com/download) (licenza proprietaria) | Gmail non supporta OpenPGP, tuttavia puoi scaricare il plugin open source [Mailvelope](https://mailvelope.com/) o [FlowCrypt](https://flowcrypt.com/download). |
...
| Veduta | Navigatore | [Mailvelope](https://mailvelope.com/) o [FlowCrypt](https://flowcrypt.com/download) (licenza proprietaria) | Il client di posta basato sul Web di Outlook non supporta OpenPGP, tuttavia è possibile scaricare il plugin open source [Mailvelope](https://mailvelope.com/) o [FlowCrypt](https://flowcrypt.com/download). |
...
| Google Chrome | Navigatore | [Mailvelope](https://mailvelope.com/) o [FlowCrypt](https://flowcrypt.com/download) (licenza proprietaria) | Puoi scaricare l'estensione open source del browser [Mailvelope](https://mailvelope.com/) o [FlowCrypt](https://flowcrypt.com/download). |
| Mozilla Firefox | Navigatore | [Mailvelope](https://mailvelope.com/) o [FlowCrypt](https://flowcrypt.com/download) (licenza proprietaria) | Puoi scaricare l'estensione open source del browser [Mailvelope](https://mailvelope.com/) o [FlowCrypt](https://flowcrypt.com/download). |
| Microsoft Edge | Navigatore | [Mailvelope](https://mailvelope.com/) | Puoi scaricare l'estensione open source del browser [Mailvelope](https://mailvelope.com/). |
| Coraggioso | Navigatore | [Mailvelope](https://mailvelope.com/) o [FlowCrypt](https://flowcrypt.com/download) (licenza proprietaria) | Puoi scaricare l'estensione open source del browser [Mailvelope](https://mailvelope.com/) o [FlowCrypt](https://flowcrypt.com/download). |
...
* `list_id` (Stringa) - il valore dell'intestazione `List-ID` (senza distinzione tra maiuscole e minuscole), se presente, dell'email in uscita originale
* `list_unsubscribe` (Stringa) - il valore dell'intestazione `List-Unsubscribe` (senza distinzione tra maiuscole e minuscole), se presente, dell'email in uscita originale
* `feedback_id` (Stringa) - il valore dell'intestazione `Feedback-ID` (senza distinzione tra maiuscole e minuscole), se presente, dell'email in uscita originale
* `recipient` (Stringa) - l'indirizzo email del destinatario che ha restituito la posta o ha generato un errore
* `message` (Stringa) - un messaggio di errore dettagliato per il bounce
...
* `bounce` (Oggetto) - un oggetto contenente le seguenti proprietà che descrivono in dettaglio il bounce e stato di rifiuto
* `action` (Stringa) - azione di rimbalzo (ad es. `"reject"`)
* `message` (Stringa) - motivo del rimbalzo (ad es. `"Message Sender Blocked By Receiving Server"`)
* `category` (Stringa) - categoria di rimbalzo (ad es. `"block"`)
* `code` (Numero) - codice di stato del rimbalzo (ad es. `554`)
* `status` (Stringa) - codice di rimbalzo dal messaggio di risposta (ad es. `5.7.1`)
* `line` (Numero) - numero di riga analizzata, se presente, [dall'elenco di analisi dei rimbalzi di Zone-MTA](https://github.com/zone-eu/zone-mta/blob/master/config/bounces.txt) (ad esempio `526`)
* `headers` (Oggetto) - coppia chiave-valore delle intestazioni per l'email in uscita
* `bounced_at` (Stringa) - data formattata [ISO 8601](https://en.wikipedia.org/wiki/ISO\_8601) in cui si è verificato l'errore di bounce
...
* Se il payload del webhook contiene un valore `list_id`, `list_unsubscribe` o `feedback_id`, è necessario adottare le misure appropriate per rimuovere `recipient` dall'elenco, se necessario.
* Se il valore `bounce.category` era `"block"`, `"recipient"`, `"spam"` o `"virus"`, è necessario rimuovere definitivamente l'utente dall'elenco. * Se devi verificare i payload dei webhook (per assicurarti che provengano effettivamente dal nostro server), puoi [risolvere l'indirizzo IP del client remoto o il nome host del client utilizzando una ricerca inversa](https://nodejs.org/api/dns.html#dnspromisesreverseip) – dovrebbe essere `smtp.forwardemail.net`.
...
* Calcola e confronta il valore `X-Webhook-Signature` della nostra richiesta webhook con il valore del corpo calcolato utilizzando questa chiave. Un esempio di come farlo è disponibile all'indirizzo [questo post di Stack Overflow](https://stackoverflow.com/a/68885281).
* Consulta la discussione all'indirizzo <https://github.com/forwardemail/free-email-forwarding/issues/235> per ulteriori informazioni. * Attenderemo fino a `5` secondi affinché l'endpoint del tuo webhook risponda con un codice di stato `200` e riproveremo fino a `1`.
* Se rileviamo un errore nell'URL del tuo webhook di rimbalzo durante il tentativo di inviargli una richiesta, ti invieremo un'email di cortesia una volta a settimana.
...
Sì, abbiamo aggiunto questa funzionalità dal 15 maggio 2020. Puoi semplicemente aggiungere webhook esattamente come faresti con qualsiasi destinatario! Assicurati di avere il prefisso "http" o "https" nell'URL del webhook.
...
* Puoi anche verificare l'IP con [i nostri indirizzi IP pubblicati](#what-are-your-servers-ip-addresses).
...
* Puoi ruotare questa chiave in qualsiasi momento per motivi di sicurezza.
* Calcola e confronta il valore `X-Webhook-Signature` della nostra richiesta webhook con il valore del corpo calcolato utilizzando questa chiave. Un esempio di come farlo è disponibile all'indirizzo [questo post di Stack Overflow](https://stackoverflow.com/a/68885281). * Consulta la discussione all'indirizzo <https://github.com/forwardemail/free-email-forwarding/issues/235> per maggiori informazioni.
* Se un webhook non risponde con un codice di stato `200`, memorizzeremo la sua risposta in [registro degli errori creato](#do-you-store-error-logs), utile per il debug.
* Le richieste HTTP del webhook verranno ritentate fino a 3 volte per ogni tentativo di connessione SMTP, con un timeout massimo di 60 secondi per richiesta POST dell'endpoint. **Nota che questo non significa che verranno ritentati solo 3 volte**, ma che verranno ritentati continuamente nel tempo inviando un codice SMTP 421 (che indica al mittente di riprovare in seguito) dopo il terzo tentativo di richiesta HTTP POST non riuscito. Ciò significa che l'email verrà ritentata continuamente per giorni fino a quando non verrà raggiunto un codice di stato 200.
* Ritenteremo automaticamente in base allo stato predefinito e ai codici di errore utilizzati in [metodo di ripetizione del superagente](https://ladjs.github.io/superagent/#retrying-requests) (siamo responsabili della manutenzione). * Raggruppiamo le richieste HTTP webhook allo stesso endpoint in un'unica richiesta anziché in più richieste per risparmiare risorse e velocizzare i tempi di risposta. Ad esempio, se si invia un'email a <webhook1@example.com>, <webhook2@example.com> e <webhook3@example.com>, e tutte queste sono configurate per raggiungere lo stesso URL dell'endpoint *esatto*, verrà effettuata una sola richiesta. Raggruppiamo in base alla corrispondenza esatta dell'endpoint con stretta uguaglianza.
* Si noti che utilizziamo il metodo "simpleParser" della libreria [parser di posta](https://nodemailer.com/extras/mailparser/) per analizzare il messaggio in un oggetto compatibile con JSON.
* Il valore raw dell'email come stringa viene specificato come proprietà "raw".
* I risultati dell'autenticazione vengono specificati come proprietà "dkim", "spf", "arc", "dmarc" e "bimi". * Le intestazioni email analizzate vengono fornite come proprietà "headers", ma si noti che è possibile utilizzare "headerLines" per semplificare l'iterazione e l'analisi.
* I destinatari raggruppati per questo webhook vengono raggruppati e forniti come proprietà "recipients".
* Le informazioni sulla sessione SMTP vengono fornite come proprietà "session". Queste informazioni includono il mittente del messaggio, l'ora di arrivo del messaggio, HELO e il nome host del client. Il valore del nome host del client, come `session.clientHostname`, è il nome di dominio completo (FQDN) (da una ricerca PTR inversa) oppure `session.remoteAddress` racchiuso tra parentesi quadre (ad esempio, `"[127.0.0.1]"`). * Se hai bisogno di un modo rapido per ottenere il valore di `X-Original-To`, puoi utilizzare il valore di `session.recipient` (vedi esempio sotto). L'intestazione `X-Original-To` è un'intestazione che aggiungiamo ai messaggi per il debug con il destinatario originale (prima dell'inoltro mascherato) del messaggio.
* Se devi rimuovere le proprietà `attachments` e/o `raw` dal corpo del payload, aggiungi semplicemente `?attachments=false`, `?raw=false` o `?attachments=false&raw=false` all'endpoint del webhook come parametro querystring (ad esempio `https://example.com/webhook?attachments=false&raw=false`). * Se sono presenti allegati, questi verranno aggiunti all'array `attachments` con i valori del buffer. È possibile analizzarli nuovamente e trasformarli in contenuto utilizzando un approccio con JavaScript come:
...
Gli alias supportati dalle espressioni regolari sono quelli che iniziano con `/` e terminano con `/` e i loro destinatari sono indirizzi email o webhook. I destinatari possono anche includere il supporto per la sostituzione di espressioni regolari (ad esempio `$1`, `$2`).

Supportiamo due flag di espressioni regolari, tra cui `i` e `g`. Il flag `i`, che non distingue tra maiuscole e minuscole, è un'impostazione predefinita permanente e viene sempre applicato. Il flag globale `g` può essere aggiunto aggiungendo alla desinenza `/` `/g`.
...
<div class="alert my-3 alert-secondary">
<i class="fa fa-info-circle font-weight-bold"></i>
<strong>Esempio di sostituzione del filtro con il simbolo più:</strong> Se voglio che tutte le email che vanno a `info@example.com` o `support@example.com` vengano inoltrate rispettivamente a `user+info@gmail.com` o `user+support@gmail.com` (con supporto per la sostituzione) (<a href="https://regexr.com/66ho7" class="alert-link">visualizza il test su RegExr</a>):
</div>
...
<div class="alert my-3 alert-secondary">
<i class="fa fa-info-circle font-weight-bold"></i>
<strong>Esempio di soft reject:</strong> se desideri disabilitare tutte le email che corrispondono a un determinato pattern e rifiutarle con il codice di stato `421` (vedi <a href="#can-i-disable-specific-aliases" class="alert-link">Posso disabilitare alias specifici</a>), usa semplicemente lo stesso approccio con un doppio punto esclamativo "!!". Questo indica al mittente di riprovare l'invio dell'email e le email a questo alias verranno ritentate per circa 5 giorni e poi rifiutate definitivamente.
</div>
...
<div class="alert my-3 alert-secondary">
<i class="fa fa-info-circle font-weight-bold"></i>
<strong>Esempio di rifiuto definitivo:</strong> se desideri disabilitare tutte le email che corrispondono a un determinato schema e rifiutarle definitivamente con il codice di stato `550` (vedi <a href="#can-i-disable-specific-aliases" class="alert-link">Posso disabilitare alias specifici</a>), allora usa semplicemente lo stesso approccio con un triplo punto esclamativo "!!!". Questo indica al mittente un errore permanente e le email non verranno riprovate, ma rifiutate per questo alias.
</div>
...
Il limite massimo consentito per utenti e domini è di 300 messaggi SMTP in uscita al giorno. Questo equivale in media a oltre 9000 email in un mese solare. Se devi superare questo limite o hai email costantemente di grandi dimensioni, ti preghiamo di [contattaci](https://forwardemail.net/help).
...
Il nostro server è `smtp.forwardemail.net` ed è monitorato anche sulla nostra <a href="https://status.forwardemail.net" target="_blank" rel="noopener noreferrer">pagina di stato</a>.
...
### Tecniche avanzate di rafforzamento della sicurezza del server {#advanced-server-hardening-techniques}
...
* **Vultr**: certificazione SOC 2+ (HIPAA), certificazioni ISO/IEC: 20000-1:2018, 27001:2022, 27017:2015, 27018:2019. Dettagli: <https://www.vultr.com/legal/compliance/>

* **DataPacket**: conforme allo standard SOC 2 (contattare direttamente DataPacket per ottenere la certificazione), fornitore di infrastrutture di livello enterprise (sede di Denver). Dettagli: <https://www.datapacket.com/datacenters/denver>
...
* Moderne suite di crittografia con aggiornamenti di sicurezza regolari
...
**Prova del codice MX**: Il server MX elabora le email interamente in memoria, senza scriverne il contenuto su disco. Il gestore principale dell'elaborazione email dimostra questo approccio in memoria: <https://github.com/forwardemail/forwardemail.net/blob/master/helpers/on-data-mx.js>
...
**Gestione degli errori per problemi di sistema**: Forward Email utilizza le funzioni di supporto `isCodeBug` e `isTimeoutError` per garantire che, in caso di problemi di connettività al database, problemi di rete DNS/lista nera o problemi di connettività upstream, il sistema restituisca i codici di stato SMTP 421 per garantire che le e-mail vengano ritentate in un secondo momento anziché essere perse o esposte.
...
* <https://forwardemail.net/technical-whitepaper.pdf#page=15> (Prevenzione degli attacchi Evil Maid)
...
Fonte: <https://github.com/forwardemail/forwardemail.net> (Dettagli sull'ambiente di sviluppo)
...
No, non scriviamo su disco né memorizziamo registri, con [eccezione di errori](#do-you-store-error-logs) e [SMTP in uscita](#do-you-support-sending-email-with-smtp) (vedere il nostro [politica sulla riservatezza](/privacy)).

Tutto avviene in memoria e [il nostro codice sorgente è su GitHub](https://github.com/forwardemail).
...
* Connessione iniziale (nessun nome di comando, ad esempio `telnet example.com 25`) - Questa è la connessione iniziale. Verifichiamo i mittenti che non sono presenti nella nostra lista di [lista consentita](#do-you-have-an-allowlist) confrontandoli con quelli presenti nella nostra lista di [lista di rifiuto](#do-you-have-a-denylist). Infine, se un mittente non è presente nella nostra lista consentita, controlliamo se è stato incluso nella lista di [inserito nella lista grigia](#do-you-have-a-greylist).
...
* `DATA` - Questa è la parte principale del nostro servizio che elabora un'email. Consulta la sezione [Come si elabora un'e-mail per l'inoltro?](#how-do-you-process-an-email-for-forwarding) qui sotto per maggiori informazioni.

### Come si elabora un'e-mail per l'inoltro {#how-do-you-process-an-email-for-forwarding}

Questa sezione descrive il nostro processo relativo al comando del protocollo SMTP `DATA` nella sezione [Come funziona il tuo sistema di inoltro e-mail](#how-does-your-email-forwarding-system-work) sopra: è il modo in cui elaboriamo le intestazioni, il corpo e la sicurezza di un'e-mail, determiniamo dove deve essere recapitata e gestiamo le connessioni.
...
* `X-Forward-Email-Version` - la versione corrente di [SemVer](https://semver.org/) da `package.json` del nostro codice sorgente. * `X-Forward-Email-Session-ID` - un valore ID sessione utilizzato per scopi di debug (applicabile solo in ambienti non di produzione).
* `X-Forward-Email-Sender` - un elenco separato da virgole contenente l'indirizzo MAIL FROM originale della busta (se non era vuoto), l'FQDN del client PTR inverso (se esiste) e l'indirizzo IP del mittente.
...
* `X-Report-Abuse-To` - con un valore di `abuse@forwardemail.net`. * `X-Complaints-To` - con un valore di `abuse@forwardemail.net`.
...
* Se il messaggio non ha superato il test SPF e il dominio aveva una policy di hard fail (ad esempio, `-all` era nella policy SPF anziché `~all` o nessuna policy), viene rifiutato con un codice di errore 550. In genere, un criterio SPF per un dominio si trova nel record <strong class="notranslate">TXT</strong> del dominio radice (ad esempio `dig example.com txt`). Consulta questa sezione per ulteriori informazioni su [invio di posta come con Gmail](#can-i-send-mail-as-in-gmail-with-this) in merito a SPF.

9. Ora elaboriamo i destinatari del messaggio così come raccolti dal comando `RCPT TO` nella sezione [Come funziona il tuo sistema di inoltro e-mail](#how-does-your-email-forwarding-system-work) sopra. Per ciascun destinatario, eseguiamo le seguenti operazioni:
...
* Analizziamo tutti i record <strong class="notranslate">TXT</strong> che iniziano con `forward-email=` (piani gratuiti) o `forward-email-site-verification=` (piani a pagamento). Si noti che analizziamo entrambi i record per elaborare le email quando un utente effettua un upgrade o un downgrade del piano. * Da questi record <strong class="notranslate">TXT</strong> analizzati, eseguiamo un'iterazione per estrarre la configurazione di inoltro (come descritto nella sezione [Come posso iniziare e configurare l'inoltro delle email?](#how-do-i-get-started-and-set-up-email-forwarding) sopra). Si noti che supportiamo un solo valore `forward-email-site-verification=` e, se ne viene fornito più di uno, si verificherà un errore 550 e il mittente riceverà un messaggio di mancato recapito per questo destinatario.
...
* Per ogni Indirizzo di inoltro, supportiamo una ricerca ricorsiva (che avvierà questa serie di operazioni sull'indirizzo specificato). Se viene trovata una corrispondenza ricorsiva, il risultato padre verrà rimosso dagli Indirizzi di inoltro e i figli verranno aggiunti. * Gli indirizzi di inoltro vengono analizzati per verificarne l'univocità (poiché non vogliamo inviare duplicati a un indirizzo o generare connessioni client SMTP non necessarie).
...
* Cerchiamo le impostazioni del destinatario originale sul nostro endpoint API `/v1/settings`, che supporta una ricerca per gli utenti a pagamento (con un fallback per gli utenti gratuiti). Restituisce un oggetto di configurazione per le impostazioni avanzate di `port` (Numero, ad esempio `25`), `has_adult_content_protection` (Booleano), `has_phishing_protection` (Booleano), `has_executable_protection` (Booleano) e `has_virus_protection` (Booleano).
* In base a queste impostazioni, controlliamo i risultati dello Spam Scanner e, in caso di errori, il messaggio viene rifiutato con un codice di errore 554 (ad esempio, se `has_virus_protection` è abilitato, controlleremo i risultati dello Spam Scanner per individuare eventuali virus). Si noti che tutti gli utenti del piano gratuito saranno autorizzati a controllare contenuti per adulti, phishing, file eseguibili e virus. Per impostazione predefinita, anche tutti gli utenti del piano a pagamento sono autorizzati, ma questa configurazione può essere modificata nella pagina Impostazioni di un dominio nella dashboard di Inoltro email.
...
12. Se ci sono destinatari, li iteriamo (raggruppandoli in base allo stesso host) e inviamo le email. Per ulteriori informazioni, consultare la sezione [Come gestisci i problemi di recapito delle email?](#how-do-you-handle-email-delivery-issues) qui sotto.
...
14. Se si sono verificati dei bounce, invieremo email di bounce in background dopo aver restituito al mittente il codice di errore più basso tra tutti. Tuttavia, se il codice di errore più basso è >= 500, non invieremo alcuna email di bounce. Questo perché, se lo facessimo, i mittenti riceverebbero una doppia email di bounce (ad esempio, una dal loro MTA in uscita, come Gmail, e una da noi). Consultare la sezione relativa a [Come proteggersi dalla retrodiffusione](#how-do-you-protect-against-backscatter) qui sotto per ulteriori informazioni.

### Come gestisci i problemi di recapito delle email {#how-do-you-handle-email-delivery-issues}

Si noti che faremo una riscrittura "Friendly-From" sulle email solo se la politica DMARC del mittente non è stata superata E nessuna firma DKIM è stata allineata con l'intestazione "From". Ciò significa che modificheremo l'intestazione "From" sul messaggio, imposteremo "X-Original-From" e imposteremo anche un "Reply-To" se non era già impostato. Risigilleremo anche il sigillo ARC sul messaggio dopo aver modificato queste intestazioni.
...
### Cosa sono gli indirizzi del direttore dell'ufficio postale {#what-are-postmaster-addresses}

Per evitare rimbalzi indesiderati e l'invio di messaggi di risposta automatica a caselle di posta non monitorate o inesistenti, gestiamo un elenco di nomi utente simili a mailer-daemon:
...
* `majordomo`
* `postmaster`
* [e qualsiasi indirizzo di non risposta](#what-are-no-reply-addresses)
...
Sì, abbiamo [elenco delle estensioni di nomi di dominio](#what-domain-name-extensions-are-allowlisted-by-default) che sono inseriti nella lista consentita per impostazione predefinita e una lista consentita dinamica, memorizzata nella cache e mobile basata su [criteri rigorosi](#what-is-your-allowlist-criteria).
...
Inoltre, per impostazione predefinita, questi [domini di primo livello di marchi e aziende](https://en.wikipedia.org/wiki/List_of_Internet_top-level_domains#Brand_and_corporate_top-level_domains) sono consentiti (ad esempio, `apple` per `applecard.apple` per gli estratti conto bancari della Apple Card):
...
Disponiamo di un elenco statico di [estensioni di nomi di dominio consentite per impostazione predefinita](#what-domain-name-extensions-are-allowlisted-by-default) e gestiamo anche un elenco dinamico, memorizzato nella cache e soggetto a modifiche, basato sui seguenti rigorosi criteri:

* Il dominio radice del mittente deve essere di tipo [estensione del nome di dominio che corrisponde all'elenco che offriamo nel nostro piano gratuito](#what-domain-name-extensions-can-be-used-for-free) (con l'aggiunta di `biz` e `info`). Includiamo anche le corrispondenze parziali `edu`, `gov` e `mil`, come `xyz.gov.au` e `xyz.edu.au`.
* Il dominio radice del mittente deve essere tra i primi 100.000 risultati univoci analizzati per dominio radice da [Elenco di popolarità degli ombrelli](http://s3-us-west-1.amazonaws.com/umbrella-static/index.html "Umbrella Popularity List") ("UPL"). * Il dominio radice del mittente deve essere tra i primi 50.000 risultati di domini radice univoci presenti in almeno 4 degli ultimi 7 giorni di UPL (circa il 50%+).
* Il dominio radice del mittente non deve essere [categorizzato](https://radar.cloudflare.com/categorization-feedback/) come contenuto per adulti o malware da Cloudflare.
* Il dominio radice del mittente deve avere record A o MX impostati.
* Il dominio radice del mittente deve avere record A, record MX, record DMARC con qualificatore `p=reject` o `p=quarantine`, oppure un record SPF con qualificatore `-all` o `~all`.
...
Se sei un mittente non presente nella nostra lista consentita, la prima volta che il tuo dominio radice FQDN o indirizzo IP invia un'email, sarai [tariffa limitata](#do-you-have-rate-limiting) e [inserito nella lista grigia](#do-you-have-a-greylist). Si noti che questa è una prassi standard adottata per le email. La maggior parte dei client di posta elettronica tenterà di riprovare se riceve un errore di limite di velocità o di greylist (ad esempio, un codice di stato di errore di livello 421 o 4xx).
...
Sì, adottiamo una politica molto permissiva ([e-mail greylisting](https://en.wikipedia.org/wiki/Greylisting_\(email\)). La greylist si applica solo ai mittenti non presenti nella nostra lista consentita e rimane nella nostra cache per 30 giorni.
...
Ad esempio, se un'email proviene da `test.example.com` prima che vediamo un'email proveniente da `example.com`, qualsiasi email proveniente da `test.example.com` e/o `example.com` dovrà attendere 5 minuti dall'orario di arrivo iniziale della connessione. Non facciamo in modo che `test.example.com` e `example.com` attendano ciascuno il proprio intervallo di 5 minuti (la nostra politica di greylisting si applica a livello di dominio radice).

Si noti che la greylisting non si applica ad alcun mittente presente sul nostro [lista consentita](#do-you-have-an-allowlist) (ad esempio Meta, Amazon, Netflix, Google, Microsoft al momento della stesura di questo documento).
...
Inoltre, estraiamo ogni ora tutti gli indirizzi IP dalla denylist di livello 1 di UCEPROTECT all'indirizzo <http://wget-mirrors.uceprotect.net/rbldnsd-all/dnsbl-1.uceprotect.net.gz> e li inseriamo nella nostra denylist con una scadenza di 7 giorni.

I mittenti presenti nella lista di blocco riceveranno un codice di errore 421 (che indica al mittente di riprovare più tardi) se [non sono ammessi](#do-you-have-an-allowlist).
...
1. Il [impronta digitale del messaggio iniziale](#how-do-you-determine-an-email-fingerprint) viene inserito nella greylist in caso di rilevamento di spam o blocklist da parte di un mittente "affidabile" (ad esempio, `gmail.com`, `microsoft.com`, `apple.com`).
* Se il mittente era nella allowlist, il messaggio rimane nella greylist per 1 ora.
* Se il mittente non è nella allowlist, il messaggio rimane nella greylist per 6 ore.
2. Analizziamo le chiavi di denylist dalle informazioni del mittente e del messaggio e per ciascuna di queste chiavi creiamo (se non ne esiste già uno) un contatore, lo incrementiamo di 1 e lo memorizziamo nella cache per 24 ore. * Per i mittenti inclusi nella lista consentita:
* Aggiungere una chiave per l'indirizzo email "MAIL FROM" della busta se ha un SPF valido o nessun SPF e non è [un nome utente del direttore delle poste](#what-are-postmaster-addresses) o [un nome utente che non accetta risposte](#what-are-no-reply-addresses).
* Se l'intestazione "From" era inclusa nella lista consentita, aggiungere una chiave per l'indirizzo email dell'intestazione "From" se ha un SPF valido o un DKIM valido e allineato.
...
* Aggiungere una chiave per l'indirizzo email "MAIL FROM" della busta se ha un SPF valido.
* Se l'intestazione "From" era inclusa nella lista consentita, aggiungere una chiave per l'indirizzo email dell'intestazione "From" se ha un SPF valido o un DKIM valido e allineato. * Se l'intestazione "From" non è stata inserita nella lista consentita, aggiungere una chiave per l'indirizzo email dell'intestazione "From" e il relativo nome di dominio root analizzato.
...
3. Se il contatore raggiunge 5 per un mittente e una chiave non inseriti nella lista consentita, la chiave viene esclusa dalla lista per 30 giorni e viene inviata un'email al nostro team anti-abuso. Questi numeri potrebbero cambiare e gli aggiornamenti saranno riportati qui mentre monitoriamo gli abusi.
4. Se il contatore raggiunge 10 per un mittente e una chiave inseriti nella lista consentita, la chiave viene esclusa dalla lista per 7 giorni e viene inviata un'email al nostro team anti-abuso. Questi numeri potrebbero cambiare e gli aggiornamenti saranno riportati qui mentre monitoriamo gli abusi.
...
La limitazione della velocità del mittente viene effettuata analizzando il dominio radice tramite una ricerca PTR inversa sull'indirizzo IP del mittente oppure, se questa non produce risultati, utilizza semplicemente l'indirizzo IP del mittente. Si noti che di seguito lo chiameremo `Sender`.

I nostri server MX hanno limiti giornalieri per la posta in entrata ricevuta per [archiviazione IMAP crittografata](/blog/docs/best-quantum-safe-encrypted-email-service):

* Invece di limitare la velocità della posta in arrivo ricevuta in base a un singolo alias (ad esempio `you@yourdomain.com`), applichiamo un limite di velocità in base al nome di dominio dell'alias stesso (ad esempio `yourdomain.com`). Questo impedisce a `Senders` di inondare contemporaneamente le caselle di posta di tutti gli alias del tuo dominio. * Abbiamo limiti generali che si applicano a tutti i `Senders` all'interno del nostro servizio, indipendentemente dal destinatario:
* I `Senders` che consideriamo "attendibili" come fonte di verità (ad esempio `gmail.com`, `microsoft.com`, `apple.com`) sono limitati all'invio di 100 GB al giorno.
* I `Senders` che sono [inserito nella lista consentita](#do-you-have-an-allowlist) sono limitati all'invio di 10 GB al giorno.
* Tutti gli altri `Senders` sono limitati all'invio di 1 GB e/o 1000 messaggi al giorno. * Abbiamo un limite specifico per `Sender` e `yourdomain.com` di 1 GB e/o 1000 messaggi al giorno.
...
* Se si invia da un dominio come `test.abc.123.example.com`, il limite di velocità verrà imposto a `example.com`. Molti spammer utilizzano centinaia di sottodomini per aggirare i comuni filtri antispam che limitano la velocità solo ai nomi host univoci, anziché ai domini radice con FQDN univoci.

* I codici `Senders` che superano il limite di frequenza verranno rifiutati con un errore 421.

I nostri server IMAP e SMTP limitano le connessioni simultanee dei tuoi alias a più di `60`.

I nostri server MX limitano i mittenti [non consentito](#do-you-have-an-allowlist) a stabilire più di 10 connessioni contemporanee (con una scadenza della cache di 3 minuti per il contatore, che rispecchia il timeout del nostro socket di 3 minuti).
...
Estraiamo l'elenco da [Backscatter.org](https://www.backscatterer.org/) (powered by [UCEPROTECT](https://www.uceprotect.net/)) a <http://wget-mirrors.uceprotect.net/rbldnsd-all/ips.backscatterer.org.gz> ogni ora e lo inseriamo nel nostro database Redis (confrontiamo anche la differenza in anticipo, nel caso in cui siano stati rimossi degli IP che devono essere rispettati).
...
Se l'IP del mittente è presente nell'elenco (e non nel nostro [lista consentita](#do-you-have-an-allowlist)), inviamo un errore 554 con il messaggio `The IP ${session.remoteAddress} is blocked by https://www.backscatterer.org/index.php?target=test&ip=${session.remoteAddress}`. Verremo avvisati se un mittente è presente sia nell'elenco Backscatterer che nella nostra lista consentita, in modo da poter risolvere il problema se necessario.

Le tecniche descritte in questa sezione aderiscono alla raccomandazione "SAFE MODE" all'indirizzo <https://www.backscatterer.org/?target=usage>, in cui controlliamo l'IP del mittente solo se sono già state soddisfatte determinate condizioni.

### Impedisci rimbalzi non necessari per proteggerti dal backscatter {#prevent-unnecessary-bounces-to-protect-against-backscatter}
...
2. Inviamo una sola volta e una sola volta (utilizziamo una chiave di impronta digitale di rimbalzo calcolata e la memorizziamo nella cache per evitare l'invio di duplicati). L'impronta digitale di rimbalzo è una chiave che rappresenta l'impronta digitale del messaggio combinata con un hash dell'indirizzo di rimbalzo e il suo codice di errore. Consulta la sezione su [impronte digitali](#how-do-you-determine-an-email-fingerprint) per maggiori informazioni su come viene calcolata l'impronta digitale del messaggio. Le impronte digitali di rimbalzo inviate correttamente scadranno dopo 7 giorni nella nostra cache Redis.

3. Inviamo solo quando il campo MAIL FROM e/o From non è vuoto e non contiene (senza distinzione tra maiuscole e minuscole) un [nome utente postmaster](#what-are-postmaster-addresses) (la parte prima della @ in un'e-mail).
...
* Intestazione di `auto-submitted` con un valore diverso da `no`. * Intestazione di `x-auto-response-suppress` con valore `dr`, `autoreply`, `auto-reply`, `auto_reply` o `all`
* Intestazione di `list-id`, `list-subscribe`, `list-unsubscribe`, `list-help`, `list-post`, `list-owner`, `list-archive`, `x-autoreply`, `x-autorespond` o `x-auto-respond` (indipendentemente dal valore).
* Intestazione di `precedence` con valore `bulk`, `autoreply`, `auto-reply`, `auto_reply` o `list`.
...
7. Non effettuiamo l'invio se è presente un'intestazione `content-type` senza distinzione tra maiuscole e minuscole di `multipart/report`.

### Come si determina l'impronta digitale di un'email {#how-do-you-determine-an-email-fingerprint}

L'impronta digitale di un'e-mail viene utilizzata per determinare l'unicità di un'e-mail e per impedire che vengano recapitati messaggi duplicati e che vengano inviati [rimbalzi duplicati](#prevent-unnecessary-bounces-to-protect-against-backscatter).
...
### Questo è un {#is-this-well-tested} ben testato

Sì, contiene test scritti con [Avere](https://github.com/avajs/ava) e ha anche la copertura del codice.

### Inoltri messaggi e codici di risposta SMTP {#do-you-pass-along-smtp-response-messages-and-codes}
...
### Come prevenire gli spammer e garantire una buona reputazione per l'inoltro delle email {#how-do-you-prevent-spammers-and-ensure-good-email-forwarding-reputation}
...
Abbiamo creato un progetto software open source :tangerine: [mandarino](https://github.com/forwardemail/tangerine) e lo utilizziamo per le ricerche DNS. I server DNS predefiniti utilizzati sono `1.1.1.1` e `1.0.0.1`, e le query DNS avvengono tramite [DNS su HTTPS](https://en.wikipedia.org/wiki/DNS_over_HTTPS) ("DoH") a livello applicativo.
...
### Se cambio piano, mi fate pagare la differenza in modo proporzionale {#if-i-switch-plans-do-you-pro-rate-and-refund-the-difference}
...
**Per un rifiuto silenzioso (al mittente sembra che il messaggio sia stato inviato correttamente, ma in realtà non va da nessuna parte) (codice di stato `250`):** Se si aggiunge "!" (un singolo punto esclamativo) a un alias, verrà restituito un codice di stato di successo pari a `250` ai mittenti che tentano di inviare messaggi a questo indirizzo, ma i messaggi di posta elettronica non andranno da nessuna parte (ad esempio, un blackhole o `/dev/null`).

**Per il rifiuto soft (codice di stato `421`):** se si aggiunge "!!" (doppio punto esclamativo) a un alias, verrà restituito un codice di stato di errore soft di `421` ai mittenti che tentano di inviare email a questo indirizzo e le email verranno spesso ritentate fino a 5 giorni prima di essere rifiutate e respinte.

**Per il rifiuto definitivo (codice di stato `550`):** Se si aggiunge "!!!" (triplo punto esclamativo) a un alias, verrà restituito un codice di stato di errore permanente `550` ai mittenti che tentano di inviare email a questo indirizzo e le email verranno rifiutate e restituite al mittente.

Ad esempio, se voglio che tutte le email indirizzate a `alias@example.com` smettano di passare a `user@gmail.com` e vengano rifiutate e restituite al mittente (ad esempio, utilizzare tre punti esclamativi):
...
Ad esempio, se voglio che ogni email indirizzata a `*@example.com` (l'asterisco indica che è un carattere jolly, ovvero un carattere generico) venga inoltrata a `user+a@gmail.com` e `user+b@gmail.com`, il mio record <strong class="notranslate">TXT</strong> apparirà così:
...
I registri degli errori per [limitazione della velocità](#do-you-have-rate-limiting) e [lista grigia](#do-you-have-a-greylist) non sono accessibili poiché la connessione termina prima (ad esempio, prima che i comandi `RCPT TO` e `MAIL FROM` possano essere trasmessi).

Per maggiori informazioni, consulta il nostro [politica sulla riservatezza](/privacy).
...
Per ulteriori informazioni, consultare <https://support.apple.com/en-us/102540>.

### Posso inoltrare un numero illimitato di email con questo {#can-i-forward-unlimited-emails-with-this}

Sì, tuttavia i mittenti "relativamente sconosciuti" hanno un limite di velocità di 100 connessioni all'ora per nome host o IP. Consultare la sezione su [Limitazione della velocità](#do-you-have-rate-limiting) e [Greylisting](#do-you-have-a-greylist) qui sopra.
...
[gmail-2fa]: __URL_PROTETTO_868__

[cloudflare-dns]: __URL_PROTETTO_869__