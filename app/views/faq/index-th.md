...
* [ฉันสามารถให้การประมวลผลและการจัดเก็บอีเมลของฉันอยู่ในสหภาพยุโรป (ถิ่นที่ตั้งของข้อมูล) ได้หรือไม่](#can-i-keep-my-email-processing-and-storage-in-the-eu-data-residency)
* [อีเมลขาเข้าของโดเมนของฉันถูกประมวลผลและจัดเก็บไว้ที่ใด และนานเท่าใด](#where-is-inbound-email-for-my-domain-processed-and-stored-and-for-how-long)
* [ฉันจะระบุ Forward Email เป็นผู้ประมวลผลย่อยใน DPA ของฉันได้อย่างไร](#how-do-i-list-forward-email-as-a-subprocessor-in-my-own-dpa)
...
* [ฉันจะเพิ่มพื้นที่จัดเก็บหรือขีดจำกัดการส่ง SMTP ขาออกได้อย่างไร](#how-do-i-increase-my-storage-or-outbound-smtp-sending-limit)
* [มีอะไรบ้างที่รวมอยู่ใน Enterprise License](#what-is-included-in-the-enterprise-license)
...
<div class="alert my-3 alert-danger">
  ...
  <span>Google ได้ยกเลิกการใช้งานการตั้งค่า Gmail Send Mail As นี้แล้ว กรุณาตรวจสอบ <a class="alert-link" href="https://support.google.com/mail/answer/17101213" target="_blank" rel="noopener noreferrer">Google announcement</a> ใช้ <a class="alert-link" href="https://mail.forwardemail.net" target="_blank" rel="noopener noreferrer">Forward Email Webmail</a>, <a class="alert-link" href="https://github.com/forwardemail/mail.forwardemail.net" target="_blank" rel="noopener noreferrer">Forward Email apps</a> หรือโปรแกรมอีเมลอื่นแทน ดู <a class="alert-link" href="/faq">Forward Email FAQ</a> สำหรับความช่วยเหลือ</span>
</div>
...
> \[!TIP]
> เราอาจประกาศตำแหน่งศูนย์ข้อมูลในสหภาพยุโรปที่โฮสต์ภายใต้ [forwardemail.eu](https://forwardemail.eu) ในเร็วๆ นี้ สมัครรับการอภิปรายได้ที่ <https://github.com/orgs/forwardemail/discussions/336> เพื่อรับข่าวสาร  ไม่มีการปรับใช้แบบเฉพาะสหภาพยุโรปหรือการเลือกเข้าร่วมในวันนี้ – ดู [ฉันสามารถให้การประมวลผลและการจัดเก็บอีเมลของฉันอยู่ในสหภาพยุโรป (ถิ่นที่ตั้งของข้อมูล) ได้หรือไม่](#can-i-keep-my-email-processing-and-storage-in-the-eu-data-residency).
...
เราบังคับใช้ขีดจำกัดอัตราการส่ง SMTP ขาออกในหลายระดับเพื่อป้องกันการละเมิดในขณะเดียวกันก็ยังคงความยืดหยุ่นสำหรับการใช้งานที่ถูกต้องตามกฎหมาย แต่ละระดับจะถูกตรวจสอบตามลำดับ — ข้อจำกัดระดับใดที่ถูกถึงก่อนจะปฏิเสธข้อความชั่วคราวพร้อมข้อผิดพลาด `421` (หมายความว่า "ลองอีกครั้งในภายหลัง")

**Rate limit hierarchy:**

| Level | Scope | Default Limit | Description |
| :---- | :---- | :-----------: | :---------- |
| ต่ออีเมลนามแฝง | อีเมลนามแฝงแต่ละรายการ | ไม่มี (ใช้ขีดจำกัดของโดเมน) | เป็นทางเลือก หากอีเมลนามแฝงตั้งค่า `smtp_limit` แบบกำหนดเอง จะถูกตรวจสอบก่อน |
| ต่อโดเมน | อีเมลทั้งหมดที่ส่งจากโดเมนภายในหนึ่งวัน | 300/day | นับอีเมลขาออกทั้งหมดจากทุกอีเมลนามแฝงในโดเมน |
| ต่อผู้ใช้ | อีเมลทั้งหมดที่ผู้ใช้บัญชีส่งภายในหนึ่งวัน | 300/day | ป้องกันการหลีกเลี่ยงโดยการลบแล้วสร้างนามแฝงหรือโดเมนใหม่ |

**วิธีการกำหนดขีดจำกัดที่ใช้จริง:**

* **โดเมนในแผนทีม** — ขีดจำกัดรายวันที่ใช้จริงจะเป็นค่าสูงสุดของ `smtp_limit` ระหว่างสมาชิกผู้ดูแลทั้งหมดของโดเมนนั้น ตัวอย่างเช่น หากผู้ดูแลคนหนึ่งมีขีดจำกัด 300 และอีกคนมี 500 ขีดจำกัดที่ใช้จริงของโดเมนจะเป็น 500
* **Enhanced Protection และแผนอื่นๆ** — ขีดจำกัดรายวันที่ใช้จริงจะเป็น `smtp_limit` ของผู้ใช้ผู้ส่งเอง (ซึ่งค่าเริ่มต้นคือ 300 ข้อความต่อวัน)
* **การแทนที่ต่ออีเมลนามแฝง** — ผู้ดูแลโดเมนสามารถตั้งค่า `smtp_limit` แบบกำหนดเองบนอีเมลนามแฝงแต่ละรายการได้ เมื่อมีการตั้งค่า จะถูกตรวจสอบก่อน (ก่อนขีดจำกัดของโดเมนและผู้ใช้) ซึ่งมีประโยชน์สำหรับการจำกัดปริมาณการส่งของนามแฝงบางรายการให้ต่ำกว่า
* **ค่าเริ่มต้นของโดเมนสำหรับนามแฝงใหม่** — ผู้ดูแลโดเมนสามารถตั้งค่า `alias_default_smtp_limit` บนโดเมนนั้นได้ (ผ่าน API หรือการตั้งค่าขั้นสูงในแดชบอร์ด). เมื่อมีการตั้งค่าแล้ว นามแฝงที่สร้างใหม่ทั้งหมดบนโดเมนนั้นจะสืบทอดค่านี้โดยอัตโนมัติเป็นค่า `smtp_limit` ของตนเอง ค่านี้จะต้องไม่เกินขีดจำกัด SMTP ที่มีผลของโดเมน นามแฝงที่มีอยู่แล้วจะไม่ได้รับผลกระทบ ตั้งค่าเป็น `0` เพื่อปิดการใช้งาน

**ผู้ดูแลระบบ** (เจ้าหน้าที่ของ Forward Email) ได้รับการยกเว้นจากขีดจำกัดทั้งหมด

การบังคับใช้การจำกัดอัตราทั้งหมดใช้การนับจากฐานข้อมูล (`Emails.countDocuments`) เทียบกับอีเมลที่สร้างตั้งแต่เริ่มต้นของวันปัจจุบัน (เที่ยงคืน UTC) ซึ่งหมายความว่าขีดจำกัดของคุณจะรีเซ็ตทุกวันในเวลาเที่ยงคืน UTC

หากคุณต้องการขีดจำกัดที่สูงขึ้น โปรด [ติดต่อเรา](https://forwardemail.net/help). คำขอส่วนใหญ่ได้รับการอนุมัติภายใน 1-2 ชั่วโมง.
...
* **การบังคับใช้การยืนยันตัวตนอีเมล**: ข้อความจากผู้ส่งที่ไม่อยู่ในรายการอนุญาตต้องผ่านอย่างน้อย SPF หรือ DKIM (คล้ายกับข้อกำหนดของ Gmail, Outlook และ Yahoo ตั้งแต่ปี 2024) ข้อความที่ไม่ผ่านการยืนยันตัวตนใดๆ จะถูกปฏิเสธด้วยรหัสข้อผิดพลาด 550 นโยบาย DMARC `p=reject` และ `p=quarantine` จะถูกบังคับใช้
* **การตรวจสอบ HELO/EHLO กับรายการปฏิเสธ**: ชื่อโฮสต์ที่นำเสนอระหว่างการทักทาย SMTP HELO/EHLO จะถูกตรวจสอบกับรายการปฏิเสธของเรา ให้การป้องกันแม้ว่าผู้ส่ง IPv6 จะไม่มีระเบียน DNS ย้อนกลับ
...
* **การใช้ Swap แบบควบคุม**: โฮสต์แอปพลิเคชันและโฮสต์ที่ไม่ใช่ฐานข้อมูลอื่นๆ จะไม่มีการใช้ swap และถูกกำหนดขนาดและตรวจสอบเพื่อให้เวิร์กโหลดปกติอยู่ใน RAM โฮสต์ MongoDB และ Redis ใช้ไฟล์ swap สำหรับ `root` เท่านั้นโดยตั้งค่า `vm.swappiness=1` เพื่อเป็นตาข่ายนิรภัยเมื่อหน่วยความจำหมดอย่างเคร่งครัด ไม่ใช่ความจุปกติ การปิดใช้งาน swap ทุกที่อาจเปลี่ยนสภาวะกดดันของหน่วยความจำฐานข้อมูลชั่วคราวให้กลายเป็นการถูก OOM kill ทันที กิจกรรม swap ของฐานข้อมูลจะถูกตรวจสอบและสืบสวน
...
* มีสำเนาที่ลงนามร่วมกันและข้อตกลง DPA แบบกำหนดเองให้ใช้งานผ่าน [Enterprise License](#what-is-included-in-the-enterprise-license)
* หากต้องการระบุชื่อเราในภาคผนวกผู้ประมวลผลย่อยของคุณ โปรดดู [ฉันจะระบุ Forward Email เป็นผู้ประมวลผลย่อยใน DPA ของฉันได้อย่างไร](#how-do-i-list-forward-email-as-a-subprocessor-in-my-own-dpa)
...
### ฉันสามารถเก็บการประมวลผลและการจัดเก็บอีเมลไว้ในสหภาพยุโรป (การพำนักของข้อมูล) {#can-i-keep-my-email-processing-and-storage-in-the-eu-data-residency}

> [!IMPORTANT]
> ยังไม่ได้ ขณะนี้ยังไม่มีการปรับใช้งานเฉพาะ EU หรือตัวเลือกให้เข้าร่วมเฉพาะ EU และคุณไม่ควรอธิบาย Forward Email ว่าเป็นผู้ประมวลผลเฉพาะ EU ในบันทึกของคุณเองหรือในข้อตกลงการประมวลผลข้อมูลของคุณ

**ตำแหน่งที่มีการประมวลผลในปัจจุบัน:** เซิร์ฟเวอร์ของเราอยู่เป็นหลักที่ Denver, Colorado, United States (ดู [เซิร์ฟเวอร์ของคุณตั้งอยู่ที่ใด](#where-are-your-servers-located) และ <https://forwardemail.net/ips>) ข้อนี้ใช้กับทุกฟีเจอร์: การส่งต่อขาเข้า บันทึกข้อผิดพลาด พื้นที่จัดเก็บกล่องจดหมาย (IMAP/POP3/CalDAV/CardDAV) และ SMTP ขาออก

**แผนงานที่วางไว้:** ศูนย์ข้อมูลในสหภาพยุโรปที่อัมสเตอร์ดัม โฮสต์ภายใต้ [forwardemail.eu](https://forwardemail.eu) เพื่อทำให้ข้อมูลของ EU แยกได้อย่างแท้จริง ทั้งในทางกฎหมายและทางเทคนิค จำเป็นต้องดำเนินการผ่านบริษัทที่ตั้งอยู่ใน EU โดยเฉพาะ ไม่ใช่เพียงแค่ผ่านเซิร์ฟเวอร์ในทำเล EU เรายังไม่มีกำหนดวันเปิดให้บริการ และการเข้าร่วมรายชื่อรอไม่เปลี่ยนตำแหน่งที่อีเมลของคุณถูกประมวลผลในวันนี้ ติดตามประกาศได้ที่ <https://github.com/orgs/forwardemail/discussions/336>; เราจะอธิบายที่นั่นว่าลูกค้าเดิมจะเลือกเข้าร่วมได้อย่างไรเมื่อพร้อมใช้งาน

**สิ่งที่คุณสามารถระบุได้อย่างถูกต้องในวันนี้:**

* ผู้ประมวลผล: Forward Email LLC, บริษัทที่จดทะเบียนใน Delaware, United States
* ตำแหน่งของการประมวลผลและการจัดเก็บ: United States
* กลไกการโอนและมาตรการคุ้มครอง: ตามที่อธิบายในหน้า [DPA](/dpa) และ [GDPR](/gdpr) ของเรา
* ผู้ประมวลผลย่อยของเราเอง: ระบุไว้ในหน้า [GDPR](/gdpr) ของเรา (ผู้ให้บริการที่ตั้งอยู่ในสหรัฐอเมริกาทั้งหมด)

ดู [อีเมลขาเข้าของโดเมนของฉันถูกประมวลผลและจัดเก็บที่ไหน และนานเท่าใด](#where-is-inbound-email-for-my-domain-processed-and-stored-and-for-how-long) สำหรับรายละเอียดรายฟีเจอร์ และ [ฉันจะระบุ Forward Email เป็นผู้ประมวลผลย่อยใน DPA ของตัวเองได้อย่างไร](#how-do-i-list-forward-email-as-a-subprocessor-in-my-own-dpa) สำหรับรายการภาคผนวกที่คัดลอกไปใช้ได้ทันที.

### อีเมลขาเข้าของโดเมนของฉันถูกประมวลผลและจัดเก็บที่ไหน และนานเท่าใด {#where-is-inbound-email-for-my-domain-processed-and-stored-and-for-how-long}

การประมวลผลและการจัดเก็บทั้งหมดเกิดขึ้นบนเซิร์ฟเวอร์ของเราใน Denver, Colorado, United States สิ่งที่เก็บไว้ และนานเท่าใด ขึ้นอยู่กับฟีเจอร์:

| ฟีเจอร์ | สิ่งที่เก็บไว้ | ระยะเวลาเก็บรักษา |
| --- | --- | --- |
| **การส่งต่ออีเมล** (นามแฝงที่ส่งต่อไปยังที่อยู่อื่นหรือ webhook) | ไม่มีอะไร ข้อความถูกประมวลผลทั้งหมดในหน่วยความจำและส่งต่อไปยังปลายทาง; จะไม่ถูกเขียนลงดิสก์หรือฐานข้อมูลเลย | ไม่มี – ข้อความจะถูกทิ้งทันทีที่มีการพยายามส่งมอบ |
| **บันทึกข้อผิดพลาด SMTP** (`4xx`/`5xx` responses) | ข้อผิดพลาด SMTP ซองจดหมาย และส่วนหัวของอีเมล **ไม่ใช่** เนื้อความของข้อความหรือไฟล์แนบ | 7 วัน (ดู [คุณเก็บบันทึกข้อผิดพลาดหรือไม่](#do-you-store-error-logs)) |
| **แคชป้องกันการละเมิด** (greylist, denylist, rate limiting) | คีย์ที่ได้มาจากข้อมูลผู้ส่งและผู้รับ (ที่อยู่ โดเมน แฮช) ไม่มีเนื้อหาข้อความ | สูงสุด 30 วัน (ดู [คุณมี greylist หรือไม่](#do-you-have-a-greylist) และ [คุณมี denylist หรือไม่](#do-you-have-a-denylist)) |
| **พื้นที่จัดเก็บกล่องจดหมาย** (IMAP/POP3/CalDAV/CardDAV เมื่อเปิดใช้งานบน นามแฝง) | ข้อความ ผู้ติดต่อ และปฏิทิน อยู่ในกล่องจดหมาย SQLite ที่เข้ารหัสรายบุคคลซึ่งมีเพียงรหัสผ่านของคุณเท่านั้นที่เปิดได้ | จนกว่าคุณจะลบข้อความ นามแฝง โดเมน หรือบัญชี (ดู [ฉันจะส่งออกและสำรองข้อมูลกล่องจดหมายของฉันได้อย่างไร](#how-do-i-export-and-backup-my-mailbox)) |
| **SMTP ขาออก** | ระเบียนคิวสำหรับการส่งมอบและการรายงานข้อผิดพลาด เนื้อความของข้อความจะถูกเก็บไว้เป็นค่าเริ่มต้น 0 วันหลังจากการส่งมอบสำเร็จหรือเกิดข้อผิดพลาดถาวร; คุณสามารถเพิ่มได้มากที่สุด 30 วันต่อโดเมน | ~30 วันสำหรับระเบียนคิว (ดู [นโยบายความเป็นส่วนตัว](/privacy) ของเรา) |

สองสิ่งที่ควรระบุไว้ในบันทึกของคุณเอง:

* ข้อความที่ถูกส่งต่อจะถูกส่งไปยังกล่องจดหมายปลายทางที่คุณกำหนดค่าไว้ (เช่น Google Workspace หรือ Microsoft 365) สิ่งที่ผู้ให้บริการนั้นจัดเก็บอยู่ภายใต้ข้อตกลงระหว่างคุณกับพวกเขา ไม่ใช่กับเรา
* ระเบียนเกี่ยวกับโดเมนและบัญชี (ที่อยู่อีเมลของคุณ ชื่อโดเมน นามแฝง รายละเอียดการเรียกเก็บเงิน) จะถูกเก็บไว้ตราบเท่าที่บัญชีของคุณยังมีอยู่ ดู [นโยบายความเป็นส่วนตัว](/privacy) ของเราเพื่อดูรายการทั้งหมด

แหล่งที่มา: <https://forwardemail.net/privacy>, <https://forwardemail.net/technical-whitepaper.pdf>, และ MX handler ที่ <https://github.com/forwardemail/forwardemail.net/blob/master/helpers/on-data-mx.js>.

### ฉันจะระบุ Forward Email เป็นผู้ประมวลผลย่อยใน DPA ของตัวเองได้อย่างไร {#how-do-i-list-forward-email-as-a-subprocessor-in-my-own-dpa}

หากคุณเป็นผู้ควบคุมข้อมูล (หรือเป็นผู้ประมวลผลเอง) ภายใต้ GDPR มาตรา 28 และคุณใช้ Forward Email เพื่อจัดการจดหมายสำหรับลูกค้าหรือผู้ใช้ของคุณ โดยทั่วไปคุณจะต้องระบุชื่อเราไว้ในภาคผนวกผู้ประมวลผลย่อยของคุณ รายการด้านล่างนี้คือสิ่งที่เราจะเขียนว่า:

| ฟิลด์ | ค่า |
| --- | --- |
| **ผู้ประมวลผลย่อย** | Forward Email LLC |
| **จดทะเบียนใน** | State of Delaware, United States |
| **บริการ** | การส่งต่ออีเมล (inbound MX) และเมื่อเปิดใช้งาน การจัดเก็บกล่องจดหมายแบบเข้ารหัส (IMAP/POP3/CalDAV/CardDAV) และ SMTP ขาออก |
| **ข้อมูลส่วนบุคคลที่ประมวลผล** | ที่อยู่อีเมล เมทาดาทาของซองจดหมายและส่วนหัว และเนื้อหาข้อความระหว่างทาง (อยู่ในหน่วยความจำเท่านั้นสำหรับการส่งต่อ; เข้ารหัสขณะพักสำหรับพื้นที่จัดเก็บกล่องจดหมาย) |
| **สถานที่ประมวลผล** | United States (Denver, Colorado) |
| **ระยะเวลาเก็บรักษา** | ดู [อีเมลขาเข้าของโดเมนของฉันถูกประมวลผลและจัดเก็บที่ไหน และนานเท่าใด](#where-is-inbound-email-for-my-domain-processed-and-stored-and-for-how-long) |
| **กลไกการโอน** | ตามที่กำหนดไว้ในหน้า [Data Processing Agreement](/dpa) และ [GDPR](/gdpr) ของเรา |
| **ผู้ประมวลผลย่อยของเรา** | ระบุไว้ในหน้า [GDPR](/gdpr) ของเราและใน [DPA](/dpa) (ปัจจุบันได้แก่ Cloudflare, DataPacket, DigitalOcean, GitHub, Vultr, Stripe, และ PayPal) |
| **ผู้แทนใน EU (Art. 27)** | Osano International Compliance Services Limited, Dublin, Ireland – ที่อยู่เต็มอยู่ในหน้า [GDPR](/gdpr) ของเรา |
| **ผู้แทนในสหราชอาณาจักร** | Osano UK Compliance LTD, Belfast – ที่อยู่เต็มอยู่ในหน้า [GDPR](/gdpr) ของเรา |
| **ข้อตกลงประมวลผลข้อมูล** | <https://forwardemail.net/dpa> (ยอมรับพร้อมกับ [Terms](/terms) ของเรา; มีสำเนาที่ลงนามร่วมกันภายใต้ Enterprise License) |
| **ผู้ติดต่อด้านความปลอดภัย** | <security@forwardemail.net> |

> [!WARNING]
> [Terms](/terms) ของเราไม่อนุญาตให้ดำเนินการบริการที่ให้บุคคลที่สาม (ผู้ใดก็ตามนอกจากพนักงานและผู้รับจ้างของคุณเอง) เข้าถึง ใช้ หรือได้รับประโยชน์จาก Forward Email โดยไม่มีข้อตกลงระดับองค์กร หากคุณระบุชื่อเราเป็นผู้ประมวลผลย่อยเพราะคุณประมวลผลจดหมายของลูกค้าของคุณ คุณต้องมี [Enterprise License](#what-is-included-in-the-enterprise-license) – นั่นยังเป็นวิธีที่คุณจะได้รับ DPA ที่ลงนามร่วมกันด้วย.
...
* `HELO` – เป็นการทักทายเพื่อระบุ FQDN, ที่อยู่ IP หรือชื่อผู้จัดการเมลของผู้ส่ง ค่านี้สามารถปลอมแปลงได้ ดังนั้นเราจึงไม่พึ่งพาข้อมูลนี้ แต่ใช้การค้นหาชื่อโฮสต์ย้อนกลับของที่อยู่ IP ที่เชื่อมต่อแทน อย่างไรก็ตาม ตอนนี้เราตรวจสอบค่านี้กับ[รายการปฏิเสธ](#do-you-have-a-denylist)ของเรา นอกเหนือจากการค้นหาชื่อโฮสต์ย้อนกลับ ซึ่งให้การป้องกันเพิ่มเติม โดยเฉพาะสำหรับการเชื่อมต่อ IPv6 ที่อาจไม่มี DNS ย้อนกลับ
...
ไปที่ <a href="/my-account/billing" target="_blank" rel="noopener noreferrer">บัญชีของฉัน → การเรียกเก็บเงิน</a> แล้วเลื่อนลงไปที่ส่วน **ส่วนเสริม** ซึ่งมีแบบฟอร์มคำขอสองรายการ:

* **อัปเกรดพื้นที่จัดเก็บ** — เลือกจำนวนที่จะเพิ่ม (+10, +20, +30, +40, หรือ +50 GB) หรือเลือก "Other" เพื่อร้องขอจำนวนแบบกำหนดเอง.
* **อัปเกรดขีดจำกัด SMTP ขาออก** — เลือกจำนวนที่จะเพิ่ม (+1000, +2000, หรือ +3000 อีเมลต่อวัน) หรือเลือก "Other" เพื่อร้องขอจำนวนแบบกำหนดเอง.

การส่งแบบฟอร์มใดแบบฟอร์มหนึ่งจะส่งคำขอของคุณไปยังทีมของเราเพื่อการตรวจสอบ — จะไม่เรียกเก็บเงินคุณในทันที เมื่อได้รับการอนุมัติแล้ว เราจะส่งอีเมลลิงก์การชำระเงินที่ปลอดภัยให้คุณเพื่อทำการอัปเกรดให้เสร็จสิ้น คุณสามารถมีคำขอที่รอดำเนินการได้ครั้งละหนึ่งคำขอต่อประเภท (พื้นที่จัดเก็บหรือ SMTP); การส่งซ้ำภายใน 3 วันนับจากคำขอก่อนหน้าสำหรับประเภทเดียวกันจะไม่สามารถทำได้จนกว่าจะพ้นช่วงเวลาดังกล่าว.


### มีอะไรบ้างใน Enterprise License {#what-is-included-in-the-enterprise-license}

Enterprise License มีราคา **$250/month** ออกใบเสนอราคาและใบแจ้งหนี้โดยตรง แทนที่จะซื้อผ่านหน้าราคา ซึ่งรวมทุกอย่างในแผน Team และเพิ่มเติมดังนี้:

* **ข้อยกเว้น Terms of Use สำหรับบุคคลที่สาม** – คุณสามารถให้บริการหรือการผสานรวมที่ลูกค้า นักเรียน หรือผู้รับบริการของคุณ (ไม่ใช่เพียงพนักงานและผู้รับจ้างของคุณเอง) ใช้หรือได้รับประโยชน์จาก Forward Email [Terms](/terms) มาตรฐานของเราไม่อนุญาตสิ่งนี้
* **ข้อตกลงระดับองค์กรและ DPA ที่ลงนามร่วมกัน** – ส่งเพื่อทบทวนและลงนามผ่าน DocuSign นี่คือวิธีที่คุณจะได้รับ [Data Processing Agreement](/dpa) ที่ลงนาม แทนสำเนาที่ได้รับการยอมรับพร้อมกับข้อกำหนดของเรา
* **เงื่อนไขตามสัญญาแบบกำหนดเอง** ที่เราสามารถรองรับได้ เช่น SLA การแจ้งเหตุละเมิด (ดู [คุณจัดการการแจ้งเหตุละเมิดข้อมูลอย่างไร](#how-do-you-handle-data-breach-notifications))
* **คำขอ API ไม่จำกัด** โดยไม่มีการจำกัดอัตรา
* **ห้องแชทสนับสนุนลูกค้าแบบเฉพาะ** กับทีมวิศวกรรมของเรา
* **ความช่วยเหลือในการเริ่มต้นใช้งานและการสนับสนุนด้านวิศวกรรมแบบเรียลไทม์**

สิ่งนี้ไม่เปลี่ยนตำแหน่งที่ข้อมูลของคุณถูกประมวลผล: ดู [ฉันสามารถเก็บการประมวลผลและการจัดเก็บอีเมลไว้ในสหภาพยุโรป (การพำนักของข้อมูล)](#can-i-keep-my-email-processing-and-storage-in-the-eu-data-residency)

**ใครที่ต้องใช้:** ผู้ที่การใช้งานบริการอยู่นอกเหนือ Terms (การเข้าถึงโดยบุคคลที่สาม) และผู้ที่ต้องการ DPA ที่ลงนามร่วมกัน เงื่อนไข DPA แบบกำหนดเอง หรือรายชื่อติดต่อวิศวกรที่ระบุชื่อเพื่อวัตถุประสงค์ด้านการปฏิบัติตามข้อกำหนด

**เริ่มอย่างไร:** [contact us](/help) พร้อมชื่อบริษัทตามกฎหมาย ที่อยู่จดทะเบียน หมายเลขทะเบียนบริษัทและหมายเลข VAT และชื่อ ตำแหน่ง และที่อยู่อีเมลของผู้ที่จะลงนาม เราจะตอบกลับด้วยข้อตกลงผ่าน DocuSign เพื่อให้คุณตรวจสอบ
