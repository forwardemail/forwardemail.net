...
<div class="alert my-3 alert-danger">
  ...
  <span>Google har avvecklat den här Gmail Send Mail As-inställningen. Vänligen granska <a class="alert-link" href="https://support.google.com/mail/answer/17101213" target="_blank" rel="noopener noreferrer">Google announcement</a>. Använd istället <a class="alert-link" href="https://mail.forwardemail.net" target="_blank" rel="noopener noreferrer">Forward Email Webmail</a>, <a class="alert-link" href="https://github.com/forwardemail/mail.forwardemail.net" target="_blank" rel="noopener noreferrer">Forward Email apps</a> eller en annan e-postklient. Se <a class="alert-link" href="/faq">Forward Email FAQ</a> för hjälp.</span>
</div>
...
* **Kontrollerad swap-användning**: Applikations- och andra icke-databasvärdar förblir swap-fria och är dimensionerade och övervakade så att normala arbetsbelastningar stannar i RAM. MongoDB- och Redis-värdar använder en swap-fil endast för root med `vm.swappiness=1` strikt som ett skyddsnät vid slut på minne, inte som normal kapacitet. Att inaktivera swap överallt kan förvandla tillfälligt minnestryck i databasen till en omedelbar OOM-kill. Databasens swap-aktivitet övervakas och undersöks.
