...
Forward Email은 모든 사용자를 위한 간편하고 안전하며 개인 정보를 보호하는 이메일 전달 서비스를 제공합니다. 많은 조직, 특히 미국 정부와 협력하는 조직에게 규정 준수는 단순한 유행어가 아니라 필수 요소라는 것을 잘 알고 있습니다. **연방 이메일 규정**을 준수하는 것은 매우 중요합니다. 그렇기 때문에 저희의 **안전한 이메일 전달** 서비스가 [국방권한법(NDAA)](https://en.wikipedia.org/wiki/National_Defense_Authorization_Act)의 [제889조](https://www.acquisition.gov/Section-889-Policies)를 포함한 엄격한 연방 요건을 충족하도록 구축되었음을 자랑스럽게 생각합니다.
...
889조란 무엇일까요? 간단히 말해, 미국 연방법으로, 정부 기관이 특정 기업(예: 화웨이, ZTE, 하이크비전, 다화, 하이테라)의 특정 통신 및 영상 감시 장비나 서비스를 사용하는 기관을 이용하거나 계약하는 것을 금지합니다. 이 규정은 종종 **화웨이 금지** 및 **ZTE 금지**와 연관되며, 국가 안보를 보호하는 데 도움이 됩니다.
...
1. **[클라우드플레어](https://www.cloudflare.com/):** 네트워크 서비스 및 **Cloudflare 이메일 보안**을 위한 당사의 주요 파트너입니다.
2. **[데이터 패킷](https://datapacket.com/):** 서버 인프라를 위한 당사의 주요 공급업체입니다. (장애 조치에는 [디지털 오션](https://www.digitalocean.com/) 및/또는 [불트르](https://www.vultr.com/)를 사용하며, 곧 DataPacket만 사용하도록 전환할 예정입니다. 물론, 두 장애 조치 공급업체 모두 섹션 889 준수를 서면으로 확인했습니다.)
...
[클라우드플레어](https://www.cloudflare.com/)과 [데이터 패킷](https://datapacket.com/)은 모두 높은 보안 표준을 준수하고 있으며 섹션 889에 따라 금지된 장비를 사용하지 않습니다. **섹션 889 준수를 위한 Cloudflare 및 DataPacket 사용**은 당사 서비스의 기본입니다.

### Cloudflare의 약속 {#cloudflares-commitment}

[클라우드플레어](https://www.cloudflare.com/)는 **[제3자 행동 강령](https://cf-assets.www.cloudflare.com/slt3lc6tev37/284hiWkCYNc49GQpAeBvGN/e137cdac96d1c4cd403c6b525831d284/Third_Party_Code_of_Conduct.pdf)**에서 **섹션 889 준수**에 대해 명시적으로 언급하고 있습니다. 해당 내용은 다음과 같습니다.
...
저희 서버 공급업체인 [데이터 패킷](https://datapacket.com/)는 **Arista Networks**와 **Cisco**의 네트워킹 장비만 사용합니다. Arista와 Cisco는 889조에 따라 금지된 업체에 포함되지 않습니다. 두 회사 모두 안전한 기업 및 정부 환경에서 널리 사용되는 유수 공급업체로, 엄격한 보안 및 규정 준수 기준을 준수하는 것으로 알려져 있습니다.

**Forward Email**은 [클라우드플레어](https://www.cloudflare.com/)과 [데이터 패킷](https://datapacket.com/)만 사용하여 전체 서비스 제공 체인이 섹션 889에서 금지한 장비로부터 자유로워지도록 보장하고, **연방 기관**과 보안을 중시하는 다른 사용자를 위한 안전한 이메일 전달을 제공합니다.
...
* **[FAR(연방 조달 규정)](https://en.wikipedia.org/wiki/Federal_Acquisition_Regulation):** 규정을 준수하는 인프라를 사용하고 간편한 상용 서비스를 제공함으로써, 정부 계약업체에 적합한 **FAR(미국 연방 개인정보보호법) 준수** 이메일 전달 원칙을 제공합니다.
...
## 앞으로의 방향: 규정 준수 지평 확장 {#our-path-forward-expanding-compliance-horizons}
...
* **[FAR(연방 조달 규정)](https://www.acquisition.gov/browse/index/far):** 상업 서비스에 대한 [FAR 52.212-4](https://www.acquisition.gov/far/52.212-4)과 같은 표준 조항을 포함합니다.
* **[DFARS(국방 연방 조달 규정 보충)](https://en.wikipedia.org/wiki/Defense_Federal_Acquisition_Regulation_Supplement):** 특히 DoD 클라우드 서비스에 대한 [DFARS 252.239-7010](https://www.acquisition.gov/dfars/252.239-7010-cloud-computing-services.)입니다.
* **[CMMC(사이버보안 성숙도 모델 인증)](https://en.wikipedia.org/wiki/Cybersecurity_Maturity_Model_Certification):** [연방 계약 정보(FCI)](https://en.wikipedia.org/wiki/Federal_Contract_Information) 또는 CUI를 처리하는 DoD 계약업체에 필수적입니다.
...
* **[FISMA(연방 정보 보안 현대화법)](https://www.cisa.gov/topics/cybersecurity-best-practices/fisma):** 연방 정보 보안을 위한 포괄적인 프레임워크입니다.
* **[HIPAA(건강보험 양도성 및 책임법)](https://www.hhs.gov/hipaa/index.html):** 보호된 건강 정보(PHI) 처리용입니다.
* **[FERPA(가족 교육 권리 및 개인정보 보호법)](https://en.wikipedia.org/wiki/Family_Educational_Rights_and_Privacy_Act):** 학생 교육 기록 보호용입니다.
* **[COPPA(아동 온라인 개인정보 보호법)](https://en.wikipedia.org/wiki/Children%27s_Online_Privacy_Protection_Act):** 13세 미만 아동을 대상으로 하는 서비스용입니다.
...
**Forward Email**은 **안전하고 개인정보 보호가 보장되는 오픈 소스 이메일 전달** 서비스를 제공하기 위해 최선을 다하고 있습니다. [클라우드플레어](https://www.cloudflare.com/) 및 [데이터 패킷](https://datapacket.com/)과의 파트너십을 통해 **889조 준수**를 달성했으며(미국 해군사관학교**의 **Forward Email 준수** 활동을 반영), 이는 이러한 노력을 입증합니다. 정부 기관, 계약업체 또는 단순히 **정부 이메일 보안**을 중요하게 생각하는 모든 분들을 위해 **Forward Email**이 구축되었습니다.
...
* **연방 위험 및 승인 관리 프로그램(FedRAMP):** <https://www.fedramp.gov/>
* **연방 정보 보안 현대화법(FISMA):** <https://www.cisa.gov/topics/cybersecurity-best-practices/fisma>
* **건강보험 양도성 및 책임법(HIPAA):** <https://www.hhs.gov/hipaa/index.html>
* **가족 교육 권리 및 개인정보 보호법(FERPA):** <https://studentprivacy.ed.gov/ferpa>
* **아동 온라인 개인정보 보호법(COPPA):** <https://www.ftc.gov/legal-library/browse/rules/childrens-online-privacy-protection-rule-coppa>