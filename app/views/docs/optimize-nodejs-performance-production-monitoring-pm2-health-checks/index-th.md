...
* **การใช้ Swap แบบควบคุม** รักษาโฮสต์แอปพลิเคชันและโฮสต์ที่ไม่ใช่ฐานข้อมูลอื่นๆ ให้ไม่มีการใช้ swap และถูกกำหนดขนาดเพื่อให้เวิร์กโหลดปกติอยู่ใน RAM ในขณะที่โฮสต์ MongoDB และ Redis ใช้ไฟล์ swap สำหรับ `root` เท่านั้นโดยตั้งค่า `vm.swappiness=1` เพื่อเป็นตาข่ายนิรภัยเมื่อหน่วยความจำหมดอย่างเคร่งครัด กิจกรรม swap ของฐานข้อมูลจะถูกตรวจสอบและสืบสวน
...
> \[!NOTE]
> Swap ในระบบการผลิตเป็นตาข่ายนิรภัยเมื่อหน่วยความจำหมด ไม่ใช่ความจุปกติ โฮสต์แอปพลิเคชันจะไม่มีการใช้ swap และคาดว่าเวิร์กโหลดปกติจะอยู่ใน RAM
