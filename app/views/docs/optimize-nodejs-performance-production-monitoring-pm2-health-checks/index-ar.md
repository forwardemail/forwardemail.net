...
* **الاستخدام المنضبط للتبديل** يحافظ على خوادم التطبيقات والخوادم الأخرى غير التابعة لقواعد البيانات خالية من التبديل وبحجم مناسب بحيث تبقى أعباء العمل العادية في ذاكرة الوصول العشوائي (RAM)، بينما تستخدم خوادم MongoDB و Redis ملف تبديل بصلاحيات root فقط مع `vm.swappiness=1` بشكل صارم كشبكة أمان لنفاد الذاكرة؛ يتم مراقبة نشاط التبديل في قواعد البيانات والتحقيق فيه
...
> \[!NOTE]
> يعد التبديل في بيئة الإنتاج شبكة أمان لنفاد الذاكرة، وليس سعة عادية. تظل خوادم التطبيقات خالية من التبديل، ومن المتوقع أن تبقى أعباء العمل العادية في ذاكرة الوصول العشوائي (RAM).
