...
* **שימוש מבוקר ב-Swap** שומר על מארחי יישומים ומארחים אחרים שאינם מסדי נתונים ללא swap ומותאמים כך שעומסי עבודה רגילים יישארו ב-RAM, בעוד שמארחי MongoDB ו-Redis משתמשים בקובץ swap של root בלבד עם `vm.swappiness=1` אך ורק כרשת ביטחון למצבי חוסר זיכרון; פעילות swap במסדי נתונים מנוטרת ונחקרת
...
> \[!NOTE]
> swap בייצור הוא רשת ביטחון למצבי חוסר זיכרון, ולא קיבולת רגילה. מארחי יישומים נשארים ללא swap, ועומסי עבודה רגילים צפויים להישאר ב-RAM.
