...
* [Impostazione del tuo portafoglio crittografico](#setting-up-your-crypto-wallet)
  * [MetaMaschera](#metamask)
  * [Fantasma](#phantom)
  * [Portafoglio Coinbase](#coinbase-wallet)
  * [PortafoglioConnetti](#walletconnect)
...
2. **Scegli la tua criptovaluta**: Attualmente accettiamo [USDC](https://en.wikipedia.org/wiki/USD_Coin) (USD Coin) su diverse blockchain, tra cui [Etereo](https://ethereum.org), [Solana](https://solana.com) e [Poligono](https://polygon.technology). USDC è una criptovaluta stabile che mantiene un valore 1:1 con il dollaro statunitense.

3. **Collega il tuo portafoglio**: Verrai reindirizzato a una pagina sicura dove potrai collegare il tuo portafoglio di criptovalute preferito. Supportiamo diverse opzioni di portafoglio, tra cui:
* [MetaMaschera](https://metamask.io)
* [Fantasma](https://phantom.app)
* [Portafoglio Coinbase](https://www.coinbase.com/wallet)
* [PortafoglioConnetti](https://walletconnect.com) (compatibile con molti altri portafogli)
...
* **Separazione dai servizi bancari tradizionali**: il pagamento non può essere collegato al tuo conto bancario o alla tua cronologia creditizia. Scopri di più su [riservatezza finanziaria](https://en.wikipedia.org/wiki/Financial_privacy).
...
* **In linea con i nostri valori**: in qualità di servizio di posta elettronica incentrato sulla privacy, crediamo nell'importanza di darti il controllo sulle tue informazioni personali in ogni fase. Scopri il nostro [politica sulla riservatezza](/privacy).
...
* I pagamenti vengono effettuati in [USDC](https://www.circle.com/en/usdc) su diverse blockchain, tra cui [Etereo](https://ethereum.org), [Solana](https://solana.com) e [Poligono](https://polygon.technology).
...
Nuovo nel mondo delle criptovalute? Ecco come impostare i wallet che supportiamo:
...
__URL_PROTETTO_18__ MetaMask {__URL_PROTETTO_19__

[MetaMaschera](https://metamask.io) è uno dei portafogli Ethereum più popolari.
...
4. Esegui un backup sicuro della tua frase di recupero
...
[PortafoglioConnetti](https://walletconnect.com) è un protocollo che collega i portafogli ai siti web.
...
Pronti a migliorare la vostra privacy con i pagamenti in criptovaluta? Selezionate semplicemente l'opzione "Criptovaluta" durante il checkout la prossima volta che rinnovate il vostro abbonamento o aggiornate il vostro piano.

Per maggiori informazioni sulle criptovalute e sulla tecnologia blockchain, consulta queste risorse:

* __LINK_PROTETTO_77__ - Investopedia
* __LINK_PROTETTO_78__ - Investopedia
* __LINK_PROTETTO_79__ - Electronic Frontier Foundation

## Guardando al futuro {#looking-forward}

L'aggiunta dei pagamenti in criptovaluta è solo un ulteriore passo avanti nel nostro impegno costante per la privacy e la libertà di scelta degli utenti. Crediamo che il tuo servizio di posta elettronica debba rispettare la tua privacy a ogni livello, dai messaggi che invii alle modalità di pagamento.

Come sempre, apprezziamo il tuo feedback su questa nuova opzione di pagamento. Per qualsiasi domanda sull'utilizzo delle criptovalute con Forward Email, contattaci al nostro [squadra di supporto](/help).
...
2. [Moneta stabile USDC](https://www.circle.com/en/usdc)
...
6. [Fondazione Frontiera Elettronica - Privacy](https://www.eff.org/issues/privacy)
7. [Informativa sulla privacy per l'inoltro delle e-mail](/privacy)