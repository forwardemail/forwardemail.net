...
* [Prefácio](#foreword)
* [Por que os pagamentos criptográficos são importantes](#why-crypto-payments-matter)
...
* [Configurando sua carteira de criptomoedas](#setting-up-your-crypto-wallet)
  ...
  * [CarteiraConectar](#walletconnect)
* [Começando](#getting-started)
* [Esperando ansiosamente](#looking-forward)

## Prefácio {#foreword}

Na [Encaminhar e-mail](https://forwardemail.net), buscamos constantemente maneiras de aprimorar sua [privacidade](https://en.wikipedia.org/wiki/Privacy) e sua segurança, tornando nosso serviço mais acessível. Hoje, temos o prazer de anunciar que agora aceitamos pagamentos [criptomoeda](https://en.wikipedia.org/wiki/Cryptocurrency) por meio da integração de pagamento com criptomoedas [Listras](https://stripe.com).
...
* [CarteiraConectar](https://walletconnect.com) (compatível com muitas outras carteiras)
...
* **Informações Pessoais Reduzidas**: Ao contrário dos pagamentos com cartão de crédito, as transações com criptomoedas não exigem seu nome, endereço de cobrança ou outros dados pessoais. Saiba mais sobre [privacidade de transação](https://en.wikipedia.org/wiki/Privacy_coin).
...
* Enquanto você paga em criptomoedas, recebemos o valor equivalente em dólares americanos, o que nos permite manter preços estáveis.

## Configurando sua carteira de criptomoedas {#setting-up-your-crypto-wallet}

Novo em criptomoeda? Veja como configurar as carteiras que oferecemos suporte:
...
__URL_PROTEGIDA_18__ MetaMask {__URL_PROTEGIDA_19__
...
6. [Guia de carteira fantasma](https://help.phantom.app/hc/en-us/articles/4406388623251-How-to-create-a-new-wallet)
...
__URL_PROTEGIDA_24__ WalletConnect {__URL_PROTEGIDA_25__

[CarteiraConectar](https://walletconnect.com) é um protocolo que conecta carteiras a sites.
...
Pronto para aumentar sua privacidade com pagamentos criptográficos? Basta selecionar a opção "Cripto" durante o checkout na próxima vez que você renovar sua assinatura ou atualizar seu plano.

Para mais informações sobre criptomoedas e tecnologia blockchain, confira estes recursos:

* __LINK_PROTEGIDO_77__ - Investopedia
* __LINK_PROTEGIDO_78__ - Investopedia
* __LINK_PROTEGIDO_79__ - Fundação Fronteira Eletrônica

## Ansiosos {#looking-forward}
...
Como sempre, agradecemos seu feedback sobre esta nova opção de pagamento. Se tiver dúvidas sobre o uso de criptomoedas com o Forward Email, entre em contato pelo nosso [equipe de suporte](/help).
...
7. [Política de Privacidade de E-mail Encaminhado](/privacy)