...
* [사례 연구: 캠브리지 대학교](#case-study-university-of-cambridge)
  * [도전](#challenge)
  * [해결책](#solution)
  * [결과](#results)
* [대학 및 동문의 혜택](#benefits-for-universities-and-alumni)
  ...
  * [이전 솔루션과 비교한 비용 절감](#cost-savings-compared-to-previous-solutions)
...
우리는 명문 대학과 그 동문을 대상으로 세계에서 가장 안전하고, 개인정보 보호가 강화되고, 유연한 이메일 전달 서비스를 구축했습니다.

경쟁이 치열한 고등교육 환경에서 동문과 평생 관계를 유지하는 것은 단순히 전통의 문제가 아니라 전략적 필수 사항입니다. 대학이 이러한 연결을 육성하는 가장 구체적인 방법 중 하나는 동문 이메일 주소를 통해 졸업생에게 학업적 유산을 반영하는 디지털 아이덴티티를 제공하는 것입니다.

Forward Email은 세계 유수의 교육 기관들과 협력하여 동문 이메일 서비스 관리 방식을 혁신해 왔습니다. Forward Email의 엔터프라이즈급 이메일 전달 솔루션은 이제 [캠브리지 대학교](https://en.wikipedia.org/wiki/University_of_Cambridge), [메릴랜드 대학교](https://en.wikipedia.org/wiki/University_of_Maryland,\_College_Park), [터프츠 대학교](https://en.wikipedia.org/wiki/Tufts_University), [스와스모어 칼리지](https://en.wikipedia.org/wiki/Swarthmore_College)의 동문 이메일 시스템을 지원하여 전 세계 수천 명의 동문에게 서비스를 제공하고 있습니다.

이 블로그 게시물에서는 당사의 [오픈소스](https://en.wikipedia.org/wiki/Open-source_software), 개인정보 보호 중심 이메일 전달 서비스가 이러한 기관에서 선호하는 솔루션이 된 과정, 이를 가능하게 하는 기술적 구현, 그리고 행정 효율성과 동문 만족도에 미친 혁신적인 영향에 대해 알아봅니다.
...
| 교육용 Google Workspace | 무료(Education Fundamentals)<br>$3/학생/년(Education Standard)<br>$5/학생/년(Education Plus) | 무료 - $500,000 | • 볼륨 할인: 100-499개 라이선스의 경우 5%<br>• 볼륨 할인: 500개 이상 라이선스의 경우 10%<br>• 무료 계층은 핵심 서비스에 한함 |
...
| 자체 호스팅 거래소 | $45 | $4,500,000 | 지속적인 유지 관리 및 보안 비용이 계속 증가합니다. |
| **Forward Email Enterprise** | **고정 $250/월** | **연간 3,000달러** | **출시 이후 가격 인상 없음** |

### 실제 대학 비용 절감 {#real-world-university-savings}

기존 공급업체 대신 Forward Email을 선택하여 파트너 대학이 매년 얼마나 많은 비용을 절감하는지 알아보세요.

| 대학교 | 동문 수 | Google의 연간 비용 | 전달 이메일로 인한 연간 비용 | 연간 절감액 |
| ----------------------- | ------------ | ----------------------- | ------------------------------ | -------------- |
| 캠브리지 대학교 | 30,000 | $90,000 | $3,000 | $87,000 |
...
이는 기존 이메일 호스팅 솔루션에 비해 상당한 비용 절감 효과를 가져옵니다. 대학은 이 자금을 장학금, 연구 또는 기타 핵심 사업에 투자할 수 있습니다. 이메일 공급업체 선정(Email Vendor Selection)의 2023년 분석에 따르면, AI 기능 통합으로 가격이 계속 상승함에 따라 교육 기관들은 기존 이메일 공급업체보다 비용 효율적인 대안을 점점 더 많이 찾고 있습니다([이메일 공급업체 선택, 2023](https://www.emailvendorselection.com/email-service-provider-list/)).

## 대학 동문 이메일 챌린지 {#the-university-alumni-email-challenge}

대학의 경우, 동문에게 평생 이메일 주소를 제공하는 것은 기존 이메일 솔루션으로는 효과적으로 해결하기 어려운 고유한 과제를 안겨줍니다. ServerFault에 대한 심도 있는 논의에서 언급했듯이, 사용자 기반이 큰 대학은 성능, 보안, 그리고 비용 효율성의 균형을 맞춘 전문 이메일 솔루션이 필요합니다([서버폴트, 2009](https://serverfault.com/questions/97364/what-is-the-best-mail-server-for-a-university-with-a-large-amount-of-users)).

### 동문 이메일 ID의 가치 {#the-value-of-alumni-email-identity}

동문 이메일 주소(예: `firstname.lastname@cl.cam.ac.uk` 또는 `username@terpalum.umd.edu`)는 여러 가지 중요한 기능을 수행합니다.
...
Tekade(2020)의 연구에 따르면 교육용 이메일 주소는 학업 자료에 대한 접근, 전문적 신뢰도, 다양한 서비스에 대한 독점 할인 등 동문에게 수많은 이점을 제공한다는 점이 강조되었습니다([중간, 2020](https://medium.com/coders-capsule/top-20-benefits-of-having-an-educational-email-address-91a09795e05)).
...
당사의 솔루션은 정교하면서도 우아한 단순함을 추구하는 기술 아키텍처를 활용하여 대규모로 안정적이고 안전한 이메일 전달 서비스를 제공합니다.

### 핵심 아키텍처 {#core-architecture}

전달 이메일 시스템은 여러 가지 핵심 구성 요소로 구성됩니다.
...
우리는 기존 대학 인프라와 원활한 통합 경로를 개발했습니다.
...
당사의 [RESTful API](https://forwardemail.net/email-api)를 사용하면 대학에서 이메일 관리를 자동화할 수 있습니다.
...
적절한 DNS 구성은 이메일 전달에 필수적입니다. 저희 팀은 다음을 지원합니다.

* MX 레코드를 포함한 [DNS](https://en.wikipedia.org/wiki/Domain_Name_System) 구성
* 오픈 소스 [메일 인증](https://www.npmjs.com/package/mailauth) 패키지를 사용하여 포괄적인 이메일 보안을 구현했습니다. 이 패키지는 이메일 인증을 위한 만능 도구로, 다음을 처리합니다.
* [SPF](https://en.wikipedia.org/wiki/Sender_Policy_Framework)(발신자 정책 프레임워크): 이메일 스푸핑 방지
* [DKIM](https://en.wikipedia.org/wiki/DomainKeys_Identified_Mail)(도메인키 식별 메일): 이메일 인증
* [DMARC](https://en.wikipedia.org/wiki/Email_authentication)(도메인 기반 메시지 인증, 보고 및 준수): 정책 적용
* [MTA-STS](https://en.wikipedia.org/wiki/Opportunistic_TLS)(SMTP MTA Strict Transport Security): TLS 암호화 적용
* [ARC](https://en.wikipedia.org/wiki/DomainKeys_Identified_Mail#Authenticated_Received_Chain)(인증된 수신 체인): 메시지 전달 시 인증 유지
* [SRS](https://en.wikipedia.org/wiki/Sender_Rewriting_Scheme)(발신자 재작성 체계): 전달 중 SPF 검증 유지
* [BIMI](https://en.wikipedia.org/wiki/Email_authentication) (메시지 식별을 위한 브랜드 표시) - 지원 이메일 클라이언트의 로고 표시용
...
당사의 체계적인 구현 프로세스는 당사 솔루션을 도입한 대학이 원활하게 전환할 수 있도록 보장합니다.

### 초기 평가 및 계획 {#initial-assessment-and-planning}

우리는 대학의 현재 이메일 시스템, 동문 데이터베이스, 기술 요구 사항에 대한 포괄적인 평가로 시작합니다. 이 단계에는 다음이 포함됩니다.
...
평가를 토대로 완전한 데이터 무결성을 보장하는 동시에 중단을 최소화하는 맞춤형 마이그레이션 전략을 개발합니다.
...
포괄적인 교육을 통해 모든 이해 관계자가 시스템을 효과적으로 사용할 수 있도록 보장합니다.
...
BulkSignature(2023)에 따르면 교육 기관을 위한 이메일 플랫폼은 무료 또는 저렴한 요금제를 통한 비용 효율성, 대량 커뮤니케이션 기능을 통한 시간 효율성, 이메일 전달 및 참여를 모니터링하는 추적 기능 등 상당한 이점을 제공합니다([벌크시그니처, 2023](https://bulksignature.com/blog/5-best-email-platforms-for-educational-institutions/)).
...
대학들은 동문 커뮤니티에서 높은 채택률과 만족도를 보고하고 있습니다.

### 이전 솔루션과 비교한 비용 절감 {#cost-savings-compared-to-previous-solutions}

재정적 영향은 상당했으며, 대학들은 이전 이메일 솔루션에 비해 상당한 비용 절감 효과를 보고했습니다.
...
저희는 새로운 기능과 성능으로 동문 이메일 솔루션을 지속적으로 개선해 나가고 있습니다.
...
Forward Email은 대학이 동문 이메일 서비스를 제공하고 관리하는 방식에 혁명을 일으켰습니다. 비용이 많이 들고 복잡한 이메일 호스팅을 우아하고 안전한 이메일 전달로 대체함으로써 기관은 모든 동문에게 평생 이메일 주소를 제공하는 동시에 비용과 관리 비용을 획기적으로 줄일 수 있었습니다.

케임브리지, 메릴랜드, 터프츠, 스와스모어와 같은 명문 기관과의 파트너십은 다양한 교육 환경에서 우리 접근 방식의 효과를 보여줍니다. 대학이 비용을 통제하는 동시에 동문과의 관계를 유지해야 하는 압박이 커짐에 따라, 우리 솔루션은 기존 이메일 시스템에 대한 매력적인 대안을 제공합니다.
...
Forward Email이 동문 이메일 서비스를 어떻게 혁신할 수 있는지 알아보고 싶은 대학의 경우 <support@forwardemail.net>으로 당사 팀에 문의하거나 [forwardemail.net](https://forwardemail.net)를 방문하여 당사의 엔터프라이즈 솔루션에 대해 자세히 알아보세요.