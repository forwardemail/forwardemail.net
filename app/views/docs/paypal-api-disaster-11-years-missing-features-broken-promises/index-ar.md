# كارثة واجهة برمجة التطبيقات الخاصة بـ PayPal التي استمرت 11 عامًا: كيف قمنا ببناء حلول بديلة بينما تجاهلوا المطورين {#paypals-11-year-api-disaster-how-we-built-workarounds-while-they-ignored-developers}
...
يُظهر ملف [منشور المجتمع الأصلي](https://web.archive.org/web/20201019142512/https://www.paypal-community.com/t5/REST-API-SDK/List-all-subscriptions/td-p/1147066) لعام 2017 توسلات المطورين للحصول على هذه الوظيفة الأساسية. وكان رد باي بال هو أرشفة المستودع الذي كان الناس يُبلغون عن المشكلة فيه.

## 2020: نقدم لهم تعليقات موسعة {#2020-we-give-them-extensive-feedback}
...
## هجرة المديرين التنفيذيين: كيف فقدت باي بال كل الذاكرة المؤسسية {#the-executive-exodus-how-paypal-lost-all-institutional-memory}

هنا تبدأ الأمور المثيرة للاهتمام. جميع من تلقّى ملاحظاتنا لعام ٢٠٢٠ غادروا باي بال:

**تغييرات القيادة:**

* [دان شولمان (الرئيس التنفيذي لمدة 9 سنوات) → أليكس كريس](https://www.fastcompany.com/90938418/paypal-ceo-alex-chriss-dan-schulman-what-to-know/) (سبتمبر 2023)
* [سري شيفاناندا (المدير التقني الذي نظم ردود الفعل) → جي بي مورجان تشيس](https://www.pymnts.com/personnel/2024/jpmorgan-names-paypal-vet-shivananda-as-new-tech-chief/) (يناير 2024)

**القادة الفنيون الذين قدموا وعودًا ثم رحلوا:**

* **مارك ستيوارت** (وعد بأن تكون الملاحظات "حافزًا") → [الآن في ريبل](https://www.linkedin.com/in/markstuartsf)
* **جيم ماجاتس** (خبير في باي بال منذ 18 عامًا) → [الرئيس التنفيذي لشركة MX](https://www.cnbc.com/2022/07/28/paypal-veteran-jim-magats-is-named-ceo-of-mx-the-startup-that-connects-banks-and-fintech-players.html) (2022)
* **جون كونزي** (نائب رئيس قسم المنتجات الاستهلاكية العالمية) → [متقاعد](https://www.linkedin.com/in/john-kunze-5724a86) (2023)
* **إدوين أوكي** (من آخر الأعضاء المتبقين) → [غادر للتو إلى ناسداك](https://www.linkedin.com/posts/edwinaoki_apparently-i-just-cant-stay-awaythe-day-activity-7289388518487793664-j8OZ) (يناير 2025)
...
شكرًا جزيلاً لك يا نيك، على نقل أليكس إلى مركز الاتصال المخفي. لقد بحثنا في الأمر منذ منشورك السابق. سنتصل بك قبل نهاية الأسبوع. هل يمكنك إرسال معلومات الاتصال بك ليتمكن أحد زملائي من التواصل معك؟ ميشيل
...
### استجابة مارتي برودبيك للهندسة المفرطة {#marty-brodbecks-overengineering-response}
...
إذا كانت "عمليات CRUD البسيطة جزءًا من واجهة برمجة التطبيقات الأساسية"، فأين نقطة نهاية قائمة الاشتراك؟ يطالب المطورون بهذه "عملية CRUD البسيطة" منذ عام ٢٠١٤. أي منذ ١١ عامًا. جميع معالجات الدفع الأخرى تتمتع بهذه الوظيفة الأساسية منذ اليوم الأول.
...
* تم تغيير مفاتيح API السرية لبيئة الحماية بشكل عشوائي وتعطيلها.
* تم حذف جميع حسابات اختبار بيئة الحماية دون إشعار.
* ظهرت رسائل خطأ عند محاولة عرض تفاصيل حساب بيئة الحماية.
...
شكرًا جزيلًا على مساعدتكم المتواصلة في تطويرنا. نقدّر ذلك كثيرًا.
...
**تطبيق المصادقة الثنائية (2FA) من PayPal مُعقّد**. حتى مع تفعيل تطبيقات TOTP، فإنها تُجبر على التحقق عبر الرسائل النصية، مما يجعل الحسابات عُرضةً لهجمات تبديل بطاقة SIM. إذا كانت ميزة TOTP مُفعّلة لديك، فيجب استخدامها حصريًا. الحل البديل هو البريد الإلكتروني، وليس الرسائل النصية.
...
* بعد ساعات، أوقفت PayPal فجأة جميع مدفوعات الاشتراك دون إشعار.
* لم يتمكن العملاء من الدفع، مما تسبب في ارتباك وعبء على الدعم.
* قدم دعم PayPal ردودًا متناقضة تدعي التحقق من الحسابات.
* اضطررنا إلى إيقاف مدفوعات PayPal تمامًا.
...
<figure>
<figcaption><div class="alert alert-danger small text-center">
يزعم فريق دعم باي بال أن كل شيء على ما يرام، بينما المدفوعات معطلة تمامًا. الرسالة الأخيرة تُظهر أنهم قالوا إنهم "استعادوا بعض الميزات" لكنهم ما زالوا يطلبون معلومات إضافية غير محددة - دعم باي بال التقليدي.
</div></figcaption>
...
رغم كل هذه المشاكل، لا يمكننا التخلي عن باي بال تمامًا، لأن بعض العملاء لا يستخدمونه إلا كخيار دفع. وكما قال أحد العملاء على موقعنا [صفحة الحالة](https://github.com/forwardemail/status.forwardemail.net/issues/1658#issuecomment-3026530515):
...
بما أن باي بال لن يوفر وظائف قائمة الاشتراكات الأساسية، فقد طوّر مجتمع المطورين حلولاً بديلة. أنشأنا نصًا برمجيًا يساعد في إدارة اشتراكات باي بال: [set-active-pypl-subscription-ids.js](https://github.com/forwardemail/forwardemail.net/blob/master/scripts/set-active-pypl-subscription-ids.js)

يشير هذا النص البرمجي إلى [جوهر المجتمع](https://gist.github.com/titanism/955f0c21d53e8c98068c549fb79e75d4) حيث يتشارك المطورون الحلول. المستخدمون في الواقع [شكرنا](https://gist.github.com/titanism/955f0c21d53e8c98068c549fb79e75d4?permalink_comment_id=5045775#gistcomment-5045775) لتقديمهم ما كان ينبغي على PayPal أن يبنيه منذ سنوات.
...
أُعيد توجيه هذا البريد الإلكتروني إلى `abuse@microsoft.com` لأنه بدا وكأنه محاولة تصيد احتيالي. المشكلة؟ في الواقع، كان مصدره بيئة باي بال التجريبية، ولكن تصميم قالبهم رديء للغاية لدرجة أنه يُفعّل أنظمة كشف التصيد الاحتيالي.
...
غالبًا ما تأتي هذه الرسائل الإلكترونية من مُضيفين `outlook.com`، ولكن يبدو أنها صادرة من أنظمة PayPal الشرعية، مما يجعلها خطيرة للغاية. تجتاز هذه الرسائل مصادقة SPF وDKIM وDMARC لأنها تُرسل عبر البنية التحتية الفعلية لـ PayPal.

تُظهر سجلاتنا الفنية أن رسائل البريد الإلكتروني العشوائية هذه تحتوي على رؤوس PayPal شرعية:

* `X-Email-Type-Id: RT000238` (نفس المعرف الذي نحظره)
...
تم توثيق ذلك في بحث أمني: [احذر من عملية الاحتيال عبر عنوان PayPal الجديد](https://www.bleepingcomputer.com/news/security/beware-paypal-new-address-feature-abused-to-send-phishing-emails/) - يوضح كيف يتم استغلال أنظمة PayPal الخاصة للاحتيال.

### التأثير الحقيقي: عمليات احتيال جديدة على PayPal {#real-world-impact-novel-paypal-scams}

لا تقتصر المشكلة على سوء تصميم القالب فحسب. فنظام الفواتير في باي بال سهل الاستغلال لدرجة أن المحتالين يستغلونه بانتظام لإرسال فواتير مزورة تبدو شرعية. وثّق الباحث الأمني جافين أنديريج حالة [عملية احتيال جديدة على PayPal](https://anderegg.ca/2023/02/01/a-novel-paypal-scam) حيث يرسل المحتالون فواتير باي بال حقيقية تجتاز جميع اختبارات المصادقة.
...
* **فقدان ثقة العملاء** عند فشل المدفوعات بشكل غامض

### كارثة هجرة الحسابات في يوليو 2025 {#the-july-2025-account-migration-disaster}

حدث هذا السيناريو بالضبط أثناء عملية نقل حساباتنا الروتينية في يوليو ٢٠٢٥. سمح باي بال في البداية بالدفع، ثم أوقفه فجأةً دون أي إشعار. لم نكتشف المشكلة إلا عندما أبلغنا العملاء عن عدم قدرتهم على الدفع.

عند تواصلنا مع الدعم، تلقينا ردودًا متناقضة حول المستندات المطلوبة، دون تحديد جدول زمني واضح للحل. هذا أجبرنا على إيقاف مدفوعات PayPal تمامًا، مما أربك العملاء الذين لم تكن لديهم خيارات دفع أخرى.
...
استضاف مجتمع باي بال الأصلي في `paypal-community.com` **6,003,558 عضوًا**، وتضمن مئات الآلاف من المنشورات وتقارير الأخطاء والشكاوى والمناقشات حول أعطال واجهة برمجة تطبيقات باي بال. مثّل هذا أكثر من عقد من الأدلة الموثقة على مشاكل باي بال المنهجية.
...
لحسن الحظ، قامت خدمة خارجية على الرابط [ppl.lithium.com](https://ppl.lithium.com/) بحفظ بعض المحتوى، مما سمح لنا بالوصول إلى المناقشات التي حاولت باي بال إخفاءها. مع ذلك، فإن هذه الخدمة الخارجية غير مكتملة وقد تختفي في أي وقت.
...
### خسارة 1899 دولارًا أمريكيًا في رسائل البريد الإلكتروني الموجهة {#forward-emails-1899-loss}
...
في عام ٢٠١٦، وثّق مستودع GitHub الخاص بشركة PayPal ثغرة أمنية تؤثر على حزمة تطوير البرامج PHP الرسمية الخاصة بها. وكان حجم هذه الثغرة مذهلاً:
...
تُظهر التقارير الأخيرة من مجتمع باي بال المُحافظ أن المشكلة قد تفاقمت. يُوثّق ملف [مناقشة سبتمبر 2024](https://ppl.lithium.com/t5/REST-APIs/Receiving-APPROVED-Webhooks-for-Order-but-capture-leads-to-404/td-p/3176093) ([مؤرشفة](https://web.archive.org/web/20250708045416/https://ppl.lithium.com/t5/REST-APIs/Receiving-APPROVED-Webhooks-for-Order-but-capture-leads-to-404/td-p/3176093)) نفس المشاكل تمامًا:
...
يكشف رابط [مناقشة المجتمع المحفوظة](https://ppl.lithium.com/t5/REST-APIs/Not-received-PAYMENT-CAPTURE-COMPLETED-when-had-captured/m-p/3042446) آخر أن نظام webhook الخاص بـ PayPal غير موثوق به بشكل أساسي:
...
أدى استحواذ باي بال على شركة هاني إلى سرقة عمولات من منشئي المحتوى والمؤثرين. وهذا يُمثل شكلاً آخر من أشكال الخداع الممنهج، حيث تستفيد باي بال من خلال إعادة توجيه الإيرادات التي كان من المفترض أن تذهب إلى جهات أخرى.
...
* **قائمة الاشتراك**: تُشير الوثائق إلى إمكانية القائمة حتى في حالة عدم وجود نقطة نهاية.
* **مهلة الجلسة**: لم يُذكر مهلة زمنية مُرهقة لمدة 60 ثانية.
...
إذا كنت تُنشئ نظام دفع، فتعلّم من تجربتنا: أنشئ [نهج ثلاثي](https://forwardemail.net/en/blog/docs/building-reliable-payment-system-stripe-paypal) الخاص بك باستخدام معالجات متعددة، ولكن لا تتوقع من PayPal توفير الوظائف الأساسية التي تحتاجها. خطط لبناء حلول بديلة منذ البداية.
