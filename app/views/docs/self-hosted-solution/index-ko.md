...
* [머리말](#foreword)
* [셀프호스팅 이메일이 중요한 이유](#why-self-hosted-email-matters)
...
* [자체 호스팅 구현: 기술 개요](#our-self-hosted-implementation-technical-overview)
  * [단순성과 이동성을 위한 Docker 기반 아키텍처](#docker-based-architecture-for-simplicity-and-portability)
...
* [오픈소스에 대한 약속](#the-open-source-commitment)
* [자체 호스팅 대 관리형: 올바른 선택하기](#self-hosted-vs-managed-making-the-right-choice)
  * [셀프호스팅 이메일의 현실](#the-reality-of-self-hosting-email)
  * [언제 우리의 관리 서비스를 선택해야 합니까?](#when-to-choose-our-managed-service)
* [셀프호스팅 포워드 이메일 시작하기](#getting-started-with-self-hosted-forward-email)
  * [시스템 요구 사항](#system-requirements)
  * [설치 단계](#installation-steps)
* [셀프호스팅 이메일의 미래](#the-future-of-self-hosted-email)
...
당사의 셀프호스팅 이메일 솔루션은 진정한 프라이버시는 통제를 의미하며, 통제는 오픈 소스에서 시작한다는 당사의 신념을 가장 명확하게 표현한 것입니다. 디지털 커뮤니케이션에 대한 완전한 소유권을 요구하는 사용자에게 셀프호스팅은 더 이상 주변적인 아이디어가 아닙니다. 이는 필수적인 권리입니다. 당사는 귀하가 원하는 대로 실행할 수 있는 완전히 개방적이고 검증 가능한 플랫폼으로 이러한 신념을 뒷받침하게 되어 자랑스럽게 생각합니다.
...
### 관리형 서비스를 선택해야 하는 경우 {#when-to-choose-our-managed-service}
...
* [역 PTR](https://www.cloudflare.com/learning/dns/dns-records/dns-ptr-record/) 설정 가능
* IPv4 및 IPv6 지원
...
이메일을 직접 관리할 준비가 되셨나요? [오늘 시작하세요](https://forwardemail.net/self-hosted)을 클릭하거나 [GitHub 저장소](https://github.com/forwardemail/forwardemail.net)을 탐색하여 자세한 내용을 알아보세요.
