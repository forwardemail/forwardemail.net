...
Im Falle eines [Angriff des bösen Dienstmädchens](https://en.wikipedia.org/wiki/Evil_maid_attack) oder eines betrügerischen Mitarbeiters eines Drittanbieters **kann Ihr Postfach weiterhin nur mit Ihrem generierten Passwort geöffnet werden**. Seien Sie versichert, wir verlassen uns auf keine anderen Drittanbieter als unsere SOC Typ 2-konformen Serveranbieter Cloudflare, DataPacket, Digital Ocean, GitHub und Vultr.
