...
Jos kyseessä on [pahan piian hyökkäys](https://en.wikipedia.org/wiki/Evil_maid_attack)-käyttäjä tai kolmannen osapuolen toimittajan luvaton työntekijä, **postilaatikkosi voidaan edelleen avata vain luomallasi salasanalla**. Voit olla varma, ettemme ole riippuvaisia muista kolmannen osapuolen toimittajista kuin SOC Type 2 -valituspalvelinpalveluntarjoajistamme, kuten Cloudflaresta, DataPacketista, Digital Oceanista, GitHub ja Vultrista.
