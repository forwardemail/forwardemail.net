...
เทคโนโลยีนี้น่าทึ่งมาก และเรายังคงใช้มันอยู่ทุกวันนี้ แต่เพื่อให้มีการเข้ารหัสแบบคงที่กับ MongoDB คุณต้องใช้ผู้ให้บริการที่เสนอ MongoDB Enterprise เช่น Digital Ocean หรือ Mongo Atlas หรือจ่ายเงินสำหรับใบอนุญาตระดับองค์กร (และต่อมาต้องทำงานกับความล่าช้าของทีมขาย)

ทีมงานของเราที่ [ส่งต่ออีเมล์](https://forwardemail.net) ต้องการโซลูชันการจัดเก็บข้อมูลสำหรับกล่องจดหมาย IMAP ที่ใช้งานง่าย ปรับขนาดได้ เชื่อถือได้ และมีการเข้ารหัส ในฐานะนักพัฒนาโอเพนซอร์ส การใช้เทคโนโลยีที่ต้องเสียค่าธรรมเนียมใบอนุญาตเพื่อให้ได้คุณสมบัติการเข้ารหัสขณะพักนั้นขัดต่อ [หลักการของเรา](#principles) ดังนั้นเราจึงได้ทดลอง วิจัย และพัฒนาโซลูชันใหม่ตั้งแต่ต้นเพื่อตอบโจทย์ความต้องการเหล่านี้

แทนที่จะใช้ฐานข้อมูลร่วมกันในการจัดเก็บกล่องจดหมายของคุณ เราจะจัดเก็บและเข้ารหัสกล่องจดหมายของคุณทีละรายการด้วยรหัสผ่านของคุณ (ซึ่งคุณเท่านั้นที่มี) **บริการอีเมลของเราปลอดภัยมาก ดังนั้นหากคุณลืมรหัสผ่าน คุณจะสูญเสียกล่องจดหมายของคุณ** (และจำเป็นต้องกู้คืนด้วยการสำรองข้อมูลแบบออฟไลน์หรือเริ่มต้นใหม่)

อ่านต่อไปเพื่อดูข้อมูลเจาะลึกด้านล่างพร้อมด้วย [การเปรียบเทียบผู้ให้บริการอีเมล์](#email-service-provider-comparison), [บริการของเราทำงานอย่างไร](#how-does-it-work), [เทคโนโลยีของเรา](#technologies) และอื่นๆ อีกมากมาย

## การเปรียบเทียบผู้ให้บริการอีเมล {#email-service-provider-comparison}

เราเป็นผู้ให้บริการอีเมลโอเพ่นซอร์ส 100% และเน้นความเป็นส่วนตัวเพียงรายเดียวที่จัดเก็บกล่องจดหมาย SQLite ที่เข้ารหัสเป็นรายบุคคล ให้โดเมน นามแฝง และผู้ใช้ไม่จำกัด และรองรับ SMTP ขาออก IMAP และ POP3:

**ไม่เหมือนผู้ให้บริการอีเมลรายอื่น คุณไม่จำเป็นต้องเสียเงินสำหรับพื้นที่จัดเก็บแบบต่อโดเมนหรือนามแฝงด้วย Forward Email** พื้นที่จัดเก็บจะถูกแชร์ในบัญชีของคุณทั้งหมด ดังนั้นหากคุณมีชื่อโดเมนที่กำหนดเองหลายชื่อและมีนามแฝงหลายชื่อในแต่ละชื่อ เราคือโซลูชันที่สมบูรณ์แบบสำหรับคุณ โปรดทราบว่าคุณยังคงบังคับใช้ขีดจำกัดพื้นที่จัดเก็บได้หากต้องการแบบต่อโดเมนหรือนามแฝง
...
2. เมื่อเชื่อมต่อแล้ว ไคลเอนต์อีเมลของคุณจะส่ง [คำสั่งโปรโตคอล IMAP](https://en.wikipedia.org/wiki/Internet_Message_Access_Protocol) ไปยังเซิร์ฟเวอร์ IMAP ของเราเพื่อให้กล่องจดหมายของคุณซิงค์กัน ซึ่งรวมถึงการเขียนและจัดเก็บอีเมลฉบับร่าง และการดำเนินการอื่นๆ ที่คุณอาจทำ (เช่น ระบุอีเมลว่าสำคัญ หรือตั้งค่าสถานะอีเมลเป็นสแปม/อีเมลขยะ)
...
> \[!TIP]
> สนใจเรียนรู้เพิ่มเติมหรือไม่? อ่าน [วิธีตั้งค่าการส่งต่ออีเมล์](/faq#how-do-i-get-started-and-set-up-email-forwarding), [บริการแลกเปลี่ยนไปรษณีย์ของเราทำงานอย่างไร](/faq#how-does-your-email-forwarding-system-work) หรือดู [ไกด์ของเรา](/guides)
...
* เมื่อได้รับอีเมลใหม่จากผู้ส่งถึงคุณ เซิร์ฟเวอร์แลกเปลี่ยนอีเมลของเราจะเขียนไปยังกล่องจดหมายชั่วคราวแบบเข้ารหัสส่วนบุคคลของคุณ
...
* เมื่อคุณเชื่อมต่อกับเซิร์ฟเวอร์ IMAP ของเราด้วยไคลเอนต์อีเมลของคุณ รหัสผ่านของคุณจะถูกเข้ารหัสในหน่วยความจำและใช้ในการอ่านและเขียนไปยังกล่องจดหมายของคุณ กล่องจดหมายของคุณสามารถอ่านและเขียนได้โดยใช้รหัสผ่านนี้เท่านั้น โปรดทราบว่าเนื่องจากคุณเป็นผู้เดียวที่มีรหัสผ่านนี้ จึงมีเพียงคุณเท่านั้นที่สามารถอ่านและเขียนไปยังกล่องจดหมายของคุณได้เมื่อคุณเข้าถึง ในครั้งถัดไปที่ไคลเอนต์อีเมลของคุณพยายามสำรวจอีเมลหรือซิงค์ ข้อความใหม่ของคุณจะถูกโอนจากกล่องจดหมายชั่วคราวนี้และเก็บไว้ในไฟล์กล่องจดหมายจริงของคุณโดยใช้รหัสผ่านที่คุณให้มา โปรดทราบว่ากล่องจดหมายชั่วคราวนี้จะถูกล้างและลบออกในภายหลังเพื่อให้กล่องจดหมายที่ได้รับการป้องกันด้วยรหัสผ่านของคุณเท่านั้นที่มีข้อความ

* **หากคุณเชื่อมต่อกับ IMAP (เช่น ใช้ไคลเอนต์อีเมลเช่น Apple Mail หรือ Thunderbird) เราไม่จำเป็นต้องเขียนลงในพื้นที่จัดเก็บชั่วคราว แต่จะใช้รหัสผ่าน IMAP ที่เข้ารหัสในหน่วยความจำของคุณแทน ในแบบเรียลไทม์ เมื่อพยายามส่งข้อความถึงคุณ เราจะส่งคำขอ WebSocket ไปยังเซิร์ฟเวอร์ IMAP ทั้งหมดเพื่อถามว่ามีเซสชันที่ใช้งานอยู่สำหรับคุณหรือไม่ (นี่คือส่วนที่ต้องดึงข้อมูล) จากนั้นจะส่งรหัสผ่านที่เข้ารหัสในหน่วยความจำต่อไป ดังนั้นเราไม่จำเป็นต้องเขียนลงในกล่องจดหมายชั่วคราว แต่สามารถเขียนลงในกล่องจดหมายที่เข้ารหัสจริงของคุณได้โดยใช้รหัสผ่านที่เข้ารหัสของคุณ**
...
5. [การสำรองข้อมูลกล่องจดหมายที่เข้ารหัสของคุณ](#backups) จะถูกดำเนินการทุกวัน คุณยังสามารถขอสำรองข้อมูลใหม่ได้ตลอดเวลาหรือดาวน์โหลดข้อมูลสำรองล่าสุดได้จาก <a href="/my-account/domains" target="_blank" rel="noopener noreferrer" class="alert-link">บัญชีของฉัน <i class="fa fa-angle-right"></i> โดเมน</a> <i class="fa fa-angle-right"></i> นามแฝง หากคุณตัดสินใจเปลี่ยนไปใช้บริการอีเมลอื่น คุณสามารถย้ายข้อมูล ดาวน์โหลด ส่งออก และล้างกล่องจดหมายและข้อมูลสำรองของคุณได้อย่างง่ายดายทุกเมื่อ

## เทคโนโลยี {#technologies}

### ฐานข้อมูล {#databases}

เราได้สำรวจเลเยอร์การจัดเก็บฐานข้อมูลที่เป็นไปได้อื่น ๆ อย่างไรก็ตาม ไม่มีเลเยอร์ใดที่ตอบสนองความต้องการของเราได้ดีเท่ากับ SQLite:
...
เราใช้การเข้ารหัส [การเข้ารหัสขณะพัก](https://en.wikipedia.org/wiki/Data_at_rest) ([AES-256](https://en.wikipedia.org/wiki/Advanced_Encryption_Standard)), [การเข้ารหัสระหว่างการขนส่ง](https://en.wikipedia.org/wiki/Data_in_transit) ([TLS](https://en.wikipedia.org/wiki/Transport_Layer_Security)), [DNS ผ่าน HTTPS](https://en.wikipedia.org/wiki/DNS_over_HTTPS) ("DoH") ตลอดเวลา โดยใช้การเข้ารหัส :tangerine: [ส้มแมนดาริน](https://tangeri.ne) และ [สแควร์](https://utelle.github.io/SQLite3MultipleCiphers/docs/ciphers/cipher_chacha20/) ([ชาชา20-โพลี1305](https://utelle.github.io/SQLite3MultipleCiphers/docs/ciphers/cipher_chacha20/)) บนกล่องจดหมาย นอกจากนี้ เรายังใช้การยืนยันตัวตนแบบสองปัจจัยโดยใช้โทเค็น (ต่างจาก SMS ซึ่ง [การโจมตีแบบ man-in-the-middle](https://en.wikipedia.org/wiki/Man-in-the-middle_attack) สงสัยว่าเป็นไปได้) คีย์ SSH แบบหมุนเวียนที่ปิดใช้งานสิทธิ์การเข้าถึงรูท การเข้าถึงเซิร์ฟเวอร์แบบจำกัดเฉพาะผ่านที่อยู่ IP ที่ถูกจำกัด และอื่นๆ อีกมากมาย

ในกรณีที่มีพนักงาน [แม่บ้านชั่วร้ายโจมตี](https://en.wikipedia.org/wiki/Evil_maid_attack) หรือพนักงานที่ไม่ซื่อสัตย์จากผู้ให้บริการบุคคลที่สาม **กล่องจดหมายของคุณจะยังคงเปิดได้โดยใช้รหัสผ่านที่คุณสร้างขึ้นเท่านั้น** โปรดมั่นใจว่าเราไม่ได้พึ่งพาผู้ให้บริการบุคคลที่สามใดๆ นอกเหนือจากผู้ให้บริการเซิร์ฟเวอร์ร้องเรียน SOC ประเภท 2 ของเรา ได้แก่ Cloudflare, DataPacket, Digital Ocean และ Vultr
...
[SQLite เป็นที่นิยมอย่างมาก](https://www.sqlite.org/mostdeployed.html) ฐานข้อมูลที่ฝังไว้ – ขณะนี้กำลังทำงานอยู่บนโทรศัพท์และคอมพิวเตอร์ของคุณ – [และถูกใช้โดยเทคโนโลยีหลักเกือบทั้งหมด](https://www.sqlite.org/famous.html)

ตัวอย่างเช่น บนเซิร์ฟเวอร์ที่เข้ารหัสของเรามีกล่องจดหมายฐานข้อมูล SQLite สำหรับ `linux@example.com`, `info@example.com`, `hello@example.com` และอื่นๆ โดยแต่ละไฟล์จะเป็นไฟล์ฐานข้อมูล `.sqlite` เราไม่ได้ตั้งชื่อไฟล์ฐานข้อมูลด้วยที่อยู่อีเมลเช่นกัน แต่จะใช้ BSON ObjectID และ UUID เฉพาะที่สร้างขึ้น ซึ่งจะไม่แชร์ว่ากล่องจดหมายนั้นเป็นเจ้าของหรืออยู่ภายใต้ที่อยู่อีเมลใด (เช่น `353a03f21e534321f5d6e267.sqlite`)

ฐานข้อมูลเหล่านี้แต่ละฐานข้อมูลจะถูกเข้ารหัสด้วยรหัสผ่านของคุณ (ซึ่งคุณเท่านั้นที่มี) โดยใช้ [สแควร์](https://utelle.github.io/SQLite3MultipleCiphers/docs/ciphers/cipher_chacha20/) ([ชาชา20-โพลี1305](https://utelle.github.io/SQLite3MultipleCiphers/docs/ciphers/cipher_chacha20/)) ซึ่งหมายความว่าเมลบ็อกซ์ของคุณจะถูกเข้ารหัสแยกกัน เป็นอิสระ [แซนด์บ็อกซ์](https://en.wikipedia.org/wiki/Sandbox_\(computer_security\)) และพกพาได้
...
ไคลเอนต์อีเมลบนโทรศัพท์ของคุณอาจแก้ไข `imap.forwardemail.net` เป็นหนึ่งในที่อยู่ IP ของ Digital Ocean ของเรา และไคลเอนต์เดสก์ท็อปของคุณอาจแก้ไข IP แยกจาก [ผู้ให้บริการ](#providers) อื่นโดยสิ้นเชิง

ไม่ว่าไคลเอนต์อีเมลของคุณจะเชื่อมต่อกับเซิร์ฟเวอร์ IMAP ตัวใด เราก็ต้องการให้การเชื่อมต่ออ่านข้อมูลจากฐานข้อมูลของคุณแบบเรียลไทม์ด้วยความแม่นยำ 100% ซึ่งทำได้ผ่าน WebSockets

#### เขียน {#writes}

การเขียนลงในฐานข้อมูลของคุณแตกต่างกันเล็กน้อย เนื่องจาก SQLite เป็นฐานข้อมูลแบบฝังตัว และเมลบ็อกซ์ของคุณจะอยู่ในไฟล์เดียวตามค่าเริ่มต้น
...
หากต้องการเขียนข้อมูลโดยเปิดใช้งาน write-ahead-logging ("[WAL](https://www.sqlite.org/wal.html)") เราจะต้องแน่ใจว่ามีเพียงเซิร์ฟเวอร์เดียว ("Primary") เท่านั้นที่รับผิดชอบในการดำเนินการดังกล่าว [WAL](https://www.sqlite.org/wal.html) จะเพิ่มความเร็วการทำงานพร้อมกันอย่างมาก และอนุญาตให้มีผู้เขียนหนึ่งคนและผู้อ่านหลายคน

เซิร์ฟเวอร์หลักกำลังทำงานบนเซิร์ฟเวอร์ข้อมูลที่มีโวลุ่มที่เมาท์ซึ่งมีกล่องจดหมายที่เข้ารหัสอยู่ จากมุมมองของการกระจาย คุณสามารถพิจารณาเซิร์ฟเวอร์ IMAP แต่ละตัวที่อยู่เบื้องหลัง `imap.forwardemail.net` เป็นเซิร์ฟเวอร์รอง ("รอง") ได้
...
* เซิร์ฟเวอร์รองใช้อินสแตนซ์ของไคลเอ็นต์ `WebSocket` ของ [ดับบลิวเอส](https://github.com/websockets/ws) ซึ่งถูกหุ้มด้วย [เว็บซ็อกเก็ตตามที่สัญญาไว้](https://github.com/vitalets/websocket-as-promised) และ [การเชื่อมต่อเว็บซ็อกเก็ตใหม่](https://github.com/opensumi/reconnecting-websocket) แรปเปอร์ทั้งสองนี้ช่วยให้มั่นใจว่า `WebSocket` จะเชื่อมต่อใหม่อีกครั้ง และสามารถส่งและรับข้อมูลสำหรับการเขียนฐานข้อมูลเฉพาะได้

### การสำรองข้อมูล {#backups}

> **tldr;** การสำรองข้อมูลกล่องจดหมายที่เข้ารหัสของคุณจะดำเนินการทุกวัน คุณสามารถขอการสำรองข้อมูลใหม่ทันทีหรือดาวน์โหลดการสำรองข้อมูลล่าสุดได้ตลอดเวลาจาก <a href="/my-account/domains" target="_blank" rel="noopener noreferrer" class="alert-link">บัญชีของฉัน <i class="fa fa-angle-right"></i> โดเมน</a> <i class="fa fa-angle-right"></i> นามแฝง
...
โปรดทราบว่าเราใช้คำสั่ง `VACUUM INTO` แทนคำสั่ง `backup` ในตัว เพราะหากมีการแก้ไขหน้าระหว่างการดำเนินการคำสั่ง `backup` หน้านั้นจะต้องเริ่มต้นใหม่ คำสั่ง `VACUUM INTO` จะบันทึกสแนปช็อตไว้ ดูความคิดเห็นเหล่านี้เกี่ยวกับ [GitHub](https://github.com/benbjohnson/litestream.io/issues/56) และ [ข่าวแฮกเกอร์](https://news.ycombinator.com/item?id=31387556) สำหรับข้อมูลเชิงลึกเพิ่มเติม

นอกจากนี้ เรายังใช้ `VACUUM INTO` แทน `backup` เนื่องจากคำสั่ง `backup` จะทำให้ฐานข้อมูลไม่เข้ารหัสเป็นระยะเวลาสั้นๆ จนกว่าจะมีการเรียกใช้ `rekey` (ดู GitHub [ความคิดเห็น](https://github.com/m4heshd/better-sqlite3-multiple-ciphers/issues/46#issuecomment-1468018927) นี้เพื่อดูรายละเอียด)
...
โปรดจำไว้ว่ากล่องจดหมายของคุณได้รับการเข้ารหัส และแม้ว่าเราจะมีข้อจำกัดด้าน IP และมาตรการการตรวจสอบสิทธิ์อื่นๆ สำหรับการสื่อสารบน WebSocket แต่ในกรณีที่มีผู้ไม่ประสงค์ดี คุณสามารถมั่นใจได้ว่า เว้นแต่เพย์โหลดของ WebSocket จะมีรหัสผ่าน IMAP ของคุณ จะไม่สามารถเปิดฐานข้อมูลของคุณได้

ขณะนี้มีการจัดเก็บข้อมูลสำรองเพียงหนึ่งรายการต่อกล่องจดหมาย แต่ในอนาคตเราอาจเสนอการกู้คืนแบบจุดต่อจุดเวลา ("[PITR](https://en.wikipedia.org/wiki/Point-in-time_recovery)")
...
ดัชนียังถูกเก็บไว้สำหรับทรัพย์สินทั้งหมดที่อยู่ในคำค้นหาด้วย

### โครงการ {#projects}

นี่คือตารางสรุปโครงการที่เราใช้ในโค้ดต้นฉบับและกระบวนการพัฒนา (เรียงตามตัวอักษร):
...
| [ImapTest](https://www.imapwiki.org/ImapTest) | เครื่องมือที่มีประโยชน์สำหรับการทดสอบเซิร์ฟเวอร์ IMAP เทียบกับเกณฑ์มาตรฐานและความเข้ากันได้ของโปรโตคอล IMAP ตามข้อกำหนด RFC โปรเจ็กต์นี้สร้างขึ้นโดยทีม [Dovecot](https://en.wikipedia.org/wiki/Dovecot_\(software\)) (เซิร์ฟเวอร์ IMAP และ POP3 โอเพนซอร์สที่ใช้งานมาตั้งแต่เดือนกรกฎาคม พ.ศ. 2545) เราได้ทดสอบเซิร์ฟเวอร์ IMAP ของเราอย่างละเอียดด้วยเครื่องมือนี้ |
...
| [Vultr](https://www.vultr.com/?ref=7429848) | โฮสติ้งเซิร์ฟเวอร์เฉพาะ |
| [DataPacket](https://www.datapacket.com) | โฮสติ้งเซิร์ฟเวอร์เฉพาะ |
...
2. ปฏิบัติตาม [MVC](https://en.wikipedia.org/wiki/Model%E2%80%93view%E2%80%93controller), [ยูนิกซ์](https://en.wikipedia.org/wiki/Unix_philosophy), [KISS](https://en.wikipedia.org/wiki/KISS_principle), [DRY](https://en.wikipedia.org/wiki/Don%27t_repeat_yourself), [YAGNI](https://en.wikipedia.org/wiki/You_aren%27t_gonna_need_it), [ปัจจัยสิบสอง](https://12factor.net/), [มีดโกนของอ็อกแคม](https://en.wikipedia.org/wiki/Occam%27s_razor) และ [การทดลองใช้ผลิตภัณฑ์อาหารสุนัข](https://en.wikipedia.org/wiki/Eating_your_own_dog_food)
3. มุ่งเป้าไปที่นักพัฒนาที่ขาดความคิดสร้างสรรค์ ขาดทักษะ และ [ราเมนทำกำไร](http://www.paulgraham.com/ramenprofitable.html)

### การทดลอง {#experiments}

> **tldr;** ในที่สุดแล้วการใช้ที่จัดเก็บวัตถุที่เข้ากันได้กับ S3 และ/หรือตารางเสมือนนั้นไม่สามารถทำได้ในทางเทคนิคเนื่องด้วยเหตุผลด้านประสิทธิภาพ และมีแนวโน้มที่จะเกิดข้อผิดพลาดเนื่องจากข้อจำกัดของหน่วยความจำ

เราได้ทำการทดลองหลายครั้งจนนำไปสู่โซลูชัน SQLite ขั้นสุดท้ายตามที่ได้กล่าวไว้ข้างต้น

วิธีหนึ่งคือการลองใช้ [rclone]() และ SQLite ร่วมกับเลเยอร์จัดเก็บข้อมูลที่เข้ากันได้กับ S3
...
* หากคุณมีเซิร์ฟเวอร์ IMAP หลายเครื่องกระจายอยู่ทั่วโลก แคชจะถูกปิดทั่วทั้งเซิร์ฟเวอร์ เว้นแต่คุณจะมีผู้เขียนเพียงรายเดียวและผู้รับข้อมูลหลายราย (เช่น วิธี pub/sub)
...
* มีโซลูชันอื่นๆ เช่น `rsync` แต่ไม่ได้มุ่งเน้นไปที่การรองรับ write-ahead-log ("[WAL](https://www.sqlite.org/wal.html)") ดังนั้นเราจึงได้ทบทวน Litestream โชคดีที่การเข้ารหัสของเราได้เข้ารหัสไฟล์ [WAL](https://www.sqlite.org/wal.html) ไว้แล้ว ดังนั้นเราจึงไม่จำเป็นต้องใช้ Litestream สำหรับเรื่องนี้ อย่างไรก็ตาม เรายังไม่มั่นใจใน Litestream สำหรับการใช้งานจริง และขออธิบายเพิ่มเติมด้านล่าง
* การใช้ตัวเลือก `--vfs-cache-mode writes` (วิธี *เดียว* ในการใช้ SQLite แทน `rclone` สำหรับการเขียน) จะพยายามคัดลอกฐานข้อมูลทั้งหมดตั้งแต่ต้นในหน่วยความจำ – การจัดการกล่องจดหมายขนาด 10 GB หนึ่งกล่องนั้นทำได้ แต่การจัดการกล่องจดหมายหลายกล่องที่มีพื้นที่เก็บข้อมูลสูงเกินไปจะทำให้เซิร์ฟเวอร์ IMAP เจอข้อจำกัดด้านหน่วยความจำ และเกิดข้อผิดพลาด `ENOMEM`, ความผิดพลาดในการแบ่งเซกเมนต์ และข้อมูลเสียหาย
* หากคุณพยายามใช้ SQLite [ตารางเสมือนจริง](https://www.sqlite.org/vtab.html) (เช่น ใช้ [เอส3ดีบี](https://github.com/jrhy/s3db)) เพื่อให้ข้อมูลอยู่บนเลเยอร์จัดเก็บข้อมูลที่เข้ากันได้กับ S3 คุณจะประสบปัญหาเพิ่มเติมหลายประการ:
* การอ่านและเขียนจะช้ามาก เนื่องจากปลายทาง API ของ S3 จะต้องถูกโจมตีด้วยเมธอด HTTP `GET`, `PUT`, `HEAD` และ `POST`
* การทดสอบการพัฒนาแสดงให้เห็นว่าการบันทึกข้อมูลเกิน 500,000-1 ล้านรายการบนอินเทอร์เน็ตไฟเบอร์ยังคงถูกจำกัดด้วยปริมาณงานของการเขียนและการอ่านข้อมูลไปยังผู้ให้บริการที่เข้ากันได้กับ S3 ตัวอย่างเช่น นักพัฒนาของเราได้รันลูป `for` เพื่อทำทั้งคำสั่ง SQL `INSERT` แบบลำดับ และคำสั่งที่เขียนข้อมูลจำนวนมากพร้อมกัน ทั้งสองกรณีนี้ประสิทธิภาพการทำงานช้ามาก
* ตารางเสมือน **ไม่สามารถมีดัชนี**, คำสั่ง `ALTER TABLE` และ [อื่น](https://stackoverflow.com/a/12507650) [ข้อจำกัด](https://sqlite.org/lang_createvtab.html) ซึ่งทำให้เกิดความล่าช้า 1-2 นาทีหรือมากกว่า ขึ้นอยู่กับปริมาณข้อมูล
* อ็อบเจ็กต์ถูกเก็บไว้โดยไม่เข้ารหัส และไม่มีการรองรับการเข้ารหัสแบบเนทีฟที่พร้อมใช้งาน
* เรายังได้ศึกษาการใช้ [sqlite-s3vfs](https://github.com/uktrade/sqlite-s3vfs) ซึ่งมีความคล้ายคลึงกันทั้งในด้านแนวคิดและเทคนิคกับหัวข้อก่อนหน้า (จึงมีปัญหาเดียวกัน) ความเป็นไปได้คือการใช้บิลด์ `sqlite3` แบบกำหนดเองที่ห่อหุ้มด้วยการเข้ารหัส เช่น [wxSQLite3](https://github.com/utelle/wxsqlite3) (ซึ่งเรากำลังใช้ในโซลูชันข้างต้น) ผ่าน [การแก้ไขไฟล์การตั้งค่า](https://github.com/rogerbinns/apsw/blob/a870bda57ce28704f028af44c392b9a458e702be/setup.py#L268-L276)
* อีกวิธีหนึ่งที่เป็นไปได้คือการใช้ [ส่วนขยายแบบมัลติเพล็กซ์](https://www.sqlite.org/src/doc/trunk/src/test_multiplex.c) อย่างไรก็ตาม วิธีนี้มีขนาดจำกัดที่ 32 GB และต้องใช้ความยุ่งยากในการสร้างและพัฒนาระบบ
* จำเป็นต้องใช้คำสั่ง `ALTER TABLE` (ดังนั้นจึงไม่สามารถใช้ Virtual Tables ได้) เราจำเป็นต้องมีคำสั่ง `ALTER TABLE` เพื่อให้ฮุกของเรากับ `knex-schema-inspector` ทำงานได้อย่างถูกต้อง ซึ่งจะช่วยให้มั่นใจได้ว่าข้อมูลจะไม่เสียหาย และแถวที่ดึงมาสามารถแปลงเป็นเอกสารที่ถูกต้องตามนิยามของ schema `mongoose` ของเรา (ซึ่งรวมถึงข้อจำกัด ประเภทตัวแปร และการตรวจสอบความถูกต้องของข้อมูลตามอำเภอใจ)
...
* ไลบรารีการบีบอัดข้อมูล เช่น [sqlite-zstd](https://github.com/phiresky/sqlite-zstd) (ดู [ความคิดเห็น](https://news.ycombinator.com/item?id=32303762)) ดูมีแนวโน้มดี แต่ [อาจยังไม่พร้อมสำหรับการใช้งานจริง](https://github.com/phiresky/sqlite-zstd#usage) การบีบอัดข้อมูลฝั่งแอปพลิเคชันบนชนิดข้อมูล เช่น `String`, `Object`, `Map`, `Array`, `Set` และ `Buffer` จะเป็นแนวทางที่สะอาดและง่ายกว่า (และง่ายต่อการย้ายข้อมูลด้วย เนื่องจากเราสามารถจัดเก็บแฟล็กหรือคอลัมน์ `Boolean` หรือแม้แต่ใช้ `PRAGMA` `user_version=1` สำหรับการบีบอัดข้อมูล หรือ `user_version=0` สำหรับการไม่บีบอัดข้อมูลเป็นเมตาดาต้าของฐานข้อมูล)
* โชคดีที่เราได้นำฟังก์ชันกำจัดไฟล์แนบซ้ำซ้อนมาใช้ในที่เก็บข้อมูลเซิร์ฟเวอร์ IMAP ของเราแล้ว ดังนั้นทุกข้อความที่มีไฟล์แนบเดียวกันจะไม่เก็บสำเนาของไฟล์แนบไว้ แต่จะมีไฟล์แนบเดียวสำหรับข้อความและเธรดหลายรายการในกล่องจดหมาย (และจะใช้การอ้างอิงจากภายนอกในภายหลัง)
* โปรเจกต์ Litestream ซึ่งเป็นโซลูชันการจำลองและสำรองข้อมูล SQLite นั้นมีศักยภาพสูง และเราน่าจะนำมันมาใช้ในอนาคต
* ไม่ได้ต้องการจะทำลายความน่าเชื่อถือของผู้เขียน เพราะเราชื่นชอบผลงานและการมีส่วนร่วมของพวกเขาในโอเพนซอร์สมานานกว่าทศวรรษแล้ว อย่างไรก็ตาม จากการใช้งานจริง พบว่ามี [อาจจะปวดหัวมาก](https://github.com/benbjohnson/litestream/issues) และ [การสูญเสียข้อมูลที่อาจเกิดขึ้นจากการใช้งาน](https://github.com/benbjohnson/litestream/issues/218)
* การกู้คืนข้อมูลสำรองต้องราบรื่นและง่ายดาย การใช้โซลูชันเช่น MongoDB ที่มี `mongodump` และ `mongoexport` ไม่เพียงแต่จะยุ่งยาก แต่ยังใช้เวลานานและมีความซับซ้อนในการกำหนดค่า
* ฐานข้อมูล SQLite ทำให้มันง่าย (เป็นไฟล์เดียว)
* เราต้องการออกแบบโซลูชันที่ผู้ใช้สามารถนำกล่องจดหมายของตนออกได้ทุกเมื่อ
* คำสั่ง Node.js ง่ายๆ ที่ใช้ `fs.unlink('mailbox.sqlite'))` จะถูกลบออกจากพื้นที่เก็บข้อมูลดิสก์อย่างถาวร
* เราสามารถใช้ API ที่เข้ากันได้กับ S3 กับ HTTP `DELETE` เพื่อลบสแนปช็อตและการสำรองข้อมูลสำหรับผู้ใช้ได้อย่างง่ายดาย
* SQLite เป็นโซลูชันที่ง่ายที่สุด รวดเร็วที่สุด และคุ้มค่าที่สุด

### ขาดทางเลือก {#lack-of-alternatives}

เท่าที่เรารู้ ไม่มีบริการอีเมลอื่นใดที่ได้รับการออกแบบด้วยวิธีนี้ และไม่ใช่โอเพนซอร์สด้วย
...
ผู้ให้บริการอีเมลส่วนใหญ่หรือเกือบทั้งหมดเป็นผู้ให้บริการแบบปิดหรือโฆษณาว่าเป็นโอเพนซอร์ส **แต่ในความเป็นจริง มีเพียงผู้ให้บริการฝั่งผู้ใช้ปลายทางเท่านั้นที่เป็นโอเพนซอร์ส**

**ส่วนที่ละเอียดอ่อนที่สุดของอีเมล** (การโต้ตอบระหว่างพื้นที่เก็บข้อมูล/IMAP/SMTP จริง) **จะทำทั้งหมดในส่วนของแบ็กเอนด์ (เซิร์ฟเวอร์) และ *ไม่ใช่* ในส่วนของฟรอนต์เอนด์ (ไคลเอนต์)**
