...
> Tất cả các giá trị mặc định khác đều lấy từ SQLite như được chỉ định từ [tài liệu PRAGMA chính thức](https://www.sqlite.org/pragma.html#pragma_auto_vacuum).
