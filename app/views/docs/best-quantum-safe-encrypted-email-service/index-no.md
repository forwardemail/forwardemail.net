...
I tilfelle en [ond hushjelpangrep](https://en.wikipedia.org/wiki/Evil_maid_attack) eller en uautorisert ansatt fra en tredjepartsleverandør, **kan postkassen din fortsatt bare åpnes med det genererte passordet ditt**. Du kan være trygg på at vi ikke er avhengige av noen tredjepartsleverandører annet enn våre SOC Type 2-klageserverleverandører Cloudflare, DataPacket, Digital Ocean, GitHub og Vultr.
