...
1. Використовуючи свій поштовий клієнт, такий як Apple Mail, Betterbird, Gmail або Outlook, ви підключаєтеся до наших захищених серверів [IMAP](/faq#do-you-support-receiving-email-with-imap), використовуючи своє ім’я користувача та пароль:
...
| [Betterbird](https://betterbird.eu/) | Наша команда розробників використовує це (і також рекомендує це) як **бажаний поштовий клієнт для використання з Forward Email**. |
