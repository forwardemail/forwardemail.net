...
\[^10]：隐私指南社区。“目前列出的任何 PG 电子邮件服务提供商的后端基础设施均未公开共享任何审计报告，也没有分享任何关于他们如何处理入站电子邮件的开源代码片段。” [转发电子邮件（电子邮件提供商） - 网站开发/工具建议](https://discuss.privacyguides.net/t/forward-email-email-provider/13370?page=9)
