...
* [خداع المصدر المغلق: ما لا يخبرك به بروتون وتوتانوتا](#the-closed-source-deception-what-proton-and-tutanota-dont-tell-you)
  ...
  * [نهج توتانوتا المماثل](#tutanotas-similar-approach)
...
> "لم تكن هناك أي عمليات تدقيق عامة مشتركة لأي من البنى التحتية الخلفية لمزودي خدمة البريد الإلكتروني PG المدرجين حاليًا، ولم تتم مشاركة أي أجزاء من التعليمات البرمجية مفتوحة المصدر حول كيفية معالجتهم للبريد الإلكتروني الوارد."\[^10]
...
يعكس هذا النمو تحولاً جذرياً في نظرتنا لأمن البرمجيات وخصوصيتها. ومع تزايد وعي المستخدمين بخصوصيتهم، سيزداد الطلب على الخصوصية القابلة للتحقق من خلال حلول مفتوحة المصدر.
...
بخلاف منافسينا الذين لا يتبنون إلا جزءًا من البرمجيات مفتوحة المصدر، فقد جعلنا منصتنا بالكامل - بكاملها - متاحةً للمراجعة العامة. هذا الالتزام بالشفافية، إلى جانب نهجنا التقني المبتكر، يوفر مستوى من الخصوصية القابلة للتحقق، لا تضاهيه بدائل البرمجيات مفتوحة المصدر.
...
مستقبل البريد الإلكتروني مفتوح وشفاف ويركز على الخصوصية. المستقبل هو بريد إلكتروني موجه.

\[^1]: SNS Insider. "قُدِّرت قيمة سوق خدمات المصدر المفتوح بـ 28.6 مليار دولار أمريكي في عام 2023، ومن المتوقع أن تصل إلى 114.8 مليار دولار أمريكي بحلول عام 2032، بمعدل نمو سنوي مركب قدره 16.70% بحلول عام 2032." [تقرير تحليل وحجم سوق خدمات المصدر المفتوح لعام ٢٠٣٢](https://www.snsinsider.com/reports/open-source-services-market-3322)
...
\[^5]: منتدى البريد في صندوق بريد. "استغرقت الصيانة حوالي ١٦ ساعة خلال تلك الفترة..." [خادم البريد الإلكتروني الذي يستضيف نفسه لا يُرحب به](https://discourse.mailinabox.email/t/self-hosting-mail-server-frowned-upon/4143)

\[^6]: Reddit r/selfhosted. "ملخص: بما أن كل شيء مُستضاف ذاتيًا، فسيتطلب وقتك. إذا لم يكن لديك وقت كافٍ، فمن الأفضل دائمًا الالتزام بخدمة مُستضاف..." [استضافة خادم بريد إلكتروني ذاتيًا؟ لماذا؟ ما هو الخيار الأكثر شيوعًا؟](https://www.reddit.com/r/selfhosted/comments/1etb8jh/selfhosting_an_email_server_why_or_why_not_whats/)

\[^7]: إعادة توجيه البريد الإلكتروني. "يزعم بروتون ميل أنه مفتوح المصدر، لكن نظامه الخلفي مغلق المصدر." [مقارنة بين توتانوتا وبروتون ميل (2025)](https://forwardemail.net/blog/tutanota-vs-proton-mail-email-service-comparison)
