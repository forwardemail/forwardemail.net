...
> [!IMPORTANT]
> Den 1. juni 2026 publiserte vi vår tredjeparts sikkerhetsrevisjon utført av [Cure53](https://cure53.de/), som er bredt anerkjent som et av de beste sikkerhetsforskningsfirmaene i bransjen. Den fullstendige penetrasjonstestrapport er tilgjengelig på [pentest-report_forward-email.pdf](/pentest-report_forward-email.pdf). Forward Email er den eneste 100% åpen kildekode e-posttjenesten med en uavhengig verifisert sikkerhetsrevisjon.

<img loading="lazy" src="/img/articles/security-audit.webp" alt="Sammenligning av sikkerhetsrevisjonsselskaper" class="rounded-lg" />
...
* [Sammenligning av selskaper](#company-comparison)
* [Utvalgskriterier](#selection-criteria)


## Oversikt {#overview}

Forward Email har aktivt evaluert cybersikkerhetsforskningsselskaper for å gjennomføre omfattende revisjoner av vår åpen kildekode-base på [GitHub](https://github.com/forwardemail) og serverinfrastruktur. Etter omfattende forskning og evaluering de siste årene har vi identifisert flere eksepsjonelle sikkerhetsrevisjonsfirmaer som konsekvent leverer arbeid av høy kvalitet, teknisk ekspertise og samsvarer med våre personvernfokuserte verdier.
...
* [Forward Email Arkitektur & Infrastruktur Sikkerhetsvurdering 2026](https://cure53.de/pentest-report_forward-email.pdf) - Omfattende penetrasjonstest av Forward Emails åpen kildekode-kodebase og serverinfrastruktur
* [Mullvad Servers Security Assessment 2024](https://cure53.de/pentest-report_mullvad_2024_v1.pdf) - Omfattende infrastrukturvurdering  
* [Mullvad Apps/API Security Assessment 2020](https://cure53.de/pentest-report_mullvad_2020_v2.pdf) - Applikasjons- og API-sikkerhetsanalyse  
* [Mullvad Servers Security Assessment 2021](https://cure53.de/pentest-report_mullvad_2021_v1.pdf) - Oppfølgende infrastrukturevaluering
...
* [Droid2Tracking sikkerhetsvurdering](https://github.com/radicallyopensecurity/ros-website/blob/main/ros-public-reports/ROS%20-%20OnNet%20-%20OF-Droid2Tracking%20the%20Trackers%20-%202022.pdf) - Mobil sporing analyse
* [Tauri Programme sikkerhetsvurdering 2022](https://github.com/radicallyopensecurity/ros-website/blob/main/ros-public-reports/ROS%20-%20The%20Tauri%20Programme%20-2022.pdf) - Evaluering av tverrplattform applikasjonsrammeverk
* [Mullvad VPN sikkerhetsvurdering 2022](https://github.com/radicallyopensecurity/ros-website/blob/main/ros-public-reports/ROS%20-%20Mullvad%20VPN%202022.pdf) - VPN-tjeneste sikkerhetsanalyse
...
* [Mullvad e-postservere sikkerhetsrevisjon 2024](https://www.assured.se/publications/Assured_Mullvad_email_server_audit\_2024.pdf) - Vurdering av e-postinfrastrukturens sikkerhet
* [Mullvad API sikkerhetsrevisjon 2022](https://www.assured.se/publications/Assured_Mullvad_API_audit_report\_2022.pdf) - Evaluering av API-sikkerhet
* [Mullvad DNS-server sikkerhetsrevisjon 2022](https://www.assured.se/publications/Assured_Mullvad_DNS_server_audit_report\_2022.pdf) - Vurdering av DNS-infrastruktur
...
* [Homebrew sikkerhetsgjennomgang 2023](https://github.com/trailofbits/publications/blob/master/reviews/2023-08-28-homebrew-securityreview.pdf) - Vurdering av pakkehåndteringssikkerhet
* [Hey sikkerhetsgjennomgang](https://github.com/trailofbits/publications/blob/master/reviews/Hey.pdf) - Evaluering av e-posttjenestesikkerhet
* [cURL sikkerhetsgjennomgang 2022](https://github.com/trailofbits/publications/blob/master/reviews/2022-12-curl-securityreview.pdf) - Nettverksbibliotek sikkerhetsanalyse


## Selskapsammenligning {#company-comparison}
