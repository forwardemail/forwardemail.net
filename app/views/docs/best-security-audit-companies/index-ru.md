...
* [Оценка безопасности архитектуры и инфраструктуры Forward Email 2026](https://cure53.de/pentest-report_forward-email.pdf) - Комплексное тестирование на проникновение кодовой базы с открытым исходным кодом и серверной инфраструктуры Forward Email
