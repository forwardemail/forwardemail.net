# Meilleures entreprises d'audit de sécurité {#best-security-audit-companies}


> [!IMPORTANT]
> Le 1er juin 2026, nous avons publié notre audit de sécurité tiers réalisé par [Cure53](https://cure53.de/), largement considéré comme l'une des meilleures entreprises de recherche en sécurité du secteur. Le rapport complet du test d'intrusion est disponible sur [pentest-report_forward-email.pdf](/pentest-report_forward-email.pdf). Forward Email est le seul service de messagerie 100% open source avec un audit de sécurité vérifié de manière indépendante.

<img loading="lazy" src="/img/articles/security-audit.webp" alt="Comparaison des entreprises d'audit de sécurité" class="rounded-lg" />
...
* [Entreprises recommandées pour l'audit de sécurité](#recommended-security-audit-companies)
  * [Cure53](#cure53)
...
* [Évaluation de Sécurité de l'Architecture et de l'Infrastructure Forward Email 2026](https://cure53.de/pentest-report_forward-email.pdf) - Test d'intrusion complet du code source ouvert et de l'infrastructure serveur de Forward Email
* [Évaluation de la sécurité des serveurs Mullvad 2024](https://cure53.de/pentest-report_mullvad_2024_v1.pdf) - Évaluation complète de la sécurité de l'infrastructure  
* [Évaluation de la sécurité des applications/API Mullvad 2020](https://cure53.de/pentest-report_mullvad_2020_v2.pdf) - Analyse de la sécurité des applications et API  
* [Évaluation de la sécurité des serveurs Mullvad 2021](https://cure53.de/pentest-report_mullvad_2021_v1.pdf) - Évaluation de suivi de l'infrastructure  
...
Leur modèle à but non lucratif leur permet de se concentrer uniquement sur les résultats en matière de sécurité plutôt que sur la maximisation des profits, ce qui aboutit souvent à des évaluations plus approfondies et des recommandations sincères. ROS possède une expertise particulière dans les technologies axées sur la confidentialité, les services VPN et les applications traitant des données utilisateur sensibles.
**Publications et Rapports Notables** :

* [Évaluation de la Sécurité Droid2Tracking](https://github.com/radicallyopensecurity/ros-website/blob/main/ros-public-reports/ROS%20-%20OnNet%20-%20OF-Droid2Tracking%20the%20Trackers%20-%202022.pdf) - Analyse du suivi mobile
* [Évaluation de la Sécurité du Programme Tauri 2022](https://github.com/radicallyopensecurity/ros-website/blob/main/ros-public-reports/ROS%20-%20The%20Tauri%20Programme%20-2022.pdf) - Évaluation du cadre d'application multiplateforme
* [Évaluation de la Sécurité Mullvad VPN 2022](https://github.com/radicallyopensecurity/ros-website/blob/main/ros-public-reports/ROS%20-%20Mullvad%20VPN%202022.pdf) - Analyse de la sécurité du service VPN
...
* [Audit de Sécurité des Serveurs Email Mullvad 2024](https://www.assured.se/publications/Assured_Mullvad_email_server_audit_2024.pdf) - Évaluation de la sécurité de l’infrastructure email  
* [Audit de Sécurité API Mullvad 2022](https://www.assured.se/publications/Assured_Mullvad_API_audit_report_2022.pdf) - Évaluation de la sécurité des API  
* [Audit de Sécurité des Serveurs DNS Mullvad 2022](https://www.assured.se/publications/Assured_Mullvad_DNS_server_audit_report_2022.pdf) - Évaluation de l’infrastructure DNS  
...
* [Revue de Sécurité Hey](https://github.com/trailofbits/publications/blob/master/reviews/Hey.pdf) - Évaluation de la sécurité du service email  
* [Revue de Sécurité cURL 2022](https://github.com/trailofbits/publications/blob/master/reviews/2022-12-curl-securityreview.pdf) - Analyse de la sécurité de la bibliothèque réseau  
