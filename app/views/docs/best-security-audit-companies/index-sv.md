# Bästa säkerhetsgranskningsföretagen {#best-security-audit-companies}


> [!IMPORTANT]
> Den 1 juni 2026 publicerade vi vår tredjepartssäkerhetsrevision utförd av [Cure53](https://cure53.de/), som allmänt anses vara ett av de bästa säkerhetsforskningsföretagen i branschen. Den fullständiga penetrationstestrapporten finns tillgänglig på [pentest-report_forward-email.pdf](/pentest-report_forward-email.pdf). Forward Email är den enda 100% öppen källkod e-posttjänsten med en oberoende verifierad säkerhetsrevision.
...
* [Forward Email Arkitektur & Infrastruktur Säkerhetsbedömning 2026](https://cure53.de/pentest-report_forward-email.pdf) - Omfattande penetrationstest av Forward Emails öppen källkod-kodbas och serverinfrastruktur
* [Mullvad Servers Security Assessment 2024](https://cure53.de/pentest-report_mullvad\_2024\_v1.pdf) - Omfattande infrastruktursäkerhetsutvärdering  
* [Mullvad Apps/API Security Assessment 2020](https://cure53.de/pentest-report_mullvad\_2020\_v2.pdf) - Applikations- och API-säkerhetsanalys  
* [Mullvad Servers Security Assessment 2021](https://cure53.de/pentest-report_mullvad\_2021\_v1.pdf) - Uppföljande infrastruktursbedömning
...
Deras ideella modell gör att de kan fokusera helt på säkerhetsresultat snarare än vinstmaximering, vilket ofta resulterar i mer grundliga bedömningar och genuina rekommendationer. ROS har särskild expertis inom integritetsfokuserade teknologier, VPN-tjänster och applikationer som hanterar känsliga användardata.
**Anmärkningsvärda publikationer och rapporter**:

* [Droid2Tracking Security Assessment](https://github.com/radicallyopensecurity/ros-website/blob/main/ros-public-reports/ROS%20-%20OnNet%20-%20OF-Droid2Tracking%20the%20Trackers%20-%202022.pdf) - Mobil spårningsanalys
* [Tauri Programme Security Assessment 2022](https://github.com/radicallyopensecurity/ros-website/blob/main/ros-public-reports/ROS%20-%20The%20Tauri%20Programme%20-2022.pdf) - Utvärdering av plattformsoberoende applikationsramverk
* [Mullvad VPN Security Assessment 2022](https://github.com/radicallyopensecurity/ros-website/blob/main/ros-public-reports/ROS%20-%20Mullvad%20VPN%202022.pdf) - Säkerhetsanalys av VPN-tjänst
...
* [Mullvad Email Servers Security Audit 2024](https://www.assured.se/publications/Assured_Mullvad_email_server_audit\_2024.pdf) - Säkerhetsbedömning av e-postinfrastruktur
* [Mullvad API Security Audit 2022](https://www.assured.se/publications/Assured_Mullvad_API_audit_report\_2022.pdf) - Utvärdering av API-säkerhet
* [Mullvad DNS Server Security Audit 2022](https://www.assured.se/publications/Assured_Mullvad_DNS_server_audit_report\_2022.pdf) - Bedömning av DNS-infrastruktur
...
* [Homebrew Security Review 2023](https://github.com/trailofbits/publications/blob/master/reviews/2023-08-28-homebrew-securityreview.pdf) - Säkerhetsbedömning av paketchef
* [Hey Security Review](https://github.com/trailofbits/publications/blob/master/reviews/Hey.pdf) - Utvärdering av e-posttjänstsäkerhet
* [cURL Security Review 2022](https://github.com/trailofbits/publications/blob/master/reviews/2022-12-curl-securityreview.pdf) - Säkerhetsanalys av nätverksbibliotek
