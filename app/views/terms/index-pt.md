...
Podemos ou não notificá-lo com antecedência sobre restrições já impostas ou que serão impostas à sua conta e ao serviço em geral.
...
| Porcentagem de tempo de atividade mensal | Dias de serviço* |
| ------------------------- | ---------------- |
| < 99.99% – >= 99.90% | 3 |
| < 99.90% – >= 95.00% | 7 |
| < 95.50% | 15 |
