...
**За исключением [журналов ошибок](#error-logs), [исходящих SMTP писем](#outbound-smtp-emails) и/или при обнаружении спама или вредоносной активности (например, для ограничения скорости):**
...
* Любую дополнительную информацию, которую вы добровольно предоставляете, например комментарии или вопросы, отправленные нам по электронной почте или на нашей <a href="/help">странице помощи</a>.
