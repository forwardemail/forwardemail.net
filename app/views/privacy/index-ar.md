...
**باستثناء المعلومات الموضحة صراحة في هذه السياسة — بما في ذلك [سجلات الأخطاء](#error-logs)، [رسائل البريد الإلكتروني الصادرة عبر SMTP](#outbound-smtp-emails)، [معلومات الحساب](#account-information)، [المعالجة المؤقتة للبيانات](#temporary-data-processing)، [سجلات التدقيق](#audit-logs)، و[ملفات تعريف الارتباط والجلسات](#cookies-and-sessions):**
...
* أي معلومات إضافية تقدمها لنا طواعية، مثل التعليقات أو الأسئلة المقدمة إلينا عبر البريد الإلكتروني أو على صفحة <a href="/help">المساعدة</a> الخاصة بنا.
