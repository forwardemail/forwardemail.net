...
**За винятком [журналів помилок](#error-logs), [вихідних SMTP-листів](#outbound-smtp-emails) та/або у випадках виявлення спаму чи шкідливої активності (наприклад, для обмеження швидкості):**
...
* Будь-яку додаткову інформацію, яку ви добровільно надаєте, наприклад, коментарі або запитання, надіслані нам електронною поштою або на нашій <a href="/help">сторінці допомоги</a>.
