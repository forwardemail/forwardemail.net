...
**本ポリシーに明示的に記載されている情報（[エラーログ](#error-logs)、[送信SMTPメール](#outbound-smtp-emails)、[アカウント情報](#account-information)、[一時的なデータ処理](#temporary-data-processing)、[監査ログ](#audit-logs)、および[クッキーとセッション](#cookies-and-sessions)を含む）を除き：**
...
* お客様が自発的に提供された追加情報（メールや当社の<a href="/help">ヘルプ</a>ページで送信されたコメントや質問など）。
