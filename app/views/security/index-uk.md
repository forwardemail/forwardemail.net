...
* **Контрольоване використання swap**: Хости застосунків та інші хости, що не є базами даних, залишаються без swap, а їх розмір і моніторинг налаштовані так, щоб звичайні робочі навантаження залишалися в RAM. Хости MongoDB та Redis використовують файл swap лише для root з `vm.swappiness=1` суворо як захисну сітку від нестачі пам'яті, а не як звичайну ємність. Активність swap бази даних відстежується та розслідується.
