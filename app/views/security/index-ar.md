...
* ممارسات معالجة البيانات المتوافقة مع [GDPR](https://forwardemail.net/gdpr)
* [اتفاقية معالجة البيانات (DPA)](https://forwardemail.net/dpa) متاحة لعملاء الشركات
...
* **التشغيل الآمن**: عملية تشغيل مُتحققة لمنع التلاعب.
...
باعتبارنا [خدمة مفتوحة المصدر](https://github.com/forwardemail/forwardemail.net)، فإن فوائد الأمان لدينا تتمثل في:
