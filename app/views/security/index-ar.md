...
* **الاستخدام المنضبط للتبديل**: تظل خوادم التطبيقات والخوادم الأخرى غير التابعة لقواعد البيانات خالية من التبديل ويتم تحديد حجمها ومراقبتها بحيث تبقى أعباء العمل العادية في ذاكرة الوصول العشوائي (RAM). تستخدم خوادم MongoDB و Redis ملف تبديل بصلاحيات root فقط مع `vm.swappiness=1` بشكل صارم كشبكة أمان لنفاد الذاكرة، وليس كسعة عادية. يتم مراقبة نشاط التبديل في قواعد البيانات والتحقيق فيه.
