...
* [2. การประมวลผล](#2-processing)
  ...
  * [2. คำแนะนำการประมวลผล](#2-processing-instructions)
...
* [3. การโอนที่มีข้อจำกัด](#3-restricted-transfers)
  ...
  * [2. การโอนย้ายอดีต EEA](#2-ex-eea-transfers)
  * [3. การย้ายอดีตไปอังกฤษ](#3-ex-uk-transfers)
...
เอกสารนี้เป็นผลงานดัดแปลงจาก [ข้อกำหนดมาตรฐาน DPA ของเอกสารทั่วไป (เวอร์ชัน 1.0)](https://commonpaper.com/standards/data-processing-agreement/1.0) และมีการเปลี่ยนแปลงดังต่อไปนี้:
...
### 2. การโอนย้ายจากเขตเศรษฐกิจยุโรป (EEA) {#2-ex-eea-transfers}
...
ข. โมดูลที่สาม (ผู้ประมวลผลถึงผู้ประมวลผลย่อย) ของ EEA SCC มีผลใช้บังคับเมื่อ <strong>ลูกค้า</strong> เป็นผู้ประมวลผล และ <strong>ผู้ให้บริการ</strong> กำลังประมวลผลข้อมูลส่วนบุคคลของลูกค้าในนามของ <strong>ลูกค้า</strong> ในฐานะผู้ประมวลผลย่อย

c. สำหรับแต่ละโมดูล ให้ใช้สิ่งต่อไปนี้ (ถ้ามี):

1. ข้อกำหนดเกี่ยวกับการเชื่อมต่อโดยเลือกตามข้อ 7 ไม่สามารถใช้ได้

2. ในข้อ 9 ตัวเลือกที่ 2 (อนุญาตเป็นลายลักษณ์อักษรทั่วไป) ใช้ได้ และระยะเวลาขั้นต่ำสำหรับการแจ้งล่วงหน้าเกี่ยวกับการเปลี่ยนแปลงตัวประมวลผลย่อยคือ 10 วันทำการ

3. ในมาตรา 11 ภาษาที่เลือกไม่ได้นำไปใช้

4. เครื่องหมายวงเล็บเหลี่ยมทั้งหมดในข้อ 13 จะถูกลบออก
...
1. DPA ฉบับนี้ไม่ได้จำกัดความรับผิดใดๆ ต่อบุคคลเกี่ยวกับสิทธิ์ในการคุ้มครองข้อมูลของบุคคลภายใต้กฎหมายคุ้มครองข้อมูลที่บังคับใช้ นอกจากนี้ DPA ฉบับนี้ไม่ได้จำกัดความรับผิดใดๆ ระหว่างคู่กรณีสำหรับการละเมิด EEA SCC หรือภาคผนวกของสหราชอาณาจักร
...
1. **"กฎหมายที่ใช้บังคับ"** หมายถึง กฎหมาย กฎ ระเบียบ คำสั่งศาล และข้อกำหนดผูกมัดอื่นๆ ของหน่วยงานรัฐบาลที่เกี่ยวข้องที่ใช้บังคับหรือควบคุมฝ่ายใดฝ่ายหนึ่ง

2. **"กฎหมายคุ้มครองข้อมูลที่ใช้บังคับ"** หมายถึง กฎหมายที่ใช้บังคับซึ่งควบคุมวิธีการที่บริการอาจประมวลผลหรือใช้ข้อมูลส่วนบุคคลของบุคคล ข้อมูลส่วนบุคคล ข้อมูลที่ระบุตัวตนส่วนบุคคล หรือคำศัพท์อื่นที่คล้ายคลึงกัน
...
7. **"EEA SCCs"** หมายถึงมาตรฐานข้อกำหนดในสัญญาที่แนบมากับการตัดสินใจดำเนินการของคณะกรรมาธิการยุโรป 2021/914 ลงวันที่ 4 มิถุนายน 2021 เกี่ยวกับมาตรฐานข้อกำหนดในสัญญาสำหรับการถ่ายโอนข้อมูลส่วนบุคคลไปยังประเทศที่สามตามข้อบังคับ (EU) 2016/679 ของรัฐสภายุโรปและของคณะมนตรียุโรป
...
10. **"ข้อมูลส่วนบุคคล"** จะมีความหมายตามที่กำหนดไว้ในกฎหมายคุ้มครองข้อมูลที่บังคับใช้สำหรับข้อมูลส่วนบุคคล ข้อมูลส่วนบุคคลหรือคำอื่นที่คล้ายคลึงกัน

11. **"การประมวลผล"** หรือ **"กระบวนการ"** จะมีความหมายตามที่กำหนดไว้ในกฎหมายคุ้มครองข้อมูลที่บังคับใช้สำหรับการใช้หรือการดำเนินการคอมพิวเตอร์กับข้อมูลส่วนบุคคล รวมถึงวิธีอัตโนมัติ
...
13. **"รายงาน"** หมายถึง รายงานการตรวจสอบที่จัดทำโดยบริษัทอื่นตามมาตรฐานที่กำหนดไว้ในนโยบายการรักษาความปลอดภัยในนามของผู้ให้บริการ

14. **"การโอนข้อมูลแบบจำกัด"** หมายถึง (ก) ในกรณีที่ GDPR มีผลใช้บังคับ การโอนข้อมูลส่วนบุคคลจาก EEA ไปยังประเทศนอก EEA ซึ่งไม่ได้ขึ้นอยู่กับการพิจารณาความเพียงพอโดยคณะกรรมาธิการยุโรป และ (ข) ในกรณีที่ GDPR ของสหราชอาณาจักรมีผลใช้บังคับ การโอนข้อมูลส่วนบุคคลจากสหราชอาณาจักรไปยังประเทศอื่นใดที่ไม่ขึ้นอยู่กับกฎระเบียบความเพียงพอที่นำมาใช้ตามมาตรา 17A ของพระราชบัญญัติการคุ้มครองข้อมูลของสหราชอาณาจักร พ.ศ. 2561
...
18. **"ผู้ประมวลผลย่อย"** จะมีความหมายตามที่กำหนดไว้ในกฎหมายคุ้มครองข้อมูลที่บังคับใช้สำหรับบริษัทที่ช่วยเหลือผู้ประมวลผลในการประมวลผลข้อมูลส่วนบุคคลในนามของผู้ควบคุม โดยได้รับการอนุมัติและยอมรับจากผู้ควบคุม

19. **"UK GDPR"** หมายถึง ข้อบังคับสหภาพยุโรป 2016/679 ตามที่นำไปปฏิบัติโดยมาตรา 3 ของพระราชบัญญัติการถอนตัวของสหภาพยุโรปแห่งสหราชอาณาจักร พ.ศ. 2561 ในสหราชอาณาจักร

20. **"ภาคผนวกของสหราชอาณาจักร"** หมายถึงภาคผนวกการโอนข้อมูลระหว่างประเทศของ EEA SCC ที่ออกโดยผู้บังคับใช้ข้อมูลสำหรับฝ่ายต่างๆ ที่ทำการโอนข้อมูลแบบจำกัดภายใต้พระราชบัญญัติคุ้มครองข้อมูล S119A(1) ปี 2018
