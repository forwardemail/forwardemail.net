...
| <strong>Approved Subprocessors</strong>    | [Cloudflare](https://cloudflare.com) (US; DNS, networking, and security provider), [DataPacket](https://www.datapacket.com/) (US/UK; hosting provider), [Digital Ocean](https://digitalocean.com) (US; hosting provider), [GitHub](https://github.com) (US; source code hosting, CI/CD, and project management), [Vultr](https://www.vultr.com) (US; hosting provider), [Stripe](https://stripe.com) (US; payment processor), [PayPal](https://paypal.com) (US; payment processor) |
