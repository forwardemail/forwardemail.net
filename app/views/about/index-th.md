...
> \[!TIP]
> สำหรับรายละเอียดทางเทคนิคเกี่ยวกับสถาปัตยกรรม การใช้งานด้านความปลอดภัย และแผนงาน โปรดดูที่ [Technical Whitepaper](https://forwardemail.net/technical-whitepaper.pdf)และ[การตรวจสอบความปลอดภัย](https://forwardemail.net/pentest-report_forward-email.pdf)อิสระจาก Cure53
...
**ปรัชญาโอเพนซอร์ส 100%**: แตกต่างจากคู่แข่งที่เปิดซอร์สเฉพาะส่วนหน้าแต่ปิดส่วนหลัง Forward Email เปิดเผยโค้ดทั้งหมดทั้งส่วนหน้าและส่วนหลังให้สาธารณะตรวจสอบได้บน [GitHub](https://github.com/forwardemail)—ตอนนี้ได้รับการสนับสนุนจาก[การตรวจสอบความปลอดภัยอิสระ](/pentest-report_forward-email.pdf)จาก Cure53
