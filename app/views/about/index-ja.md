...
> \[!TIP]
> アーキテクチャ、セキュリティ実装、ロードマップの技術的詳細については、[Technical Whitepaper](https://forwardemail.net/technical-whitepaper.pdf)をご覧くださいおよびCure53による独立[セキュリティ監査](https://forwardemail.net/pentest-report_forward-email.pdf)。
