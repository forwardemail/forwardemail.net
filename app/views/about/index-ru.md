...
* [Хронология](#timeline)
  ...
  * [2026 - Соответствие RFC и продвинутая фильтрация и независимый аудит безопасности {#2026---rfc-compliance-and-advanced-filtering}](#2026---rfc-compliance-and-advanced-filtering-2026---rfc-compliance-and-advanced-filtering)
...
> \[!TIP]
> Для технических деталей об архитектуре, реализации безопасности и дорожной карте смотрите [Технический Whitepaper](https://forwardemail.net/technical-whitepaper.pdf) и наш независимый [аудит безопасности](https://forwardemail.net/pentest-report_forward-email.pdf) от Cure53.
...
### 2026 - Соответствие RFC и расширенная фильтрация и независимый аудит безопасности {#2026---rfc-compliance-and-advanced-filtering} {#2026---rfc-compliance-and-advanced-filtering-2026---rfc-compliance-and-advanced-filtering}
...
**Май 2026**: Были выпущены значительные улучшения надёжности и совместимости, включая поддержку Apple Push Notification (APN) для доставки почты в реальном времени на iOS/macOS, комплексные исправления CalDAV для совместимости синхронизации iOS (восстановление PRODID, LAST-MODIFIED, CREATED, SEQUENCE и правильная кодировка href), политики хранения электронной почты для каждого псевдонима, улучшенная фильтрация Sieve с декодированием заголовков MIME и сохранением заголовков List-*, синхронизация ключевых слов IMAP с пользовательскими метками и защита от переполнения BSON для отправителей с большим объёмом. Была добавлена поддержка устаревшего TLS для клиентов IMAP/POP3, а API push-уведомлений был расширен конечными точками CRUD токенов и конвейера доставки.

**Июнь 2026**: Forward Email опубликовал свой первый независимый аудит безопасности третьей стороной, проведённый [Cure53](https://cure53.de/), одной из самых уважаемых фирм по исследованию безопасности в отрасли. Полный отчёт о тестировании на проникновение доступен по адресу [pentest-report_forward-email.pdf](/pentest-report_forward-email.pdf). Аудит охватил всю архитектуру с открытым исходным кодом и серверную инфраструктуру, все обнаруженные проблемы были устранены и проверены посредством непрерывного повторного тестирования. Было применено дополнительное усиление безопасности, включая DNS pinning для предотвращения SSRF, аутентификацию токеном приглашения и валидацию URL Domain Connect.
...
**100% открытый исходный код**: В отличие от конкурентов, которые открывают только фронтенд, оставляя бэкенд закрытым, Forward Email сделал весь свой код — как фронтенд, так и бэкенд — доступным для публичного просмотра на [GitHub](https://github.com/forwardemail)—теперь подкреплённый [независимым аудитом безопасности](/pentest-report_forward-email.pdf) от Cure53.
